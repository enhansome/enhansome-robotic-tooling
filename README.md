...
* [Gogs](https://github.com/gogs/gogs) ⭐ 47,776 | 🐛 1,007 | 🌐 Go | 📅 2026-08-26 - Build a simple, stable and extensible self-hosted Git service that can be setup in the most painless way.
* [discourse](https://github.com/discourse/discourse) ⭐ 47,740 | 🐛 278 | 🌐 Ruby | 📅 2026-08-27 - A platform for community discussion. Free, open, simple.
* [mattermost](https://github.com/mattermost/mattermost-server) ⭐ 38,918 | 🐛 986 | 🌐 TypeScript | 📅 2026-08-27 - An open source, private cloud, Slack-alternative.
* [jitsi-meet](https://github.com/jitsi/jitsi-meet) ⭐ 29,823 | 🐛 142 | 🌐 TypeScript | 📅 2026-08-27 - Secure, Simple and Scalable Video Conferences that you use as a standalone app or embed in your web application.
...
* [Wekan](https://github.com/wekan/wekan) ⭐ 21,067 | 🐛 283 | 🌐 JavaScript | 📅 2026-08-27 - Meteor based Kanban Board.
* [openproject](https://github.com/opf/openproject) ⭐ 15,956 | 🐛 231 | 🌐 Ruby | 📅 2026-08-27 - The leading open source project management software.
* [leantime](https://github.com/Leantime/leantime) ⭐ 11,462 | 🐛 321 | 🌐 PHP | 📅 2026-08-15 - Leantime is a lean project management system for innovators.
* [Kanboard](https://github.com/kanboard/kanboard) ⭐ 9,827 | 🐛 160 | 🌐 PHP | 📅 2026-08-27 - Minimalistic Kanban Board.
* [Gitlab](https://github.com/sameersbn/docker-gitlab) ⭐ 8,103 | 🐛 576 | 🌐 Shell | 📅 2026-08-27 - Simple Selfhosted Gitlab Server with Docker.
...
* [JIRA API](https://github.com/pycontribs/jira) ⭐ 2,128 | 🐛 236 | 🌐 Python | 📅 2026-08-24 - Python Library for REST API of Jira.
...
* [Taiga API](https://github.com/nephila/python-taiga) ⭐ 138 | 🐛 18 | 🌐 Python | 📅 2026-08-24 - Python Library for REST API of Taiga.
...
* [Excalidraw](https://github.com/excalidraw/excalidraw) ⭐ 130,645 | 🐛 3,412 | 🌐 TypeScript | 📅 2026-08-27 - Virtual whiteboard for sketching hand-drawn like diagrams.
* [tesseract](https://github.com/tesseract-ocr/tesseract) ⭐ 76,211 | 🐛 488 | 🌐 C++ | 📅 2026-08-25 - Open Source OCR Engine.
* [Pandoc](https://github.com/jgm/pandoc) ⭐ 46,042 | 🐛 1,035 | 🌐 Haskell | 📅 2026-08-27 - Universal markup converter.
* [carbon](https://github.com/carbon-app/carbon) ⭐ 36,089 | 🐛 85 | 🌐 JavaScript | 📅 2026-02-10 - Share beautiful images of your source code.
* [OCRmyPDF](https://github.com/jbarlow83/OCRmyPDF) ⭐ 34,598 | 🐛 98 | 🌐 Python | 📅 2026-08-22 - Adds an OCR text layer to scanned PDF files, allowing them to be searched.
* [PlotNeuralNet](https://github.com/HarisIqbal88/PlotNeuralNet) ⭐ 24,956 | 🐛 89 | 🌐 TeX | 📅 2023-08-21 - Latex code for drawing neural networks for reports and presentation.
* [mkdocs](https://github.com/mkdocs/mkdocs/) ⭐ 22,382 | 🐛 188 | 🌐 Python | 📅 2025-10-20 - A fast, simple and downright gorgeous static site generator that's geared towards building project documentation.
* [overleaf](https://github.com/overleaf/overleaf) ⭐ 18,075 | 🐛 169 | 🌐 JavaScript | 📅 2026-07-10 - An open-source online real-time collaborative LaTeX editor.
* [asciinema](https://github.com/asciinema/asciinema) ⭐ 17,740 | 🐛 8 | 🌐 Rust | 📅 2026-08-14 - Lets you easily record terminal sessions and replay them in a terminal as well as in a web browser.
* [foam](https://github.com/foambubble/foam) ⭐ 17,379 | 🐛 30 | 🌐 TypeScript | 📅 2026-08-13 - Foam is a personal knowledge management and sharing system inspired by Roam Research, built on Visual Studio Code and GitHub.
* [Zotero](https://github.com/zotero/zotero) ⭐ 15,087 | 🐛 1,595 | 🌐 JavaScript | 📅 2026-08-27 - A free, easy-to-use tool to help you collect, organize, cite, and share your research sources.
* [gollum](https://github.com/gollum/gollum) ⭐ 14,318 | 🐛 91 | 🌐 Ruby | 📅 2025-11-24 - A simple, Git-powered wiki with a sweet API and local frontend.
...
* [Sphinx](https://github.com/sphinx-doc/sphinx/) ⭐ 7,991 | 🐛 1,420 | 🌐 Python | 📅 2026-08-23 - A tool that makes it easy to create intelligent and beautiful documentation for Python projects.
...
* [CodiMD](https://github.com/codimd/server) ⭐ 7,383 | 🐛 268 | 🌐 TypeScript | 📅 2026-08-27 - Open Source Online Real-time collaborate on team documentation in markdown.
* [buku](https://github.com/jarun/buku) ⭐ 7,185 | 🐛 6 | 🌐 Python | 📅 2026-08-16 - Browser-independent bookmark manager.
* [Doxygen](https://github.com/doxygen/doxygen) ⭐ 6,564 | 🐛 1,859 | 🌐 C++ | 📅 2026-08-26 - Doxygen is the de facto standard tool for generating documentation from annotated C++ sources.
* [papermill](https://github.com/nteract/papermill) ⭐ 6,476 | 🐛 196 | 🌐 Python | 📅 2026-07-06 - A tool for parameterizing, executing, and analyzing Jupyter Notebooks.
* [Markor](https://github.com/gsantner/markor) ⭐ 6,035 | 🐛 185 | 🌐 Java | 📅 2026-08-25 - A Simple Markdown Editor for your Android Device.
...
* [docsy](https://github.com/google/docsy-example) ⭐ 558 | 🐛 15 | 🌐 JavaScript | 📅 2026-08-27 - An example documentation site using the Docsy Hugo theme.
...
* [fossology](https://github.com/fossology/fossology) ⭐ 1,021 | 🐛 304 | 🌐 HTML | 📅 2026-08-20 - A toolkit you can run license, copyright and export control scans from the command line.
* [doorstop](https://github.com/doorstop-dev/doorstop) ⭐ 658 | 🐛 56 | 🌐 Python | 📅 2026-08-26 - Requirements management using version control.
...
* [Architecture\_Decision\_Record](https://github.com/joelparkerhenderson/architecture_decision_record) ⭐ 16,751 | 🐛 10 | 📅 2026-08-20 - A document that captures an important architectural decision made along with its context and consequences.
* [vscode-drawio](https://github.com/hediet/vscode-drawio) ⭐ 9,482 | 🐛 179 | 🌐 TypeScript | 📅 2026-08-23 - This extension integrates Draw\.io into VS Code.
...
* [OpenPilot](https://github.com/commaai/openpilot) ⭐ 63,522 | 🐛 135 | 🌐 Python | 📅 2026-08-27 - Open Source Adaptive Cruise Control (ACC) and Lane Keeping Assist System (LKAS).
* [PythonRobotics](https://github.com/AtsushiSakai/PythonRobotics/) ⭐ 30,395 | 🐛 51 | 🌐 Python | 📅 2026-08-24 - This is a Python code collection of robotics algorithms, especially for autonomous navigation.
* [Apollo](https://github.com/ApolloAuto/apollo) ⭐ 26,807 | 🐛 1,045 | 🌐 C++ | 📅 2026-04-16 - High performance, flexible architecture which accelerates the development, testing, and deployment of Autonomous Vehicles.
* [ArduPilot](https://github.com/ArduPilot/ardupilot) ⭐ 15,754 | 🐛 3,158 | 🌐 C++ | 📅 2026-08-27 - Open source control software for autonomous vehicles - copters/planes/rovers/boats/submersibles.
* [PX4](https://github.com/PX4/Firmware) ⭐ 12,504 | 🐛 336 | 🌐 C++ | 📅 2026-08-27 - An open source flight control software for drones and other unmanned vehicles.
* [F Prime](https://github.com/nasa/fprime) ⭐ 11,700 | 🐛 459 | 🌐 C++ | 📅 2026-08-26 - A component-driven framework that enables rapid development and deployment of spaceflight and other embedded software applications.
* [open-source-rover](https://github.com/nasa-jpl/open-source-rover) ⭐ 9,611 | 🐛 17 | 🌐 Prolog | 📅 2026-08-13 - A build-it-yourself, 6-wheel rover based on the rovers on Mars from JPL.
...
* [astrobee](https://github.com/nasa/astrobee) ⭐ 1,397 | 🐛 31 | 🌐 C++ | 📅 2025-12-02 - Astrobee is a free-flying robot designed to operate as a payload inside the International Space Station (ISS).
...
* [clover](https://github.com/CopterExpress/clover) ⭐ 684 | 🐛 14 | 🌐 C++ | 📅 2026-04-14 - ROS-based framework and RPi image to control PX4-powered drones.
* [JdeRobot Academy](https://github.com/JdeRobot/RoboticsAcademy) ⭐ 492 | 🐛 61 | 🌐 Python | 📅 2026-08-16 - JdeRobot Academy is an open source collection of exercises to learn robotics in a practical way.
* [CARMAPlatform](https://github.com/usdot-fhwa-stol/CARMAPlatform) ⭐ 436 | 🐛 271 | 🌐 C++ | 📅 2026-08-26 - Enables cooperative automated driving plug-in.
...
* [COMPAS](https://github.com/compas-dev/compas_fab) ⭐ 137 | 🐛 83 | 🌐 Python | 📅 2026-08-27 - Robotic fabrication package for the COMPAS Framework.
...
* [Visual Studio Code](https://github.com/Microsoft/vscode) ⭐ 189,708 | 🐛 20,143 | 🌐 TypeScript | 📅 2026-08-27 - Code editor for edit-build-debug cycle.
* [atom](https://github.com/atom/atom) ⚠️ Archived - Hackable text editor for the 21st century.
* [pybind11](https://github.com/pybind/pybind11) ⭐ 18,008 | 🐛 714 | 🌐 C++ | 📅 2026-08-25 - Seamless operability between C++11 and Python.
* [Sourcetrail](https://github.com/CoatiSoftware/Sourcetrail) ⚠️ Archived - Free and open-source cross-platform source explorer.
* [Gitpod](https://github.com/gitpod-io/gitpod) ⭐ 13,758 | 🐛 456 | 🌐 TypeScript | 📅 2026-08-24 - An open source developer platform that automates the provisioning of ready-to-code development environments.
* [TabNine](https://github.com/zxqfl/TabNine) ⭐ 10,774 | 🐛 0 | 🌐 Shell | 📅 2025-09-04 - The all-language autocompleter.
* [jedi](https://github.com/davidhalter/jedi) ⭐ 6,173 | 🐛 70 | 🌐 Python | 📅 2026-07-09 - Autocompletion and static analysis library for python.
...
* [ROS](https://github.com/leggedrobotics/ros_best_practices/tree/master/ros_package_template) ⭐ 1,636 | 🐛 9 | 🌐 C++ | 📅 2022-01-22 - Template for ROS node standardization in C++.
...
* [VS Code ROS2 Workspace Template](https://github.com/athackst/vscode_ros2_workspace) ⭐ 995 | 🐛 0 | 🌐 Python | 📅 2026-08-18 -  Template for using VSCode as an IDE for ROS2 development.
...
* [aptly](https://github.com/aptly-dev/aptly) ⭐ 2,875 | 🐛 216 | 🌐 Go | 📅 2026-08-09 - Debian repository management tool.
...
* [superflore](https://github.com/ros-infrastructure/superflore) ⭐ 62 | 🐛 21 | 🌐 Python | 📅 2026-08-20 - An extended platform release manager for Robot Operating System.
...
* [googletest](https://github.com/google/googletest) ⭐ 38,998 | 🐛 491 | 🌐 C++ | 📅 2026-08-27 - Google's C++ test framework.
* [pytest](https://github.com/pytest-dev/pytest/) ⭐ 14,449 | 🐛 807 | 🌐 Python | 📅 2026-08-27 - The pytest framework makes it easy to write small tests, yet scales to support complex functional testing.
...
* [black](https://github.com/psf/black) ⭐ 41,818 | 🐛 303 | 🌐 Python | 📅 2026-08-20 - The uncompromising Python code formatter.
* [shellcheck](https://github.com/koalaman/shellcheck) ⭐ 39,944 | 🐛 1,138 | 🌐 Haskell | 📅 2026-08-04 - A static analysis tool for shell scripts.
* [pydantic](https://github.com/samuelcolvin/pydantic) ⭐ 28,638 | 🐛 577 | 🌐 Python | 📅 2026-08-27 - Data parsing and validation using Python type hints.
...
* [cppcheck](https://github.com/danmar/cppcheck) ⭐ 6,733 | 🐛 201 | 🌐 C++ | 📅 2026-08-27 - Static analysis of C/C++ code.
* [pylint](https://github.com/PyCQA/pylint/) ⭐ 5,718 | 🐛 1,078 | 🌐 Python | 📅 2026-08-27 - Pylint is a Python static code analysis tool which looks for programming errors, helps enforcing a coding standard, sniffs for code smells and offers simple refactoring suggestions.
...
* [bcc](https://github.com/iovisor/bcc) ⭐ 22,640 | 🐛 1,069 | 🌐 C | 📅 2026-08-27 - Tools for BPF-based Linux IO analysis, networking, monitoring, and more.
* [FlameGraph](https://github.com/brendangregg/FlameGraph) ⭐ 19,700 | 🐛 174 | 🌐 Perl | 📅 2024-10-20 - Visualize profiled code.
* [tracy](https://github.com/wolfpld/tracy) ⭐ 16,672 | 🐛 168 | 🌐 C++ | 📅 2026-08-27 - A real time, nanosecond resolution, remote telemetry frame profiler for games and other applications.
* [sanitizer](https://github.com/google/sanitizers) ⭐ 12,455 | 🐛 549 | 🌐 C | 📅 2026-05-19 - AddressSanitizer, ThreadSanitizer, MemorySanitizer.
...
* [bpftrace](https://github.com/iovisor/bpftrace) ⭐ 10,298 | 🐛 252 | 🌐 C++ | 📅 2026-08-24 - High-level tracing language for Linux eBPF.
...
* [heaptrack](https://github.com/KDE/heaptrack) ⭐ 4,154 | 🐛 6 | 🌐 C++ | 📅 2026-08-12 - Traces all memory allocations and annotates these events with stack traces.
* [qira](https://github.com/geohot/qira) ⭐ 4,070 | 🐛 69 | 🌐 C | 📅 2022-07-02 - QIRA is a competitor to strace and gdb.
* [action-tmate](https://github.com/mxschmitt/action-tmate) ⭐ 3,579 | 🐛 36 | 🌐 JavaScript | 📅 2026-07-29 - Debug your GitHub Actions via SSH by using tmate to get access to the runner system itself.
* [pudb](https://github.com/inducer/pudb) ⭐ 3,248 | 🐛 164 | 🌐 Python | 📅 2026-08-23 - Full-screen console debugger for Python.
* [gdb-frontend](https://github.com/rohanrhu/gdb-frontend) ⭐ 3,025 | 🐛 16 | 🌐 JavaScript | 📅 2025-11-12 - GDBFrontend is an easy, flexible and extensionable gui debugger.
* [pyperformance](https://github.com/python/pyperformance) ⭐ 1,028 | 🐛 72 | 🌐 Python | 📅 2026-08-17 - Python Performance Benchmark Suite.
...
* [lazygit](https://github.com/jesseduffield/lazygit) ⭐ 81,691 | 🐛 1,021 | 🌐 Go | 📅 2026-08-27 - A simple terminal UI for git commands, written in Go with the gocui library.
* [dive](https://github.com/wagoodman/dive) ⭐ 54,506 | 🐛 212 | 🌐 Go | 📅 2025-12-15 - A tool for exploring each layer in a docker image.
* [learnGitBranching](https://github.com/pcottle/learnGitBranching) ⭐ 33,958 | 🐛 62 | 🌐 JavaScript | 📅 2026-08-25 - A git repository visualizer, sandbox, and a series of educational tutorials and challenges.
* [semantic-release](https://github.com/semantic-release/semantic-release) ⭐ 24,009 | 🐛 404 | 🌐 JavaScript | 📅 2026-08-26 - Fully automated version management and package publishing.
* [dvc](https://github.com/iterative/dvc) ⭐ 15,845 | 🐛 201 | 🌐 Python | 📅 2026-08-24 - Management and versioning of datasets and machine learning models.
* [tig](https://github.com/jonas/tig) ⭐ 13,318 | 🐛 232 | 🌐 C | 📅 2026-07-27 - Text-mode interface for git.
* [bfg-repo-cleaner](https://github.com/rtyley/bfg-repo-cleaner) ⭐ 12,177 | 🐛 275 | 🌐 Scala | 📅 2025-01-19 - Removes large or troublesome blobs like git-filter-branch does, but faster.
* [git-secret](https://github.com/sobolevn/git-secret) ⭐ 4,038 | 🐛 152 | 🌐 Shell | 📅 2026-08-24 - Encrypts files with permitted users' public keys, allowing users you trust to access encrypted data using pgp and their secret keys.
* [nbdime](https://github.com/jupyter/nbdime) ⭐ 2,840 | 🐛 96 | 🌐 TypeScript | 📅 2026-06-10 - Tools for diffing and merging of Jupyter notebooks.
...
* [git-cola](https://github.com/git-cola/git-cola) ⭐ 2,567 | 🐛 5 | 🌐 Python | 📅 2026-08-21 - The highly caffeinated Git GUI.
* [python-gitlab](https://github.com/python-gitlab/python-gitlab) ⭐ 2,472 | 🐛 31 | 🌐 Python | 📅 2026-08-27 - A Python package providing access to the GitLab server API.
...
* [meld](https://github.com/GNOME/meld) ⭐ 1,308 | 🐛 0 | 🌐 Python | 📅 2026-08-25 - Meld is a visual diff and merge tool that helps you compare files, directories, and version controlled projects.
...
* [AirSim](https://github.com/microsoft/AirSim) ⭐ 18,425 | 🐛 780 | 🌐 C++ | 📅 2026-06-30 - Open source simulator for autonomous vehicles built on Unreal Engine.
* [carla](https://github.com/carla-simulator/carla) ⭐ 14,329 | 🐛 1,192 | 🌐 C++ | 📅 2026-08-27 - Open-source simulator for autonomous driving research.
* [Webots](https://github.com/cyberbotics/webots) ⭐ 4,578 | 🐛 228 | 🌐 C++ | 📅 2026-08-27 - Webots is an open source robot simulator compatible (among others) with [ROS](http://wiki.ros.org/webots_ros) and [ROS2](http://wiki.ros.org/webots_ros2).
* [Drake](https://github.com/RobotLocomotion/drake) ⭐ 4,158 | 🐛 651 | 🌐 C++ | 📅 2026-08-27 - Drake aims to simulate even very complex dynamics of robots.
* [sumo](https://github.com/eclipse/sumo) ⭐ 4,149 | 🐛 2,974 | 🌐 Python | 📅 2026-08-27 - Eclipse SUMO is an open source, highly portable, microscopic and continuous road traffic simulation package designed to handle large road networks.
...
* [highway-env](https://github.com/eleurent/highway-env) ⭐ 3,299 | 🐛 40 | 🌐 Python | 📅 2026-08-22 - A collection of environments for autonomous driving and tactical decision-making tasks.
* [Unity-Robotics-Hub](https://github.com/Unity-Technologies/Unity-Robotics-Hub) ⭐ 2,566 | 🐛 56 | 🌐 C# | 📅 2024-11-26 - Central repository for tools, tutorials, resources, and documentation for robotic simulation in Unity.
...
* [champ](https://github.com/chvmp/champ) ⭐ 2,306 | 🐛 54 | 🌐 C++ | 📅 2024-07-04 - ROS Packages for CHAMP Quadruped Controller.
* [gym-pybullet-drones](https://github.com/utiasDSL/gym-pybullet-drones) ⭐ 2,118 | 🐛 110 | 🌐 Python | 📅 2026-08-23 - PyBullet-based Gym environments for single and multi-agent reinforcement learning of quadcopter control.
* [AI2-THOR](https://github.com/allenai/ai2thor) ⭐ 1,785 | 🐛 279 | 🌐 C# | 📅 2025-11-04 - Python framework with a Unity backend providing interaction, navigation, and manipulation support for household based robotic agents, consisting of 200+ of custom scenes, 1500+ custom annotated objects, and 200+ actions.
...
* [awesome-CARLA](https://github.com/Amin-Tgz/awesome-CARLA) ⭐ 914 | 🐛 0 | 📅 2024-03-27 - A curated list of awesome CARLA tutorials, blogs, and related projects.
...
* [BlueSky](https://github.com/TUDelft-CNS-ATM/bluesky) ⭐ 554 | 🐛 50 | 🌐 Python | 📅 2026-08-27 - The goal of BlueSky is to provide everybody who wants to visualize, analyze or simulate air traffic with a tool to do so without any restrictions, licenses or limitations.
...
* [42](https://github.com/ericstoneking/42) ⭐ 451 | 🐛 26 | 🌐 C | 📅 2026-08-13 - Simulation for spacecraft attitude control system analysis and design.
...
* [Trick](https://github.com/nasa/Trick) ⭐ 158 | 🐛 114 | 🌐 C++ | 📅 2026-08-26 - Developed at the NASA Johnson Space Center, is a powerful simulation development framework that enables users to build applications for all phases of space vehicle development.
...
* [FreeCAD](https://github.com/FreeCAD/FreeCAD) ⭐ 33,097 | 🐛 4,113 | 🌐 C++ | 📅 2026-08-27 - Your own 3D parametric modeler.
* [openscad](https://github.com/openscad/openscad) ⭐ 10,035 | 🐛 819 | 🌐 C++ | 📅 2026-08-27 -  A software for creating solid 3D CAD models.
* [WireViz](https://github.com/formatc1702/WireViz) ⭐ 5,231 | 🐛 195 | 🌐 Python | 📅 2026-06-06 - A tool for easily documenting cables, wiring harnesses and connector pinouts.
* [NASA-3D-Resources](https://github.com/nasa/NASA-3D-Resources) ⭐ 3,757 | 🐛 4 | 📅 2025-06-03 - Here you'll find a growing collection of 3D models, textures, and images from inside NASA.
* [ODrive](https://github.com/madcowswe/ODrive) ⭐ 3,745 | 🐛 18 | 🌐 C++ | 📅 2026-01-20 - The aim is to make it possible to use inexpensive brushless motors in high performance robotics projects.
* [LibrePCB](https://github.com/LibrePCB/LibrePCB) ⭐ 2,971 | 🐛 216 | 🌐 C++ | 📅 2026-08-25 - A powerful, innovative and intuitive EDA tool for everyone.
* [GNSS-SDR](https://github.com/gnss-sdr/gnss-sdr) ⭐ 2,216 | 🐛 232 | 🌐 C++ | 📅 2026-08-27 - GNSS-SDR provides interfaces for a wide range of radio frequency front-ends and raw sample file formats, generates processing outputs in standard formats.
* [pvlib-python](https://github.com/pvlib/pvlib-python) ⭐ 1,643 | 🐛 244 | 🌐 Python | 📅 2026-08-19 - A community supported tool that provides a set of functions and classes for simulating the performance of photovoltaic energy systems.
* [PcbDraw](https://github.com/yaqwsx/PcbDraw) ⭐ 1,414 | 🐛 10 | 🌐 Python | 📅 2026-08-07 - Convert your KiCAD board into a nice looking 2D drawing suitable for pinout diagrams.
...
* [kicad-3rd-party-tools](https://github.com/xesscorp/kicad-3rd-party-tools) ⭐ 839 | 🐛 4 | 📅 2026-05-15 - Tools made by others to augment the KiCad PCB EDA suite.
* [OpenMDAO](https://github.com/OpenMDAO/OpenMDAO) ⭐ 773 | 🐛 76 | 🌐 Python | 📅 2026-08-25 - An open-source framework for efficient multidisciplinary optimization.
* [solidworks\_urdf\_exporter](https://github.com/ros/solidworks_urdf_exporter) ⭐ 670 | 🐛 48 | 🌐 C# | 📅 2026-06-05 - SolidWorks to URDF Exporter.
* [cadCAD](https://github.com/cadCAD-org/cadCAD) ⭐ 615 | 🐛 11 | 🌐 Python | 📅 2024-04-19 - A Python package that assists in the processes of designing, testing and validating complex systems through simulation, with support for Monte Carlo methods, A/B testing and parameter sweeping.
...
* [SUAVE](https://github.com/suavecode/SUAVE) ⭐ 527 | 🐛 39 | 🌐 ReScript | 📅 2024-02-14 - An Aircraft Design Toolbox.
* [oemof-solph](https://github.com/oemof/oemof-solph) ⭐ 417 | 🐛 117 | 🌐 Python | 📅 2026-08-27 - A modular open source framework to model energy supply systems.
...
* [tigl](https://github.com/DLR-SC/tigl) ⭐ 302 | 🐛 135 | 🌐 C++ | 📅 2026-08-27 - The TiGL Geometry Library can be used for the computation and processing of aircraft geometries stored inside CPACS files.
...
* [opem](https://github.com/ECSIM/opem) ⭐ 231 | 🐛 2 | 🌐 Python | 📅 2026-08-17 - The Open-Source PEMFC Simulation Tool (OPEM) is a modeling tool for evaluating the performance of proton exchange membrane fuel cells.
...
* [lidar\_camera\_calibration](https://github.com/ankitdhall/lidar_camera_calibration) ⭐ 1,766 | 🐛 61 | 🌐 C++ | 📅 2025-10-16 - ROS package to find a rigid-body transformation between a LiDAR and a camera.
...
* [lidar\_align](https://github.com/ethz-asl/lidar_align) ⭐ 1,054 | 🐛 29 | 🌐 C++ | 📅 2025-03-11 - A simple method for finding the extrinsic calibration between a 3D lidar and a 6-dof pose sensor.
* [ikpy](https://github.com/Phylliade/ikpy) ⭐ 1,029 | 🐛 24 | 🌐 Python | 📅 2026-08-08 - An Inverse Kinematics library aiming performance and modularity.
...
* [ray](https://github.com/ray-project/ray) ⭐ 43,622 | 🐛 3,541 | 🌐 Python | 📅 2026-08-27 - A fast and simple framework for building and running distributed applications.
* [gym](https://github.com/openai/gym) ⚠️ Archived - A toolkit for developing and comparing reinforcement learning algorithms.
* [Netron](https://github.com/lutzroeder/Netron) ⭐ 33,414 | 🐛 18 | 🌐 JavaScript | 📅 2026-08-27 - Visualizer for neural network, deep learning and machine learning models.
* [fastai](https://github.com/fastai/fastai) ⭐ 28,126 | 🐛 267 | 🌐 Jupyter Notebook | 📅 2026-08-15 - The fastai library simplifies training fast and accurate neural nets using modern best practices.
* [mlflow](https://github.com/mlflow/mlflow) ⭐ 27,692 | 🐛 2,061 | 🌐 Python | 📅 2026-08-27 - A platform to streamline machine learning development, including tracking experiments, packaging code into reproducible runs, and sharing and deploying models.
* [MNN](https://github.com/alibaba/MNN) ⭐ 15,976 | 🐛 40 | 🌐 C++ | 📅 2026-08-25 - A blazing fast, lightweight deep learning framework, battle-tested by business-critical use cases in Alibaba.
...
* [cnn-explainer](https://github.com/poloclub/cnn-explainer) ⭐ 9,029 | 🐛 7 | 🌐 JavaScript | 📅 2023-10-14 - Learning Convolutional Neural Networks with Interactive Visualization.
...
* [Tensorflow Federated](https://github.com/tensorflow/federated) ⭐ 2,448 | 🐛 290 | 🌐 Python | 📅 2026-08-26 - TensorFlow Federated (TFF) is an open-source framework for machine learning and other computations on decentralized data.
* [finn](https://github.com/Xilinx/finn) ⭐ 1,044 | 🐛 114 | 🌐 Python | 📅 2026-08-27 - Fast, Scalable Quantized Neural Network Inference on FPGAs.
...
* [dask](https://github.com/dask/dask) ⭐ 13,897 | 🐛 1,313 | 🌐 Python | 📅 2026-08-24 - Parallel computing with task scheduling for Python.
* [TensorRT](https://github.com/NVIDIA/TensorRT) ⭐ 13,294 | 🐛 629 | 🌐 C++ | 📅 2026-08-25 - A C++ library for high performance inference on NVIDIA GPUs and deep learning accelerators.
* [cupy](https://github.com/cupy/cupy) ⭐ 12,280 | 🐛 710 | 🌐 Python | 📅 2026-08-25 - NumPy-like API accelerated with CUDA.
* [numba](https://github.com/numba/numba) ⭐ 11,131 | 🐛 1,795 | 🌐 Python | 📅 2026-08-27 - NumPy aware dynamic Python compiler using LLVM.
...
* [PYNQ](https://github.com/Xilinx/PYNQ) ⭐ 2,339 | 🐛 58 | 🌐 Jupyter Notebook | 📅 2026-08-26 - An open-source project from Xilinx that makes it easy to design embedded systems with Zynq All Programmable Systems on Chips.
...
* [detectron2](https://github.com/facebookresearch/detectron2) ⭐ 34,690 | 🐛 585 | 🌐 Python | 📅 2026-08-19 - A next-generation research platform for object detection and segmentation.
* [EasyOCR](https://github.com/JaidedAI/EasyOCR) ⭐ 29,943 | 🐛 530 | 🌐 Python | 📅 2025-12-05 - Ready-to-use Optical character recognition (OCR) with 40+ languages supported including Chinese, Japanese, Korean and Thai.
* [imgaug](https://github.com/aleju/imgaug) ⭐ 14,744 | 🐛 311 | 🌐 Python | 📅 2024-07-30 - Image augmentation for machine learning experiments.
* [meshroom](https://github.com/alicevision/meshroom) ⭐ 12,928 | 🐛 516 | 🌐 Python | 📅 2026-08-26 - Meshroom is a free, open-source 3D Reconstruction Software based on the AliceVision Photogrammetric Computer Vision framework.
* [libvips](https://github.com/libvips/libvips) ⭐ 11,608 | 🐛 80 | 🌐 C | 📅 2026-08-27 - A fast image processing library with low memory needs.
* [satellite-image-deep-learning](https://github.com/robmarkcole/satellite-image-deep-learning) ⭐ 10,243 | 🐛 0 | 📅 2026-08-02 - Resources for deep learning with satellite & aerial imagery.
...
* [AliceVision](https://github.com/alicevision/AliceVision) ⭐ 3,486 | 🐛 42 | 🌐 C++ | 📅 2026-08-27 - A Photogrammetric Computer Vision Framework which provides a 3D Reconstruction and Camera Tracking algorithms.
...
* [Simd](https://github.com/ermig1979/Simd) ⭐ 2,265 | 🐛 25 | 🌐 C++ | 📅 2026-08-27 - C++ image processing and machine learning library with using of SIMD: SSE, SSE2, SSE3, SSSE3, SSE4.1, SSE4.2, AVX, AVX2, AVX-512, VMX(Altivec) and VSX(Power7), NEON for ARM.
...
* [satpy](https://github.com/pytroll/satpy) ⭐ 1,204 | 🐛 559 | 🌐 Python | 📅 2026-08-27 - A python library for reading and manipulating meteorological remote sensing data and writing it to various image and data file formats.
...
* [image\_pipeline](https://github.com/ros-perception/image_pipeline) ⭐ 960 | 🐛 57 | 🌐 C++ | 📅 2026-08-27 - Fills the gap between getting raw images from a camera driver and higher-level vision processing.
...
* [vision\_opencv](https://github.com/ros-perception/vision_opencv) ⭐ 668 | 🐛 68 | 🌐 C++ | 📅 2025-12-29 - Packages for interfacing ROS with OpenCV, a library of programming functions for real time computer vision.
...
* [open3d](https://github.com/intel-isl/Open3D) ⭐ 13,919 | 🐛 1,304 | 🌐 C++ | 📅 2026-08-27 - Open3D: A Modern Library for 3D Data Processing.
* [Draco](https://github.com/google/draco) ⭐ 7,458 | 🐛 174 | 🌐 C++ | 📅 2026-08-18 - A library for compressing and decompressing 3D geometric meshes and point clouds.
* [mmdetection3d](https://github.com/open-mmlab/mmdetection3d) ⭐ 6,519 | 🐛 656 | 🌐 Python | 📅 2024-07-10 - Next-generation platform for general 3D object detection.
* [PCDet](https://github.com/sshaoshuai/PCDet) ⭐ 5,695 | 🐛 30 | 🌐 Python | 📅 2025-10-08 - A general PyTorch-based codebase for 3D object detection from point cloud.
* [OpenPCDet](https://github.com/open-mmlab/OpenPCDet) ⭐ 5,695 | 🐛 30 | 🌐 Python | 📅 2025-10-08 - A Toolbox for LiDAR-based 3D Object Detection.
* [kaolin](https://github.com/NVIDIAGameWorks/kaolin) ⭐ 5,161 | 🐛 29 | 🌐 Python | 📅 2026-08-24 - A PyTorch Library for Accelerating 3D Deep Learning Research.
* [grid\_map](https://github.com/ANYbotics/grid_map) ⭐ 3,225 | 🐛 168 | 🌐 C++ | 📅 2026-01-13 - Universal grid map library for mobile robotic mapping.
...
* [KISS-ICP](https://github.com/PRBonn/kiss-icp) ⭐ 2,305 | 🐛 18 | 🌐 C++ | 📅 2026-06-09 - A LiDAR Odometry pipeline that just works on most of the cases without tunning any parameter.
* [python-pcl](https://github.com/strawlab/python-pcl) ⚠️ Archived - Python bindings to the pointcloud library.
* [elevation\_mapping](https://github.com/ANYbotics/elevation_mapping) ⭐ 1,857 | 🐛 101 | 🌐 C++ | 📅 2024-11-04 - Robot-centric elevation mapping for rough terrain navigation.
* [libpointmatcher](https://github.com/ethz-asl/libpointmatcher) ⭐ 1,828 | 🐛 100 | 🌐 C++ | 📅 2026-08-27 - An "Iterative Closest Point" library for 2-D/3-D mapping in Robotics.
* [Votenet](https://github.com/facebookresearch/votenet) ⚠️ Archived - Deep Hough Voting for 3D Object Detection in Point Clouds.
* [fast\_gicp](https://github.com/SMRT-AIST/fast_gicp) ⭐ 1,686 | 🐛 76 | 🌐 C++ | 📅 2025-04-24 - A collection of GICP-based fast point cloud registration algorithms.
...
* [Det3D](https://github.com/poodarchu/Det3D) ⭐ 1,560 | 🐛 20 | 🌐 Python | 📅 2023-12-19 - A first 3D Object Detection toolbox which provides off the box implementations of many 3D object detection algorithms such as PointPillars, SECOND, PIXOR.
* [PointCNN](https://github.com/yangyanli/PointCNN) ⭐ 1,434 | 🐛 61 | 🌐 Python | 📅 2026-03-12 - A simple and general framework for feature learning from point clouds.
* [PDAL](https://github.com/PDAL/PDAL) ⭐ 1,404 | 🐛 134 | 🌐 C++ | 📅 2026-08-27 - A C++ BSD library for translating and manipulating point cloud data.
...
* [LAStools](https://github.com/LAStools/LAStools) ⭐ 1,064 | 🐛 59 | 🌐 C++ | 📅 2026-08-21 - Award-winning software for efficient LiDAR processing.
...
* [spatio\_temporal\_voxel\_layer](https://github.com/SteveMacenski/spatio_temporal_voxel_layer) ⭐ 856 | 🐛 16 | 🌐 C++ | 📅 2026-08-05 - A new voxel layer leveraging modern 3D graphics tools to modernize navigation environmental representations.
...
* [CSF](https://github.com/jianboqi/CSF) ⭐ 643 | 🐛 16 | 🌐 C++ | 📅 2025-08-13 - LiDAR point cloud ground filtering / segmentation (bare earth extraction) method based on cloth simulation.
* [pptk](https://github.com/heremaps/pptk) ⭐ 634 | 🐛 59 | 🌐 C++ | 📅 2020-09-17 - Point Processing Toolkit from HEREMaps.
* [pointcloud\_to\_laserscan](https://github.com/ros-perception/pointcloud_to_laserscan) ⭐ 597 | 🐛 10 | 🌐 C++ | 📅 2025-08-28 - Converts a 3D Point Cloud into a 2D laser scan.
...
* [mp2p\_icp](https://github.com/MOLAorg/mp2p_icp) ⭐ 188 | 🐛 4 | 🌐 C++ | 📅 2026-08-25 - A repertory of multi primitive-to-primitive (MP2P) ICP algorithms in C++.
...
* [Kalman-and-Bayesian-Filters-in-Python](https://github.com/rlabbe/Kalman-and-Bayesian-Filters-in-Python) ⭐ 19,222 | 🐛 143 | 🌐 Jupyter Notebook | 📅 2024-08-07 - Kalman Filter book using Jupyter Notebook.
* [evo](https://github.com/MichaelGrupp/evo) ⭐ 4,308 | 🐛 9 | 🌐 Python | 📅 2026-08-14 - Python package for the evaluation of odometry and SLAM.
* [PROJ](https://github.com/OSGeo/PROJ) ⭐ 2,008 | 🐛 100 | 🌐 C++ | 📅 2026-08-27 - Cartographic Projections and Coordinate Transformations Library.
* [robot\_localization](https://github.com/cra-ros-pkg/robot_localization) ⭐ 1,949 | 🐛 92 | 🌐 C++ | 📅 2026-07-16 - A package of nonlinear state estimation nodes.
...
* [ai-imu-dr](https://github.com/mbrossar/ai-imu-dr) ⭐ 997 | 🐛 39 | 🌐 Python | 📅 2025-01-08 - Contains the code of our novel accurate method for dead reckoning of wheeled vehicles based only on an IMU.
* [RTKLIB](https://github.com/rtklibexplorer/RTKLIB) ⭐ 966 | 🐛 84 | 🌐 C | 📅 2026-08-26 - A version of RTKLIB optimized for single and dual frequency low cost GPS receivers, especially u-blox receivers.
...
* [fuse](https://github.com/locusrobotics/fuse) ⭐ 876 | 🐛 48 | 🌐 C++ | 📅 2026-08-19 - General architecture for performing sensor fusion live on a robot.
* [eagleye](https://github.com/MapIV/eagleye) ⭐ 773 | 🐛 24 | 🌐 C++ | 📅 2026-04-06 -  An open-source software for vehicle localization utilizing GNSS and IMU.
...
* [LIO\_SAM](https://github.com/TixiaoShan/LIO-SAM) ⭐ 4,895 | 🐛 183 | 🌐 C++ | 📅 2025-02-14 - Tightly-coupled Lidar Inertial Odometry via Smoothing and Mapping.
* [pyslam](https://github.com/luigifreda/pyslam) ⭐ 3,402 | 🐛 1 | 🌐 Python | 📅 2026-08-23 - Contains a monocular Visual Odometry (VO) pipeline in Python.
* [maplab](https://github.com/ethz-asl/maplab) ⭐ 2,867 | 🐛 123 | 🌐 C++ | 📅 2024-05-31 - An open visual-inertial mapping framework.
...
* [slam\_toolbox](https://github.com/SteveMacenski/slam_toolbox) ⭐ 2,610 | 🐛 48 | 🌐 C++ | 📅 2026-08-19 - Slam Toolbox for lifelong mapping and localization in potentially massive maps with ROS .
* [A-LOAM](https://github.com/HKUST-Aerial-Robotics/A-LOAM) ⭐ 2,439 | 🐛 52 | 🌐 C++ | 📅 2023-10-19 - Advanced implementation of LOAM.
* [hdl\_graph\_slam](https://github.com/koide3/hdl_graph_slam) ⭐ 2,333 | 🐛 126 | 🌐 C++ | 📅 2024-07-16 - An open source ROS package for real-time 6DOF SLAM using a 3D LIDAR.
* [KISS-ICP](https://github.com/PRBonn/kiss-icp) ⭐ 2,305 | 🐛 18 | 🌐 C++ | 📅 2026-06-09 - A LiDAR Odometry pipeline that just works on most of the cases without tunning any parameter.
* [cartographer\_ros](https://github.com/googlecartographer/cartographer_ros) ⭐ 1,853 | 🐛 289 | 🌐 C++ | 📅 2024-03-10 - Provides ROS integration for Cartographer.
...
* [mola](https://github.com/MOLAorg/mola) ⭐ 999 | 🐛 32 | 🌐 C++ | 📅 2026-08-27 - A Modular System for Localization and Mapping.
...
* [ORB\_SLAM3](https://github.com/UZ-SLAMLab/ORB_SLAM3) ⭐ 8,987 | 🐛 571 | 🌐 C++ | 📅 2024-07-24 - ORB-SLAM3: An Accurate Open-Source Library for Visual, Visual-Inertial and Multi-Map SLAM.
* [VINS-Fusion](https://github.com/HKUST-Aerial-Robotics/VINS-Fusion) ⭐ 4,687 | 🐛 212 | 🌐 C++ | 📅 2024-05-23 - A Robust and Versatile Multi-Sensor Visual-Inertial State Estimator.
* [hloc](https://github.com/cvg/Hierarchical-Localization) ⭐ 4,195 | 🐛 162 | 🌐 Python | 📅 2025-12-10 - A modular toolbox for state-of-the-art 6-DoF visual localization. It implements Hierarchical Localization, leveraging image retrieval and feature matching, and is fast, accurate, and scalable.
* [open\_vins](https://github.com/rpng/open_vins) ⭐ 3,060 | 🐛 73 | 🌐 C++ | 📅 2025-11-30 - An open source platform for visual-inertial navigation research.
...
* [Kimera](https://github.com/MIT-SPARK/Kimera) ⭐ 2,119 | 🐛 2 | 📅 2021-01-30 - A C++ library for real-time metric-semantic simultaneous localization and mapping, which uses camera images and inertial data to build a semantically annotated 3D mesh of the environment.
...
* [Mapbox](https://github.com/mapbox/mapbox-gl-js) ⭐ 12,391 | 🐛 1,461 | 🌐 TypeScript | 📅 2026-08-26 - A JavaScript library for interactive, customizable vector maps on the web.
* [osrm-backend](https://github.com/Project-OSRM/osrm-backend) ⭐ 8,014 | 🐛 360 | 🌐 C++ | 📅 2026-08-24 - Open Source Routing Machine - C++ backend.
* [gdal](https://github.com/OSGeo/gdal) ⭐ 6,033 | 🐛 578 | 🌐 C++ | 📅 2026-08-27 - GDAL is an open source X/MIT licensed translator library for raster and vector geospatial data formats.
...
* [geopandas](https://github.com/geopandas/geopandas) ⭐ 5,231 | 🐛 429 | 🌐 Python | 📅 2026-08-27 - A project to add support for geographic data to pandas objects.
* [mapnik](https://github.com/mapnik/mapnik) ⭐ 3,955 | 🐛 727 | 🌐 C++ | 📅 2026-08-26 - Combines pixel-perfect image output with lightning-fast cartographic algorithms, and exposes interfaces in C++, Python, and Node.
* [iD](https://github.com/openstreetmap/iD) ⭐ 3,864 | 🐛 1,010 | 🌐 JavaScript | 📅 2026-08-27 - The easy-to-use OpenStreetMap editor in JavaScript.
* [MapsModelsImporter](https://github.com/eliemichel/MapsModelsImporter) ⭐ 2,809 | 🐛 132 | 🌐 Python | 📅 2024-04-21 - A Blender add-on to import models from google maps.
* [3d-tiles](https://github.com/CesiumGS/3d-tiles) ⭐ 2,598 | 🐛 96 | 🌐 Batchfile | 📅 2026-08-27 - Specification for streaming massive heterogeneous 3D geospatial datasets.
* [grass](https://github.com/OSGeo/grass) ⭐ 1,154 | 🐛 701 | 🌐 C | 📅 2026-08-26 - GRASS GIS - free and open source Geographic Information System (GIS).
...
* [BehaviorTree.CPP](https://github.com/BehaviorTree/BehaviorTree.CPP) ⭐ 4,174 | 🐛 56 | 🌐 C++ | 📅 2026-08-14 - Behavior Trees Library in C++.
* [Groot](https://github.com/BehaviorTree/Groot) ⭐ 888 | 🐛 66 | 🌐 C++ | 📅 2025-02-28 - Graphical Editor to create BehaviorTrees. Compliant with BehaviorTree.CPP.
...
* [pinocchio](https://github.com/stack-of-tasks/pinocchio) ⭐ 3,686 | 🐛 110 | 🌐 C++ | 📅 2026-08-26 - A fast and flexible implementation of Rigid Body Dynamics algorithms and their analytical derivatives.
* [EGO-Planner](https://github.com/ZJU-FAST-Lab/ego-planner) ⭐ 2,623 | 🐛 40 | 🌐 C++ | 📅 2025-03-08 - A lightweight gradient-based local planner without ESDF construction, which significantly reduces computation time compared to some state-of-the-art methods.
* [casADi](https://github.com/casadi/casadi) ⭐ 2,282 | 🐛 745 | 🌐 C++ | 📅 2026-08-25 - A symbolic framework for numeric optimization implementing automatic differentiation in forward and reverse modes on sparse matrix-valued computational graphs.
* [ompl](https://github.com/ompl/ompl) ⭐ 2,134 | 🐛 99 | 🌐 C++ | 📅 2026-08-26 - Consists of many state-of-the-art sampling-based motion planning algorithms.
* [path\_planner](https://github.com/karlkurzer/path_planner) ⭐ 1,911 | 🐛 18 | 🌐 C++ | 📅 2026-03-30 - Hybrid A\* Path Planner for the KTH Research Concept Vehicle.
* [mpcc](https://github.com/alexliniger/MPCC) ⭐ 1,860 | 🐛 9 | 🌐 C++ | 📅 2026-04-25 - Model Predictive Contouring Controller for Autonomous Racing.
* [flexible-collision-library](https://github.com/flexible-collision-library/fcl) ⭐ 1,750 | 🐛 244 | 🌐 C++ | 📅 2026-08-27 - A library for performing three types of proximity queries on a pair of geometric models composed of triangles.
* [control-toolbox](https://github.com/ethz-adrl/control-toolbox) ⭐ 1,706 | 🐛 64 | 🌐 C++ | 📅 2022-11-09 - An efficient C++ library for control, estimation, optimization and motion planning in robotics.
...
* [teb\_local\_planner](https://github.com/rst-tu-dortmund/teb_local_planner) ⭐ 1,342 | 🐛 151 | 🌐 C++ | 📅 2026-01-09 - An optimal trajectory planner considering distinctive topologies for mobile robots based on Timed-Elastic-Bands.
...
* [toppra](https://github.com/hungpham2511/toppra) ⭐ 923 | 🐛 38 | 🌐 Python | 📅 2026-08-26 - A library for computing the time-optimal path parametrization for robots subject to kinematic and dynamic constraints.
...
* [CrowdNav](https://github.com/vita-epfl/CrowdNav) ⭐ 732 | 🐛 30 | 🌐 Python | 📅 2022-08-26 - Crowd-aware Robot Navigation with Attention-based Deep Reinforcement Learning.
...
* [se2\_navigation](https://github.com/leggedrobotics/se2_navigation) ⭐ 605 | 🐛 7 | 🌐 C++ | 📅 2023-03-07 - Pure pursuit controller and Reeds-Shepp sampling based planner for navigation in SE(2) space.
...
* [ACADO Toolkit](https://github.com/acado/acado) ⭐ 585 | 🐛 150 | 🌐 C++ | 📅 2024-08-14 - A software environment and algorithm collection for automatic control and dynamic optimization.
...
* [imgui](https://github.com/ocornut/imgui) ⭐ 75,890 | 🐛 1,237 | 🌐 C++ | 📅 2026-08-23 - Designed to enable fast iterations and to empower programmers to create content creation tools and visualization / debug tools.
* [pencil](https://github.com/evolus/pencil) ⭐ 9,860 | 🐛 534 | 🌐 JavaScript | 📅 2026-06-02 - A tool for making diagrams and GUI prototyping that everyone can use.
...
* [elements](https://github.com/cycfi/elements) ⭐ 3,721 | 🐛 41 | 🌐 C++ | 📅 2026-06-13 - A lightweight, fine-grained, resolution independent, modular GUI library.
* [cage](https://github.com/Hjdskes/cage) ⭐ 2,031 | 🐛 124 | 🌐 C | 📅 2026-08-18 - This is Cage, a Wayland kiosk. A kiosk runs a single, maximized application.
...
* [mir](https://github.com/MirServer/mir) ⭐ 778 | 🐛 415 | 🌐 C++ | 📅 2026-08-27 - Mir is set of libraries for building Wayland based shells.
...
* [TTS](https://github.com/coqui-ai/TTS) ⭐ 45,960 | 🐛 2 | 🌐 Python | 📅 2024-08-16 - A deep learning toolkit for Text-to-Speech, battle-tested in research and production.
...
* [the-art-of-command-line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,178 | 🐛 257 | 📅 2024-06-25 - Master the command line, in one page.
* [fzf](https://github.com/junegunn/fzf) ⭐ 82,679 | 🐛 326 | 🌐 Go | 📅 2026-08-26 - A command-line fuzzy finder.
* [bat](https://github.com/sharkdp/bat) ⭐ 60,277 | 🐛 422 | 🌐 Rust | 📅 2026-08-11 - A cat(1) clone with wings.
* [ag](https://github.com/ggreer/the_silver_searcher) ⭐ 27,108 | 🐛 564 | 🌐 C | 📅 2024-06-16 - A code-searching tool similar to ack, but faster.
* [fx](https://github.com/antonmedv/fx) ⭐ 20,598 | 🐛 26 | 🌐 Go | 📅 2026-08-26 - Command-line tool and terminal JSON viewer.
* [gocui](https://github.com/jroimartin/gocui) ⭐ 10,590 | 🐛 60 | 🌐 Go | 📅 2025-05-01 - Minimalist Go package aimed at creating Console User Interfaces.
...
* [mapscii](https://github.com/rastapasta/mapscii) ⭐ 9,227 | 🐛 52 | 🌐 JavaScript | 📅 2024-11-03 - World map renderer for your console.
* [dotbot](https://github.com/anishathalye/dotbot) ⭐ 7,993 | 🐛 17 | 🌐 Python | 📅 2026-07-12 - A tool that bootstraps your dotfiles.
* [tmate](https://github.com/tmate-io/tmate) ⭐ 6,117 | 🐛 130 | 🌐 C | 📅 2026-07-29 - Instant terminal sharing.
* [guake](https://github.com/Guake/guake) ⭐ 4,668 | 🐛 456 | 🌐 Python | 📅 2026-08-19 - Drop-down terminal for GNOME.
* [tmuxp](https://github.com/tmux-python/tmuxp) ⭐ 4,569 | 🐛 139 | 🌐 Python | 📅 2026-08-22 -  A session manager built on libtmux.
...
* [obs-studio](https://github.com/obsproject/obs-studio) ⭐ 75,515 | 🐛 1,166 | 🌐 C | 📅 2026-08-26 - Free and open source software for live streaming and screen recording.
* [bokeh](https://github.com/bokeh/bokeh) ⭐ 20,436 | 🐛 845 | 🌐 Python | 📅 2026-08-26 - Interactive Data Visualization in the browser, from Python.
* [plotly.py](https://github.com/plotly/plotly.py) ⭐ 18,755 | 🐛 771 | 🌐 Python | 📅 2026-08-26 - An open-source, interactive graphing library for Python.
* [openmct](https://github.com/nasa/openmct) ⭐ 13,095 | 🐛 1,071 | 🌐 JavaScript | 📅 2026-08-26 - A web based mission control framework.
* [kepler.gl](https://github.com/keplergl/kepler.gl) ⭐ 11,989 | 🐛 456 | 🌐 TypeScript | 📅 2026-08-27 - Kepler.gl is a powerful open source geospatial analysis tool for large-scale data sets.
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,129 | 🐛 161 | 🌐 C++ | 📅 2026-08-10 - The timeseries visualization tool that you deserve.
* [voila](https://github.com/voila-dashboards/voila) ⭐ 5,938 | 🐛 328 | 🌐 Python | 📅 2026-08-03 - From Jupyter notebooks to standalone web applications and dashboards.
* [PyQtGraph](https://github.com/pyqtgraph/pyqtgraph) ⭐ 4,405 | 🐛 495 | 🌐 Python | 📅 2026-08-27 - Fast data visualization and GUI tools for scientific / engineering applications.
...
* [webviz](https://github.com/cruise-automation/webviz) ⭐ 2,329 | 🐛 134 | 🌐 JavaScript | 📅 2022-12-17 - Web-based visualization libraries like rviz.
* [marvros](https://github.com/mavlink/mavros) ⭐ 1,217 | 🐛 404 | 🌐 C++ | 📅 2026-08-24 - MAVLink to ROS gateway with proxy for Ground Control Station.
...
* [urdf-loaders](https://github.com/gkjohnson/urdf-loaders) ⭐ 812 | 🐛 30 | 🌐 JavaScript | 📅 2026-08-10 - URDF Loaders for Unity and THREE.js with example ATHLETE URDF File.
...
* [ros3djs](https://github.com/RobotWebTools/ros3djs) ⭐ 445 | 🐛 81 | 🌐 JavaScript | 📅 2026-02-20 - 3D Visualization Library for use with the ROS JavaScript Libraries.
...
* [label-studio](https://github.com/heartexlabs/label-studio) ⭐ 28,158 | 🐛 927 | 🌐 TypeScript | 📅 2026-08-27 - Label Studio is a multi-type data labeling and annotation tool with standardized output format.
...
* [cvat](https://github.com/opencv/cvat) ⭐ 16,607 | 🐛 591 | 🌐 Python | 📅 2026-08-27 - Powerful and efficient Computer Vision Annotation Tool (CVAT).
* [labelme](https://github.com/wkentaro/labelme) ⭐ 16,131 | 🐛 180 | 🌐 Python | 📅 2026-08-27 - Image Polygonal Annotation with Python (polygon, rectangle, circle, line, point and image-level flag annotation).
* [napari](https://github.com/napari/napari) ⭐ 2,741 | 🐛 1,242 | 🌐 Python | 📅 2026-08-25 -  A fast, interactive, multi-dimensional image viewer for python.
...
* [Potree](https://github.com/potree/potree) ⭐ 5,586 | 🐛 822 | 🌐 JavaScript | 📅 2026-01-08 - WebGL point cloud viewer for large datasets.
* [CloudCompare](https://github.com/CloudCompare/CloudCompare) ⭐ 4,698 | 🐛 290 | 🌐 C++ | 📅 2026-08-26 - CloudCompare is a 3D point cloud (and triangular mesh) processing software.
...
* [mapviz](https://github.com/swri-robotics/mapviz) ⭐ 485 | 🐛 10 | 🌐 C++ | 📅 2026-08-22 - Modular ROS visualization tool for 2D data.
...
* [spdlog](https://github.com/gabime/spdlog) ⭐ 29,533 | 🐛 50 | 🌐 C++ | 📅 2026-08-08 - Very fast, header-only/compiled, C++ logging library.
* [ctop](https://github.com/bcicen/ctop) ⭐ 17,826 | 🐛 121 | 🌐 Go | 📅 2024-07-08 -  Top-like interface for container metrics.
* [psutil](https://github.com/giampaolo/psutil) ⭐ 11,265 | 🐛 258 | 🌐 Python | 📅 2026-08-27 - Cross-platform lib for process and system monitoring in Python.
* [nvtop](https://github.com/Syllo/nvtop) ⭐ 10,944 | 🐛 146 | 🌐 C | 📅 2026-05-06 - NVIDIA GPUs htop like monitoring tool.
* [ntop](https://github.com/ntop/ntopng) ⭐ 8,116 | 🐛 338 | 🌐 Lua | 📅 2026-08-27 - Web-based Traffic and Security Network Traffic Monitoring.
...
* [atop](https://github.com/Atoptool/atop) ⭐ 1,054 | 🐛 62 | 🌐 C | 📅 2026-08-15 - System and process monitor for Linux with logging and replay function.
...
* [multimaster\_fkie](https://github.com/fkie/multimaster_fkie) ⭐ 290 | 🐛 12 | 🌐 Python | 📅 2025-03-11 - GUI-based management environment that is very useful to manage ROS-launch configurations and control running nodes.
...
* [syncthing](https://github.com/syncthing/syncthing) ⭐ 88,044 | 🐛 378 | 🌐 Go | 📅 2026-08-25 - A continuous file synchronization program.
* [DuckDB](https://github.com/cwida/duckdb) ⭐ 40,723 | 🐛 784 | 🌐 C++ | 📅 2026-08-27 - An embeddable SQL OLAP Database Management System.
* [nextcloud](https://github.com/nextcloud/server) ⭐ 36,600 | 🐛 3,687 | 🌐 PHP | 📅 2026-08-27 - Nextcloud is a suite of client-server software for creating and using file hosting services.
* [borg](https://github.com/borgbackup/borg) ⭐ 13,658 | 🐛 226 | 🌐 Python | 📅 2026-08-27 - Deduplicating archiver with compression and authenticated encryption.
...
* [ceph](https://github.com/ceph/ceph) ⭐ 16,970 | 🐛 1,293 | 🌐 C++ | 📅 2026-08-27 - A distributed object, block, and file storage platform.
...
* [nfs](https://github.com/sahlberg/libnfs) ⭐ 601 | 🐛 15 | 🌐 C | 📅 2026-08-27 - A distributed file system protocol originally developed by Sun Microsystems.
...
* [ansible](https://github.com/ansible/ansible) ⭐ 70,481 | 🐛 831 | 🌐 Python | 📅 2026-08-27 - Ansible is a radically simple IT automation platform that makes your applications and systems easier to deploy.
...
* [traefik](https://github.com/containous/traefik) ⭐ 64,617 | 🐛 913 | 🌐 Go | 📅 2026-08-27 - The Cloud Native Edge Router.
* [Portainer](https://github.com/portainer/portainer) ⭐ 38,357 | 🐛 746 | 🌐 TypeScript | 📅 2026-08-27 - Making Docker management easy.
* [luigi](https://github.com/spotify/luigi) ⭐ 18,766 | 🐛 170 | 🌐 Python | 📅 2026-07-18 - A Python module that helps you build complex pipelines of batch jobs. It handles dependency resolution, workflow management, visualization etc. It also comes with Hadoop support built in.
* [nvidia-docker](https://github.com/NVIDIA/nvidia-docker) ⚠️ Archived - Build and run Docker containers leveraging NVIDIA GPUs.
* [kubeflow](https://github.com/kubeflow/kubeflow) ⭐ 15,834 | 🐛 0 | 📅 2026-08-21 - Machine Learning Toolkit for Kubernetes.
* [noVNC](https://github.com/novnc/noVNC) ⭐ 13,967 | 🐛 110 | 🌐 JavaScript | 📅 2026-08-20 - VNC client using HTML5.
* [triton-inference-server](https://github.com/NVIDIA/triton-inference-server) ⭐ 10,943 | 🐛 890 | 🌐 Python | 📅 2026-08-27 - NVIDIA Triton Inference Server provides a cloud inferencing solution optimized for NVIDIA GPUs.
* [cudf](https://github.com/rapidsai/cudf) ⭐ 9,736 | 🐛 1,333 | 🌐 C++ | 📅 2026-08-27 - Provides a pandas-like API that will be familiar to data engineers & data scientists, so they can use it to easily accelerate their workflows without going into the details of CUDA programming.
* [jupyterhub](https://github.com/jupyterhub/jupyterhub) ⭐ 8,332 | 🐛 193 | 🌐 Python | 📅 2026-08-24 - Multi-user server for Jupyter notebooks.
* [graylog2-server](https://github.com/Graylog2/graylog2-server) ⭐ 8,117 | 🐛 2,050 | 🌐 Java | 📅 2026-08-27 - Free and open source log management.
* [docker-py](https://github.com/docker/docker-py) ⭐ 7,211 | 🐛 569 | 🌐 Python | 📅 2026-08-24 - A Python library for the Docker Engine API.
* [pyinfra](https://github.com/Fizzadar/pyinfra) ⭐ 5,966 | 🐛 173 | 🌐 Python | 📅 2026-08-27 - It can be used for ad-hoc command execution, service deployment, configuration management and more.
* [Slurm](https://github.com/SchedMD/slurm) ⭐ 4,284 | 🐛 14 | 🌐 C | 📅 2026-08-27 - Slurm: A Highly Scalable Workload Manager.
* [polyaxon](https://github.com/polyaxon/polyaxon) ⭐ 3,724 | 🐛 126 | 🌐 MDX | 📅 2026-08-26 - A platform for reproducing and managing the whole life cycle of machine learning and deep learning applications.
* [docker-firefox](https://github.com/jlesage/docker-firefox) ⭐ 2,540 | 🐛 95 | 🌐 Shell | 📅 2026-08-26 - Run a Docker Container with Firefox and noVNC for remote access to headless servers.
* [log-pilot](https://github.com/AliyunContainerService/log-pilot) ⚠️ Archived - Collect logs for docker containers.
* [enroot](https://github.com/NVIDIA/enroot) ⭐ 1,095 | 🐛 100 | 🌐 Shell | 📅 2026-06-09 - A simple, yet powerful tool to turn traditional container/OS images into unprivileged sandboxes.
* [mass](https://github.com/maas/maas) ⭐ 497 | 🐛 28 | 🌐 Python | 📅 2026-08-27 - Self-service, remote installation of Windows, CentOS, ESXi and Ubuntu on real servers turns your data centre into a bare metal cloud.

### Embedded Operation System

* [jetson-containers](https://github.com/dusty-nv/jetson-containers) ⭐ 4,835 | 🐛 196 | 🌐 Jupyter Notebook | 📅 2026-08-10 - Machine Learning Containers for Jetson and JetPack 4.4.
* [jetson\_stats](https://github.com/rbonghi/jetson_stats) ⭐ 2,615 | 🐛 55 | 🌐 Python | 📅 2026-08-09 - A package to monitoring and control your NVIDIA Jetson (Xavier NX, Nano, AGX Xavier, TX1, TX2) Works with all NVIDIA Jetson ecosystem.
* [Jailhouse](https://github.com/siemens/jailhouse) ⭐ 1,957 | 🐛 0 | 🌐 C | 📅 2024-05-18 - Jailhouse is a partitioning Hypervisor based on Linux.
...
* [meta-balena](https://github.com/balena-os/meta-balena) ⭐ 989 | 🐛 139 | 🌐 BitBake | 📅 2026-08-27 - Run Docker containers on embedded devices.
...
* [bitbake](https://github.com/openembedded/bitbake) ⭐ 529 | 🐛 17 | 🌐 Python | 📅 2026-08-27 - A generic task execution engine that allows shell and Python tasks to be run efficiently and in parallel while working within complex inter-task dependency constraints.
* [meta-ros](https://github.com/ros/meta-ros/tree/thud-draft) ⭐ 486 | 🐛 97 | 🌐 BitBake | 📅 2026-08-26 - OpenEmbedded Layer for ROS Applications.
...
* [protobuf](https://github.com/protocolbuffers/protobuf) ⭐ 71,824 | 🐛 315 | 🌐 C++ | 📅 2026-08-27 - Google's data interchange format.
* [Fast-RTPS](https://github.com/eProsima/Fast-RTPS) ⭐ 2,886 | 🐛 129 | 🌐 C++ | 📅 2026-08-24 - A Protocol, which provides publisher-subscriber communications over unreliable transports such as UDP, as defined and maintained by the Object Management Group (OMG) consortium.
* [iceoryx](https://github.com/eclipse/iceoryx) ⭐ 2,160 | 🐛 259 | 🌐 C++ | 📅 2026-08-18 - An IPC middleware for POSIX-based systems.
* [cyclonedds](https://github.com/eclipse-cyclonedds/cyclonedds) ⭐ 1,327 | 🐛 311 | 🌐 C | 📅 2026-08-26 - Eclipse Cyclone DDS is a very performant and robust open-source DDS implementation.
* [rosbridge\_suite](https://github.com/RobotWebTools/rosbridge_suite) ⭐ 1,238 | 🐛 30 | 🌐 Python | 📅 2026-08-17 - Provides a JSON interface to ROS, allowing any client to send JSON to publish or subscribe to ROS topics, call ROS services, and more.
...
* [termshark](https://github.com/gcla/termshark) ⭐ 9,969 | 🐛 50 | 🌐 Go | 📅 2024-04-30 - A terminal UI for tshark, inspired by Wireshark.
* [iperf](https://github.com/esnet/iperf) ⭐ 8,719 | 🐛 239 | 🌐 C | 📅 2026-07-10 - A TCP, UDP, and SCTP network bandwidth measurement tool.
* [openwifi](https://github.com/open-sdr/openwifi) ⭐ 4,772 | 🐛 93 | 🌐 C | 📅 2026-08-25 - Linux mac80211 compatible full-stack IEEE802.11/Wi-Fi design based on Software Defined Radio.
* [nethogs](https://github.com/raboof/nethogs) ⭐ 3,686 | 🐛 104 | 🌐 C++ | 📅 2026-07-23 - It groups bandwidth by process.
...
* [wavemon](https://github.com/uoaerg/wavemon) ⭐ 1,228 | 🐛 6 | 🌐 C | 📅 2026-06-29 - An ncurses-based monitoring application for wireless network devices.
...
* [awesome CAN](https://github.com/iDoka/awesome-canbus) ⭐ 3,433 | 🐛 6 | 📅 2026-08-07 -  A curated list of awesome CAN bus tools, hardware and resources.
* [opendbc](https://github.com/commaai/opendbc) ⭐ 3,365 | 🐛 342 | 🌐 Python | 📅 2026-08-27 - The project to democratize access to the decoder ring of your car.
* [can-utils](https://github.com/linux-can/can-utils) ⭐ 2,908 | 🐛 62 | 🌐 C | 📅 2026-05-12 - Linux-CAN / SocketCAN user space applications.
* [cantools](https://github.com/eerimoq/cantools) ⭐ 2,276 | 🐛 129 | 🌐 Python | 📅 2026-08-27 - CAN BUS tools in Python 3.
* [AndrOBD](https://github.com/fr3ts0n/AndrOBD) ⭐ 2,076 | 🐛 71 | 🌐 Java | 📅 2026-08-27 - Android OBD diagnostics with any ELM327 adapter.
* [CANopenNode](https://github.com/CANopenNode/CANopenNode) ⭐ 1,988 | 🐛 114 | 🌐 C | 📅 2026-07-10 - The internationally standardized (EN 50325-4) (CiA301) CAN-based higher-layer protocol for embedded control system.
* [ddt4all](https://github.com/cedricp/ddt4all) ⭐ 1,821 | 🐛 2 | 🌐 Python | 📅 2026-08-23 - DDT4All is a tool to create your own ECU parameters screens and connect to a CAN network with a cheap ELM327 interface.
* [SavvyCAN](https://github.com/collin80/SavvyCAN) ⭐ 1,783 | 🐛 283 | 🌐 C++ | 📅 2026-05-15 - A Qt5 based cross platform tool which can be used to load, save, and capture canbus frames.
* [python-can](https://github.com/hardbyte/python-can) ⭐ 1,586 | 🐛 274 | 🌐 Python | 📅 2026-07-01 - The can package provides controller area network support for Python developers.
...
* [Open-Vehicle-Monitoring-System-3](https://github.com/openvehicles/Open-Vehicle-Monitoring-System-3) ⭐ 842 | 🐛 208 | 🌐 C | 📅 2026-08-22 - The system provides live monitoring of vehicle metrics like state of charge, temperatures, tyre pressures and diagnostic fault conditions.
...
* [novatel\_gps\_driver](https://github.com/swri-robotics/novatel_gps_driver) ⭐ 175 | 🐛 31 | 🌐 C++ | 📅 2026-08-23 - ROS driver for NovAtel GPS / GNSS receivers.
...
* [Vault](https://github.com/hashicorp/vault) ⭐ 36,180 | 🐛 1,431 | 🌐 Go | 📅 2026-08-27 - A tool for securely accessing secrets. A secret is anything that you want to tightly control access to, such as API keys, passwords, certificates, and more.
* [How-to-Secure-A-Linux-Server](https://github.com/imthenachoman/How-To-Secure-A-Linux-Server) ⭐ 30,318 | 🐛 35 | 📅 2026-07-13 - An evolving how-to guide for securing a Linux server.
* [fail2ban](https://github.com/fail2ban/fail2ban) ⭐ 18,483 | 🐛 270 | 🌐 Python | 📅 2026-08-26 - Daemon to ban hosts that cause multiple authentication errors.
* [lynis](https://github.com/CISOfy/lynis) ⭐ 16,242 | 🐛 218 | 🌐 Shell | 📅 2026-08-05 - Security auditing tool for Linux, macOS, and UNIX-based systems. Assists with compliance testing (HIPAA/ISO27001/PCI DSS) and system hardening.
* [OpenVPN](https://github.com/OpenVPN/openvpn) ⭐ 14,444 | 🐛 222 | 🌐 C | 📅 2026-08-26 - An open source VPN daemon.
...
* [Firejail](https://github.com/netblue30/firejail) ⭐ 7,613 | 🐛 523 | 🌐 C | 📅 2026-08-22 - A SUID sandbox program that reduces the risk of security breaches by restricting the running environment of untrusted applications using Linux namespaces, seccomp-bpf and Linux capabilities.
* [gopass](https://github.com/gopasspw/gopass) ⭐ 7,108 | 🐛 86 | 🌐 Go | 📅 2026-08-26 - A password manager for the command line written in Go.
* [vulscan](https://github.com/scipag/vulscan) ⭐ 3,780 | 🐛 7 | 🌐 Lua | 📅 2026-02-06 - Advanced vulnerability scanning with Nmap NSE.
* [OpenTitan](https://github.com/lowRISC/opentitan) ⭐ 3,612 | 🐛 2,024 | 🌐 SystemVerilog | 📅 2026-08-27 - Will make the silicon Root of Trust design and implementation more transparent, trustworthy, and secure for enterprises, platform providers, and chip manufacturers. OpenTitan is administered by lowRISC CIC as a collaborative project to produce high quality, open IP for instantiation as a full-featured product.
* [nmap-vulners](https://github.com/vulnersCom/nmap-vulners) ⭐ 3,415 | 🐛 0 | 🌐 Lua | 📅 2026-08-21 - NSE script based on Vulners.com API.
* [openfortivpn](https://github.com/adrienverge/openfortivpn) ⭐ 3,395 | 🐛 141 | 🌐 Perl | 📅 2026-08-24 - A client for PPP+SSL VPN tunnel services and compatible with Fortinet VPNs.
* [wolfssl](https://github.com/wolfSSL/wolfssl) ⭐ 2,920 | 🐛 223 | 🌐 C | 📅 2026-08-27 - A small, fast, portable implementation of TLS/SSL for embedded devices to the cloud.
* [brutespray](https://github.com/x90skysn3k/brutespray) ⭐ 2,525 | 🐛 9 | 🌐 Go | 📅 2026-08-25 - Automatically attempts default creds on found services.
...
* [hardening](https://github.com/konstruktoid/hardening) ⭐ 1,855 | 🐛 7 | 🌐 Shell | 📅 2026-08-24 - A quick way to make a Ubuntu server a bit more secure.
* [openscap](https://github.com/OpenSCAP/openscap) ⭐ 1,806 | 🐛 63 | 🌐 XSLT | 📅 2026-08-13 - The oscap program is a command line tool that allows users to load, scan, validate, edit, and export SCAP documents.
* [Security-Enhanced Linux](https://github.com/SELinuxProject/selinux) ⭐ 1,619 | 🐛 16 | 🌐 C | 📅 2026-08-26 - A Linux kernel security module that provides a mechanism for supporting access control security policies, including mandatory access controls (MAC).
* [Passbolt](https://github.com/passbolt/passbolt_docker) ⭐ 1,110 | 🐛 9 | 🌐 Ruby | 📅 2026-08-12 - Passbolt is a free and open source password manager that allows team members to store and share credentials securely.
...
* [waymo-open-dataset](https://github.com/waymo-research/waymo-open-dataset) ⭐ 3,398 | 🐛 464 | 🌐 Python | 📅 2026-01-08 - The Waymo Open Dataset is comprised of high-resolution sensor data collected by Waymo self-driving cars in a wide variety of conditions.
...
* [racetrack-database](https://github.com/TUMFTM/racetrack-database) ⭐ 296 | 🐛 0 | 📅 2021-09-18 - Contains center lines (x- and y-coordinates), track widths and race lines for over 20 race tracks (mainly F1 and DTM) all over the world.
