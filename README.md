...
* [flightmare](https://github.com/uzh-rpg/flightmare) ⭐ 1,412 | 🐛 128 | 🌐 C++ | 📅 2024-06-14 - Flightmare is composed of two main components: a configurable rendering engine built on Unity and a flexible physics engine for dynamics simulation.
...
* [oemof-solph](https://github.com/oemof/oemof-solph) ⭐ 418 | 🐛 118 | 🌐 Python | 📅 2026-09-05 - A modular open source framework to model energy supply systems.
...
* [slam\_toolbox](https://github.com/SteveMacenski/slam_toolbox) ⭐ 2,614 | 🐛 48 | 🌐 C++ | 📅 2026-08-19 - Slam Toolbox for lifelong mapping and localization in potentially massive maps with ROS .
