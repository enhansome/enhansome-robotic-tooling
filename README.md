...
* [Gogs](https://github.com/gogs/gogs) ⭐ 47,785 | 🐛 1,009 | 🌐 Go | 📅 2026-08-26 - Build a simple, stable and extensible self-hosted Git service that can be setup in the most painless way.
* [discourse](https://github.com/discourse/discourse) ⭐ 47,763 | 🐛 278 | 🌐 Ruby | 📅 2026-08-31 - A platform for community discussion. Free, open, simple.
* [mattermost](https://github.com/mattermost/mattermost-server) ⭐ 38,943 | 🐛 1,002 | 🌐 TypeScript | 📅 2026-08-31 - An open source, private cloud, Slack-alternative.
* [jitsi-meet](https://github.com/jitsi/jitsi-meet) ⭐ 29,840 | 🐛 140 | 🌐 TypeScript | 📅 2026-08-31 - Secure, Simple and Scalable Video Conferences that you use as a standalone app or embed in your web application.
...
* [Wekan](https://github.com/wekan/wekan) ⭐ 21,067 | 🐛 282 | 🌐 JavaScript | 📅 2026-08-31 - Meteor based Kanban Board.
* [openproject](https://github.com/opf/openproject) ⭐ 15,978 | 🐛 228 | 🌐 Ruby | 📅 2026-08-31 - The leading open source project management software.
* [leantime](https://github.com/Leantime/leantime) ⭐ 11,484 | 🐛 321 | 🌐 PHP | 📅 2026-08-15 - Leantime is a lean project management system for innovators.
* [Kanboard](https://github.com/kanboard/kanboard) ⭐ 9,836 | 🐛 158 | 🌐 PHP | 📅 2026-08-29 - Minimalistic Kanban Board.
* [Gitlab](https://github.com/sameersbn/docker-gitlab) ⭐ 8,106 | 🐛 576 | 🌐 Shell | 📅 2026-08-27 - Simple Selfhosted Gitlab Server with Docker.
* [ONLYOFFICE](https://github.com/ONLYOFFICE/CommunityServer) ⭐ 3,160 | 🐛 206 | 🌐 C# | 📅 2026-05-05 -  A free open source collaborative system developed to manage documents, projects, customer relationship and email correspondence, all in one place.
...
* [JIRA API](https://github.com/pycontribs/jira) ⭐ 2,129 | 🐛 236 | 🌐 Python | 📅 2026-08-24 - Python Library for REST API of Jira.
...
* [Taiga API](https://github.com/nephila/python-taiga) ⭐ 138 | 🐛 14 | 🌐 Python | 📅 2026-08-31 - Python Library for REST API of Taiga.
...
* [Excalidraw](https://github.com/excalidraw/excalidraw) ⭐ 130,853 | 🐛 3,425 | 🌐 TypeScript | 📅 2026-08-31 - Virtual whiteboard for sketching hand-drawn like diagrams.
* [tesseract](https://github.com/tesseract-ocr/tesseract) ⭐ 76,277 | 🐛 489 | 🌐 C++ | 📅 2026-08-25 - Open Source OCR Engine.
* [Pandoc](https://github.com/jgm/pandoc) ⭐ 46,081 | 🐛 1,035 | 🌐 Haskell | 📅 2026-08-30 - Universal markup converter.
* [carbon](https://github.com/carbon-app/carbon) ⭐ 36,085 | 🐛 85 | 🌐 JavaScript | 📅 2026-02-10 - Share beautiful images of your source code.
* [OCRmyPDF](https://github.com/jbarlow83/OCRmyPDF) ⭐ 34,635 | 🐛 97 | 🌐 Python | 📅 2026-08-31 - Adds an OCR text layer to scanned PDF files, allowing them to be searched.
* [PlotNeuralNet](https://github.com/HarisIqbal88/PlotNeuralNet) ⭐ 24,960 | 🐛 89 | 🌐 TeX | 📅 2023-08-21 - Latex code for drawing neural networks for reports and presentation.
* [mkdocs](https://github.com/mkdocs/mkdocs/) ⭐ 22,397 | 🐛 189 | 🌐 Python | 📅 2025-10-20 - A fast, simple and downright gorgeous static site generator that's geared towards building project documentation.
* [overleaf](https://github.com/overleaf/overleaf) ⭐ 18,082 | 🐛 172 | 🌐 JavaScript | 📅 2026-07-10 - An open-source online real-time collaborative LaTeX editor.
* [asciinema](https://github.com/asciinema/asciinema) ⭐ 17,748 | 🐛 8 | 🌐 Rust | 📅 2026-08-14 - Lets you easily record terminal sessions and replay them in a terminal as well as in a web browser.
* [foam](https://github.com/foambubble/foam) ⭐ 17,379 | 🐛 31 | 🌐 TypeScript | 📅 2026-08-13 - Foam is a personal knowledge management and sharing system inspired by Roam Research, built on Visual Studio Code and GitHub.
* [Zotero](https://github.com/zotero/zotero) ⭐ 15,114 | 🐛 1,597 | 🌐 JavaScript | 📅 2026-08-28 - A free, easy-to-use tool to help you collect, organize, cite, and share your research sources.
* [gollum](https://github.com/gollum/gollum) ⭐ 14,319 | 🐛 91 | 🌐 Ruby | 📅 2025-11-24 - A simple, Git-powered wiki with a sweet API and local frontend.
* [ReLaXed](https://github.com/RelaxedJS/ReLaXed) ⭐ 11,798 | 🐛 52 | 🌐 JavaScript | 📅 2025-09-07 - Allows complex PDF layouts to be defined with CSS and JavaScript, while writing the content in a friendly, minimal syntax close to Markdown or LaTeX.
* [Sphinx](https://github.com/sphinx-doc/sphinx/) ⭐ 7,997 | 🐛 1,426 | 🌐 Python | 📅 2026-08-31 - A tool that makes it easy to create intelligent and beautiful documentation for Python projects.
...
* [CodiMD](https://github.com/codimd/server) ⭐ 7,386 | 🐛 275 | 🌐 TypeScript | 📅 2026-08-31 - Open Source Online Real-time collaborate on team documentation in markdown.
* [buku](https://github.com/jarun/buku) ⭐ 7,187 | 🐛 6 | 🌐 Python | 📅 2026-08-16 - Browser-independent bookmark manager.
* [Doxygen](https://github.com/doxygen/doxygen) ⭐ 6,568 | 🐛 1,859 | 🌐 C++ | 📅 2026-08-30 - Doxygen is the de facto standard tool for generating documentation from annotated C++ sources.
* [papermill](https://github.com/nteract/papermill) ⭐ 6,477 | 🐛 196 | 🌐 Python | 📅 2026-07-06 - A tool for parameterizing, executing, and analyzing Jupyter Notebooks.
* [Markor](https://github.com/gsantner/markor) ⭐ 6,053 | 🐛 188 | 🌐 Java | 📅 2026-08-25 - A Simple Markdown Editor for your Android Device.
* [jupyter-book](https://github.com/executablebooks/jupyter-book) ⭐ 4,274 | 🐛 668 | 🌐 TypeScript | 📅 2026-08-08 - Build interactive, publication-quality documents from Jupyter Notebooks.
...
* [docsy](https://github.com/google/docsy-example) ⭐ 558 | 🐛 14 | 🌐 JavaScript | 📅 2026-08-30 - An example documentation site using the Docsy Hugo theme.
...
* [awesome-safety-critical](https://github.com/stanislaw/awesome-safety-critical) ⭐ 1,594 | 🐛 1 | 🌐 Python | 📅 2025-03-11 - List of resources about programming practices for writing safety-critical software.
* [fossology](https://github.com/fossology/fossology) ⭐ 1,024 | 🐛 289 | 🌐 HTML | 📅 2026-08-31 - A toolkit you can run license, copyright and export control scans from the command line.
* [doorstop](https://github.com/doorstop-dev/doorstop) ⭐ 658 | 🐛 56 | 🌐 Python | 📅 2026-08-28 - Requirements management using version control.
...
* [Architecture\_Decision\_Record](https://github.com/joelparkerhenderson/architecture_decision_record) ⭐ 16,778 | 🐛 10 | 📅 2026-08-20 - A document that captures an important architectural decision made along with its context and consequences.
* [vscode-drawio](https://github.com/hediet/vscode-drawio) ⭐ 9,482 | 🐛 179 | 🌐 TypeScript | 📅 2026-08-28 - This extension integrates Draw\.io into VS Code.
* [Plantuml](https://github.com/plantuml/plantuml-server) ⭐ 2,213 | 🐛 77 | 🌐 Java | 📅 2026-08-27 - Web application to generate UML diagrams on-the-fly in your live documentation.
...
* [OpenPilot](https://github.com/commaai/openpilot) ⭐ 63,540 | 🐛 135 | 🌐 Python | 📅 2026-08-31 - Open Source Adaptive Cruise Control (ACC) and Lane Keeping Assist System (LKAS).
* [PythonRobotics](https://github.com/AtsushiSakai/PythonRobotics/) ⭐ 30,415 | 🐛 51 | 🌐 Python | 📅 2026-08-24 - This is a Python code collection of robotics algorithms, especially for autonomous navigation.
* [Apollo](https://github.com/ApolloAuto/apollo) ⭐ 26,815 | 🐛 1,046 | 🌐 C++ | 📅 2026-04-16 - High performance, flexible architecture which accelerates the development, testing, and deployment of Autonomous Vehicles.
* [ArduPilot](https://github.com/ArduPilot/ardupilot) ⭐ 15,776 | 🐛 3,176 | 🌐 C++ | 📅 2026-08-31 - Open source control software for autonomous vehicles - copters/planes/rovers/boats/submersibles.
* [PX4](https://github.com/PX4/Firmware) ⭐ 12,520 | 🐛 325 | 🌐 C++ | 📅 2026-08-31 - An open source flight control software for drones and other unmanned vehicles.
* [F Prime](https://github.com/nasa/fprime) ⭐ 11,719 | 🐛 457 | 🌐 C++ | 📅 2026-08-30 - A component-driven framework that enables rapid development and deployment of spaceflight and other embedded software applications.
* [open-source-rover](https://github.com/nasa-jpl/open-source-rover) ⭐ 9,617 | 🐛 17 | 🌐 Prolog | 📅 2026-08-13 - A build-it-yourself, 6-wheel rover based on the rovers on Mars from JPL.
...
* [astrobee](https://github.com/nasa/astrobee) ⭐ 1,402 | 🐛 31 | 🌐 C++ | 📅 2025-12-02 - Astrobee is a free-flying robot designed to operate as a payload inside the International Space Station (ISS).
...
* [JdeRobot Academy](https://github.com/JdeRobot/RoboticsAcademy) ⭐ 491 | 🐛 61 | 🌐 Python | 📅 2026-08-16 - JdeRobot Academy is an open source collection of exercises to learn robotics in a practical way.
* [CARMAPlatform](https://github.com/usdot-fhwa-stol/CARMAPlatform) ⭐ 436 | 🐛 270 | 🌐 C++ | 📅 2026-08-27 - Enables cooperative automated driving plug-in.
...
* [mod\_vehicle\_dynamics\_control](https://github.com/TUMFTM/mod_vehicle_dynamics_control) ⭐ 295 | 🐛 4 | 🌐 MATLAB | 📅 2022-03-19 - TUM Roborace Team Software Stack - Path tracking control, velocity control, curvature control and state estimation.
...
* [COMPAS](https://github.com/compas-dev/compas_fab) ⭐ 137 | 🐛 84 | 🌐 Python | 📅 2026-08-27 - Robotic fabrication package for the COMPAS Framework.
...
* [Visual Studio Code](https://github.com/Microsoft/vscode) ⭐ 190,091 | 🐛 20,297 | 🌐 TypeScript | 📅 2026-08-31 - Code editor for edit-build-debug cycle.
* [atom](https://github.com/atom/atom) ⚠️ Archived - Hackable text editor for the 21st century.
* [pybind11](https://github.com/pybind/pybind11) ⭐ 18,009 | 🐛 715 | 🌐 C++ | 📅 2026-08-29 - Seamless operability between C++11 and Python.
* [Sourcetrail](https://github.com/CoatiSoftware/Sourcetrail) ⚠️ Archived - Free and open-source cross-platform source explorer.
* [Gitpod](https://github.com/gitpod-io/gitpod) ⭐ 13,760 | 🐛 452 | 🌐 TypeScript | 📅 2026-08-31 - An open source developer platform that automates the provisioning of ready-to-code development environments.
* [TabNine](https://github.com/zxqfl/TabNine) ⭐ 10,774 | 🐛 0 | 🌐 Shell | 📅 2025-09-04 - The all-language autocompleter.
* [jedi](https://github.com/davidhalter/jedi) ⭐ 6,175 | 🐛 70 | 🌐 Python | 📅 2026-07-09 - Autocompletion and static analysis library for python.
* [awesome-hpp](https://github.com/p-ranav/awesome-hpp) ⭐ 4,159 | 🐛 29 | 📅 2025-11-06 - A curated list of awesome header-only C++ libraries.
...
* [live-share](https://github.com/MicrosoftDocs/live-share) ⭐ 2,383 | 🐛 281 | 📅 2026-08-03 - Real-time collaborative development from the comfort of your favorite tools.
* [cocalc](https://github.com/sagemathinc/cocalc) ⚠️ Archived - Collaborative Calculation in the Cloud.
* [Jupyter ROS](https://github.com/RoboStack/jupyter-ros) ⭐ 614 | 🐛 30 | 🌐 Python | 📅 2026-04-02 - Jupyter widget helpers for ROS, the Robot Operating System.
...
* [Bash](https://github.com/ralish/bash-script-template) ⭐ 1,008 | 🐛 2 | 🌐 Shell | 📅 2026-02-15 - A bash scripting template incorporating best practices & several useful functions.
* [VS Code ROS2 Workspace Template](https://github.com/athackst/vscode_ros2_workspace) ⭐ 997 | 🐛 0 | 🌐 Python | 📅 2026-08-18 -  Template for using VSCode as an IDE for ROS2 development.
...
* [pyenv](https://github.com/pyenv/pyenv) ⭐ 45,056 | 🐛 56 | 🌐 Shell | 📅 2026-08-29 - Simple Python version management.
...
* [aptly](https://github.com/aptly-dev/aptly) ⭐ 2,878 | 🐛 218 | 🌐 Go | 📅 2026-08-09 - Debian repository management tool.
...
* [superflore](https://github.com/ros-infrastructure/superflore) ⭐ 62 | 🐛 21 | 🌐 Python | 📅 2026-08-28 - An extended platform release manager for Robot Operating System.
...
* [googletest](https://github.com/google/googletest) ⭐ 39,401 | 🐛 495 | 🌐 C++ | 📅 2026-08-27 - Google's C++ test framework.
* [pytest](https://github.com/pytest-dev/pytest/) ⭐ 14,461 | 🐛 808 | 🌐 Python | 📅 2026-08-31 - The pytest framework makes it easy to write small tests, yet scales to support complex functional testing.
* [doctest](https://github.com/onqtam/doctest) ⭐ 6,856 | 🐛 138 | 🌐 C++ | 📅 2026-08-29 - The fastest feature-rich C++11/14/17/20 single-header testing framework for unit tests and TDD.
...
* [black](https://github.com/psf/black) ⭐ 41,825 | 🐛 311 | 🌐 Python | 📅 2026-08-20 - The uncompromising Python code formatter.
* [shellcheck](https://github.com/koalaman/shellcheck) ⭐ 39,963 | 🐛 1,138 | 🌐 Haskell | 📅 2026-08-04 - A static analysis tool for shell scripts.
* [pydantic](https://github.com/samuelcolvin/pydantic) ⭐ 28,667 | 🐛 575 | 🌐 Python | 📅 2026-08-29 - Data parsing and validation using Python type hints.
* [hadolint](https://github.com/hadolint/hadolint) ⭐ 12,378 | 🐛 203 | 🌐 Haskell | 📅 2026-08-24 - Dockerfile linter, validate inline bash, written in Haskell.
* [cppcheck](https://github.com/danmar/cppcheck) ⭐ 6,735 | 🐛 194 | 🌐 C++ | 📅 2026-08-31 - Static analysis of C/C++ code.
* [pylint](https://github.com/PyCQA/pylint/) ⭐ 5,721 | 🐛 1,080 | 🌐 Python | 📅 2026-08-30 - Pylint is a Python static code analysis tool which looks for programming errors, helps enforcing a coding standard, sniffs for code smells and offers simple refactoring suggestions.
...
* [bcc](https://github.com/iovisor/bcc) ⭐ 22,648 | 🐛 1,072 | 🌐 C | 📅 2026-08-27 - Tools for BPF-based Linux IO analysis, networking, monitoring, and more.
* [FlameGraph](https://github.com/brendangregg/FlameGraph) ⭐ 19,713 | 🐛 174 | 🌐 Perl | 📅 2024-10-20 - Visualize profiled code.
* [tracy](https://github.com/wolfpld/tracy) ⭐ 16,690 | 🐛 168 | 🌐 C++ | 📅 2026-08-31 - A real time, nanosecond resolution, remote telemetry frame profiler for games and other applications.
* [sanitizer](https://github.com/google/sanitizers) ⭐ 12,456 | 🐛 549 | 🌐 C | 📅 2026-05-19 - AddressSanitizer, ThreadSanitizer, MemorySanitizer.
...
* [bpftrace](https://github.com/iovisor/bpftrace) ⭐ 10,302 | 🐛 254 | 🌐 C++ | 📅 2026-08-29 - High-level tracing language for Linux eBPF.
...
* [hotspot](https://github.com/KDAB/hotspot) ⭐ 5,143 | 🐛 85 | 🌐 C++ | 📅 2026-05-12 - The Linux perf GUI for performance analysis.
...
* [backward-cpp](https://github.com/bombela/backward-cpp) ⭐ 4,297 | 🐛 126 | 🌐 C++ | 📅 2025-04-14 - A beautiful stack trace pretty printer for C++.
* [heaptrack](https://github.com/KDE/heaptrack) ⭐ 4,155 | 🐛 6 | 🌐 C++ | 📅 2026-08-12 - Traces all memory allocations and annotates these events with stack traces.
...
* [pudb](https://github.com/inducer/pudb) ⭐ 3,248 | 🐛 164 | 🌐 Python | 📅 2026-08-28 - Full-screen console debugger for Python.
...
* [gpuvis](https://github.com/mikesart/gpuvis) ⭐ 908 | 🐛 6 | 🌐 C++ | 📅 2026-01-14 - GPU Trace Visualizer.
...
* [lazygit](https://github.com/jesseduffield/lazygit) ⭐ 81,799 | 🐛 1,026 | 🌐 Go | 📅 2026-08-30 - A simple terminal UI for git commands, written in Go with the gocui library.
* [dive](https://github.com/wagoodman/dive) ⭐ 54,519 | 🐛 212 | 🌐 Go | 📅 2025-12-15 - A tool for exploring each layer in a docker image.
* [learnGitBranching](https://github.com/pcottle/learnGitBranching) ⭐ 33,974 | 🐛 61 | 🌐 JavaScript | 📅 2026-08-30 - A git repository visualizer, sandbox, and a series of educational tutorials and challenges.
* [semantic-release](https://github.com/semantic-release/semantic-release) ⭐ 24,013 | 🐛 403 | 🌐 JavaScript | 📅 2026-08-29 - Fully automated version management and package publishing.
* [dvc](https://github.com/iterative/dvc) ⭐ 15,851 | 🐛 201 | 🌐 Python | 📅 2026-08-31 - Management and versioning of datasets and machine learning models.
...
* [git-secret](https://github.com/sobolevn/git-secret) ⭐ 4,040 | 🐛 153 | 🌐 Shell | 📅 2026-08-24 - Encrypts files with permitted users' public keys, allowing users you trust to access encrypted data using pgp and their secret keys.
...
* [git-cola](https://github.com/git-cola/git-cola) ⭐ 2,568 | 🐛 5 | 🌐 Python | 📅 2026-08-28 - The highly caffeinated Git GUI.
* [python-gitlab](https://github.com/python-gitlab/python-gitlab) ⭐ 2,472 | 🐛 29 | 🌐 Python | 📅 2026-08-31 - A Python package providing access to the GitLab server API.
...
* [meld](https://github.com/GNOME/meld) ⭐ 1,311 | 🐛 0 | 🌐 Python | 📅 2026-08-29 - Meld is a visual diff and merge tool that helps you compare files, directories, and version controlled projects.
* [gitg](https://github.com/GNOME/gitg) ⭐ 216 | 🐛 0 | 🌐 Vala | 📅 2026-08-26 - A graphical user interface for git.
...
* [AirSim](https://github.com/microsoft/AirSim) ⭐ 18,426 | 🐛 780 | 🌐 C++ | 📅 2026-06-30 - Open source simulator for autonomous vehicles built on Unreal Engine.
* [carla](https://github.com/carla-simulator/carla) ⭐ 14,344 | 🐛 1,192 | 🌐 C++ | 📅 2026-08-31 - Open-source simulator for autonomous driving research.
* [Webots](https://github.com/cyberbotics/webots) ⭐ 4,584 | 🐛 228 | 🌐 C++ | 📅 2026-08-28 - Webots is an open source robot simulator compatible (among others) with [ROS](http://wiki.ros.org/webots_ros) and [ROS2](http://wiki.ros.org/webots_ros2).
* [Drake](https://github.com/RobotLocomotion/drake) ⭐ 4,162 | 🐛 657 | 🌐 C++ | 📅 2026-08-31 - Drake aims to simulate even very complex dynamics of robots.
* [sumo](https://github.com/eclipse/sumo) ⭐ 4,157 | 🐛 2,976 | 🌐 Python | 📅 2026-08-31 - Eclipse SUMO is an open source, highly portable, microscopic and continuous road traffic simulation package designed to handle large road networks.
...
* [OpenSceneGraph](https://github.com/openscenegraph/OpenSceneGraph) ⭐ 3,608 | 🐛 176 | 🌐 C++ | 📅 2024-08-09 - An open source high performance 3D graphics toolkit, used by application developers in fields such as visual simulation, games, virtual reality, scientific visualization and modelling.
* [highway-env](https://github.com/eleurent/highway-env) ⭐ 3,302 | 🐛 40 | 🌐 Python | 📅 2026-08-22 - A collection of environments for autonomous driving and tactical decision-making tasks.
* [Unity-Robotics-Hub](https://github.com/Unity-Technologies/Unity-Robotics-Hub) ⭐ 2,569 | 🐛 56 | 🌐 C# | 📅 2024-11-26 - Central repository for tools, tutorials, resources, and documentation for robotic simulation in Unity.
...
* [champ](https://github.com/chvmp/champ) ⭐ 2,309 | 🐛 54 | 🌐 C++ | 📅 2024-07-04 - ROS Packages for CHAMP Quadruped Controller.
* [gym-pybullet-drones](https://github.com/utiasDSL/gym-pybullet-drones) ⭐ 2,121 | 🐛 110 | 🌐 Python | 📅 2026-08-23 - PyBullet-based Gym environments for single and multi-agent reinforcement learning of quadcopter control.
* [AI2-THOR](https://github.com/allenai/ai2thor) ⭐ 1,788 | 🐛 279 | 🌐 C# | 📅 2025-11-04 - Python framework with a Unity backend providing interaction, navigation, and manipulation support for household based robotic agents, consisting of 200+ of custom scenes, 1500+ custom annotated objects, and 200+ actions.
* [rotors\_simulator](https://github.com/ethz-asl/rotors_simulator) ⭐ 1,503 | 🐛 174 | 🌐 C++ | 📅 2024-07-15 - Provides some multirotor models.
...
* [flightmare](https://github.com/uzh-rpg/flightmare) ⭐ 1,406 | 🐛 128 | 🌐 C++ | 📅 2024-06-14 - Flightmare is composed of two main components: a configurable rendering engine built on Unity and a flexible physics engine for dynamics simulation.
* [gazebo\_models](https://github.com/osrf/gazebo_models) ⭐ 1,306 | 🐛 29 | 🌐 HTML | 📅 2024-07-14 - This repository holds the Gazebo model database.
...
* [esmini](https://github.com/esmini/esmini) ⭐ 941 | 🐛 216 | 🌐 C++ | 📅 2026-08-27 -  A basic OpenSCENARIO player.
...
* [safe-control-gym](https://github.com/utiasDSL/safe-control-gym) ⭐ 913 | 🐛 6 | 🌐 Python | 📅 2026-04-29 - PyBullet-based CartPole and Quadrotor environments—with CasADi symbolic dynamics and constraints—for safe and robust learning-based control.
...
* [ESIM](https://github.com/uzh-rpg/rpg_esim/) ⭐ 727 | 🐛 83 | 🌐 C | 📅 2023-12-25 - An Open Event Camera Simulator.
* [scenario\_runner](https://github.com/carla-simulator/scenario_runner) ⭐ 680 | 🐛 179 | 🌐 Python | 📅 2026-08-26 - Traffic scenario definition and execution engine.
* [ros-bridge](https://github.com/carla-simulator/ros-bridge) ⭐ 644 | 🐛 185 | 🌐 Python | 📅 2026-08-16 - ROS bridge for CARLA Simulator.
...
* [BlueSky](https://github.com/TUDelft-CNS-ATM/bluesky) ⭐ 554 | 🐛 48 | 🌐 Python | 📅 2026-08-29 - The goal of BlueSky is to provide everybody who wants to visualize, analyze or simulate air traffic with a tool to do so without any restrictions, licenses or limitations.
...
* [usv\_sim\_lsa](https://github.com/disaster-robotics-proalertas/usv_sim_lsa) ⭐ 458 | 🐛 37 | 🌐 Python | 📅 2024-07-07 - Unmanned Surface Vehicle simulation on Gazebo with water current and winds.
* [42](https://github.com/ericstoneking/42) ⭐ 452 | 🐛 26 | 🌐 C | 📅 2026-08-13 - Simulation for spacecraft attitude control system analysis and design.
...
* [Trick](https://github.com/nasa/Trick) ⭐ 159 | 🐛 112 | 🌐 C++ | 📅 2026-08-29 - Developed at the NASA Johnson Space Center, is a powerful simulation development framework that enables users to build applications for all phases of space vehicle development.
...
* [FreeCAD](https://github.com/FreeCAD/FreeCAD) ⭐ 33,170 | 🐛 4,105 | 🌐 C++ | 📅 2026-08-31 - Your own 3D parametric modeler.
* [openscad](https://github.com/openscad/openscad) ⭐ 10,068 | 🐛 816 | 🌐 C++ | 📅 2026-08-31 -  A software for creating solid 3D CAD models.
* [WireViz](https://github.com/formatc1702/WireViz) ⭐ 5,236 | 🐛 195 | 🌐 Python | 📅 2026-06-06 - A tool for easily documenting cables, wiring harnesses and connector pinouts.
* [NASA-3D-Resources](https://github.com/nasa/NASA-3D-Resources) ⭐ 3,765 | 🐛 4 | 📅 2025-06-03 - Here you'll find a growing collection of 3D models, textures, and images from inside NASA.
* [ODrive](https://github.com/madcowswe/ODrive) ⭐ 3,752 | 🐛 18 | 🌐 C++ | 📅 2026-01-20 - The aim is to make it possible to use inexpensive brushless motors in high performance robotics projects.
* [LibrePCB](https://github.com/LibrePCB/LibrePCB) ⭐ 2,974 | 🐛 217 | 🌐 C++ | 📅 2026-08-25 - A powerful, innovative and intuitive EDA tool for everyone.
* [GNSS-SDR](https://github.com/gnss-sdr/gnss-sdr) ⭐ 2,221 | 🐛 233 | 🌐 C++ | 📅 2026-08-31 - GNSS-SDR provides interfaces for a wide range of radio frequency front-ends and raw sample file formats, generates processing outputs in standard formats.
* [pvlib-python](https://github.com/pvlib/pvlib-python) ⭐ 1,647 | 🐛 247 | 🌐 Python | 📅 2026-08-19 - A community supported tool that provides a set of functions and classes for simulating the performance of photovoltaic energy systems.
* [PcbDraw](https://github.com/yaqwsx/PcbDraw) ⭐ 1,415 | 🐛 10 | 🌐 Python | 📅 2026-08-07 - Convert your KiCAD board into a nice looking 2D drawing suitable for pinout diagrams.
* [Horizon](https://github.com/horizon-eda/horizon) ⭐ 1,312 | 🐛 162 | 🌐 C | 📅 2026-08-28 - EDA is an Electronic Design Automation package supporting an integrated end-to-end workflow for printed circuit board design including parts management and schematic entry.
* [phobos](https://github.com/dfki-ric/phobos) ⭐ 900 | 🐛 14 | 🌐 Python | 📅 2026-07-14 - An add-on for Blender allowing to create URDF, SDF and SMURF robot models in a WYSIWYG environment.
* [kicad-3rd-party-tools](https://github.com/xesscorp/kicad-3rd-party-tools) ⭐ 840 | 🐛 4 | 📅 2026-05-15 - Tools made by others to augment the KiCad PCB EDA suite.
* [OpenMDAO](https://github.com/OpenMDAO/OpenMDAO) ⭐ 777 | 🐛 76 | 🌐 Python | 📅 2026-08-25 - An open-source framework for efficient multidisciplinary optimization.
* [solidworks\_urdf\_exporter](https://github.com/ros/solidworks_urdf_exporter) ⭐ 673 | 🐛 48 | 🌐 C# | 📅 2026-06-05 - SolidWorks to URDF Exporter.
* [cadCAD](https://github.com/cadCAD-org/cadCAD) ⭐ 618 | 🐛 11 | 🌐 Python | 📅 2024-04-19 - A Python package that assists in the processes of designing, testing and validating complex systems through simulation, with support for Monte Carlo methods, A/B testing and parameter sweeping.
...
* [FMPy](https://github.com/CATIA-Systems/FMPy) ⭐ 584 | 🐛 141 | 🌐 Python | 📅 2026-08-13 - Simulate Functional Mockup Units (FMUs) in Python.
* [SUAVE](https://github.com/suavecode/SUAVE) ⭐ 529 | 🐛 39 | 🌐 ReScript | 📅 2024-02-14 - An Aircraft Design Toolbox.
* [oemof-solph](https://github.com/oemof/oemof-solph) ⭐ 417 | 🐛 118 | 🌐 Python | 📅 2026-08-31 - A modular open source framework to model energy supply systems.
...
* [tigl](https://github.com/DLR-SC/tigl) ⭐ 302 | 🐛 131 | 🌐 C++ | 📅 2026-08-31 - The TiGL Geometry Library can be used for the computation and processing of aircraft geometries stored inside CPACS files.
* [OpenAeroStruct](https://github.com/mdolab/OpenAeroStruct) ⭐ 278 | 🐛 34 | 🌐 Python | 📅 2025-10-06 -  A lightweight tool that performs aerostructural optimization using OpenMDAO.
...
* [kalibr](https://github.com/ethz-asl/kalibr) ⭐ 5,684 | 🐛 135 | 🌐 C++ | 📅 2024-03-30 - The Kalibr visual-inertial calibration toolbox.
* [lidar\_camera\_calibration](https://github.com/ankitdhall/lidar_camera_calibration) ⭐ 1,767 | 🐛 61 | 🌐 C++ | 📅 2025-10-16 - ROS package to find a rigid-body transformation between a LiDAR and a camera.
...
* [easy\_handeye](https://github.com/IFL-CAMP/easy_handeye) ⭐ 1,174 | 🐛 23 | 🌐 Python | 📅 2025-11-30 - Simple, straighforward ROS library for hand-eye calibration.
* [lidar\_align](https://github.com/ethz-asl/lidar_align) ⭐ 1,055 | 🐛 29 | 🌐 C++ | 📅 2025-03-11 - A simple method for finding the extrinsic calibration between a 3D lidar and a 6-dof pose sensor.
...
* [robot\_calibration](https://github.com/mikeferguson/robot_calibration/) ⭐ 489 | 🐛 7 | 🌐 C++ | 📅 2026-08-10 - This package offers calibration of a number of parameters of a robot, such as: 3D Camera intrinsics, extrinsics Joint angle offsets and robot frame offsets.
...
* [e2calib](https://github.com/uzh-rpg/e2calib) ⭐ 200 | 🐛 3 | 🌐 Python | 📅 2025-02-28 - Contains code that implements video reconstruction from event data for calibration.
...
* [GibsonEnv](https://github.com/StanfordVL/GibsonEnv) ⭐ 946 | 🐛 49 | 🌐 C | 📅 2024-04-15 - Gibson Environments: Real-World Perception for Embodied Agents.
...
* [ray](https://github.com/ray-project/ray) ⭐ 43,665 | 🐛 3,549 | 🌐 Python | 📅 2026-08-31 - A fast and simple framework for building and running distributed applications.
* [gym](https://github.com/openai/gym) ⚠️ Archived - A toolkit for developing and comparing reinforcement learning algorithms.
* [Netron](https://github.com/lutzroeder/Netron) ⭐ 33,432 | 🐛 18 | 🌐 JavaScript | 📅 2026-08-30 - Visualizer for neural network, deep learning and machine learning models.
* [fastai](https://github.com/fastai/fastai) ⭐ 28,128 | 🐛 268 | 🌐 Jupyter Notebook | 📅 2026-08-29 - The fastai library simplifies training fast and accurate neural nets using modern best practices.
* [mlflow](https://github.com/mlflow/mlflow) ⭐ 27,747 | 🐛 2,057 | 🌐 Python | 📅 2026-08-31 - A platform to streamline machine learning development, including tracking experiments, packaging code into reproducible runs, and sharing and deploying models.
* [MNN](https://github.com/alibaba/MNN) ⭐ 16,001 | 🐛 42 | 🌐 C++ | 📅 2026-08-31 - A blazing fast, lightweight deep learning framework, battle-tested by business-critical use cases in Alibaba.
* [DLIB](https://github.com/davisking/dlib) ⭐ 14,435 | 🐛 39 | 🌐 C++ | 📅 2026-08-11 - A toolkit for making real world machine learning and data analysis applications in C++.
* [Dopamine](https://github.com/google/dopamine) ⭐ 10,903 | 🐛 111 | 🌐 Jupyter Notebook | 📅 2026-03-24 - A research framework for fast prototyping of reinforcement learning algorithms.
...
* [cnn-explainer](https://github.com/poloclub/cnn-explainer) ⭐ 9,031 | 🐛 7 | 🌐 JavaScript | 📅 2023-10-14 - Learning Convolutional Neural Networks with Interactive Visualization.
...
* [ReAgent](https://github.com/facebookresearch/ReAgent) ⭐ 3,712 | 🐛 85 | 🌐 Python | 📅 2026-08-24 - An open source end-to-end platform for applied reinforcement learning (RL) developed and used at Facebook.
...
* [Tensorforce](https://github.com/tensorforce/tensorforce) ⭐ 3,305 | 🐛 44 | 🌐 Python | 📅 2026-07-14 - An open-source deep reinforcement learning framework, with an emphasis on modularized flexible library design and straightforward usability for applications in research and practice.
...
* [Tensorflow Federated](https://github.com/tensorflow/federated) ⭐ 2,448 | 🐛 291 | 🌐 Python | 📅 2026-08-30 - TensorFlow Federated (TFF) is an open-source framework for machine learning and other computations on decentralized data.
* [finn](https://github.com/Xilinx/finn) ⭐ 1,045 | 🐛 114 | 🌐 Python | 📅 2026-08-31 - Fast, Scalable Quantized Neural Network Inference on FPGAs.
...
* [dask](https://github.com/dask/dask) ⭐ 13,909 | 🐛 1,320 | 🌐 Python | 📅 2026-08-24 - Parallel computing with task scheduling for Python.
* [TensorRT](https://github.com/NVIDIA/TensorRT) ⭐ 13,310 | 🐛 629 | 🌐 C++ | 📅 2026-08-25 - A C++ library for high performance inference on NVIDIA GPUs and deep learning accelerators.
* [cupy](https://github.com/cupy/cupy) ⭐ 12,296 | 🐛 713 | 🌐 Python | 📅 2026-08-30 - NumPy-like API accelerated with CUDA.
* [numba](https://github.com/numba/numba) ⭐ 11,137 | 🐛 1,799 | 🌐 Python | 📅 2026-08-28 - NumPy aware dynamic Python compiler using LLVM.
...
* [PYNQ](https://github.com/Xilinx/PYNQ) ⭐ 2,342 | 🐛 58 | 🌐 Jupyter Notebook | 📅 2026-08-30 - An open-source project from Xilinx that makes it easy to design embedded systems with Zynq All Programmable Systems on Chips.
...
* [detectron2](https://github.com/facebookresearch/detectron2) ⭐ 34,692 | 🐛 588 | 🌐 Python | 📅 2026-08-19 - A next-generation research platform for object detection and segmentation.
* [EasyOCR](https://github.com/JaidedAI/EasyOCR) ⭐ 29,957 | 🐛 530 | 🌐 Python | 📅 2025-12-05 - Ready-to-use Optical character recognition (OCR) with 40+ languages supported including Chinese, Japanese, Korean and Thai.
* [imgaug](https://github.com/aleju/imgaug) ⭐ 14,741 | 🐛 311 | 🌐 Python | 📅 2024-07-30 - Image augmentation for machine learning experiments.
* [meshroom](https://github.com/alicevision/meshroom) ⭐ 12,936 | 🐛 516 | 🌐 Python | 📅 2026-08-31 - Meshroom is a free, open-source 3D Reconstruction Software based on the AliceVision Photogrammetric Computer Vision framework.
* [libvips](https://github.com/libvips/libvips) ⭐ 11,620 | 🐛 81 | 🌐 C | 📅 2026-08-31 - A fast image processing library with low memory needs.
* [satellite-image-deep-learning](https://github.com/robmarkcole/satellite-image-deep-learning) ⭐ 10,239 | 🐛 1 | 📅 2026-08-02 - Resources for deep learning with satellite & aerial imagery.
* [fawkes](https://github.com/Shawn-Shan/fawkes) ⭐ 5,596 | 🐛 43 | 🌐 Python | 📅 2023-08-02 - Privacy preserving tool against facial recognition systems.
...
* [AliceVision](https://github.com/alicevision/AliceVision) ⭐ 3,488 | 🐛 38 | 🌐 C++ | 📅 2026-08-30 - A Photogrammetric Computer Vision Framework which provides a 3D Reconstruction and Camera Tracking algorithms.
* [flownet2-pytorch](https://github.com/NVIDIA/flownet2-pytorch) ⭐ 3,290 | 🐛 167 | 🌐 Python | 📅 2026-03-30 - Pytorch implementation of FlowNet 2.0: Evolution of Optical Flow Estimation with Deep Networks.
...
* [Simd](https://github.com/ermig1979/Simd) ⭐ 2,266 | 🐛 25 | 🌐 C++ | 📅 2026-08-27 - C++ image processing and machine learning library with using of SIMD: SSE, SSE2, SSE3, SSSE3, SSE4.1, SSE4.2, AVX, AVX2, AVX-512, VMX(Altivec) and VSX(Power7), NEON for ARM.
...
* [AB3DMOT](https://github.com/xinshuoweng/AB3DMOT) ⭐ 1,847 | 🐛 24 | 🌐 Python | 📅 2024-04-03 - This work proposes a simple yet accurate real-time baseline 3D multi-object tracking system.
...
* [eo-learn](https://github.com/sentinel-hub/eo-learn) ⭐ 1,247 | 🐛 7 | 🌐 Python | 📅 2026-01-15 - A collection of open source Python packages that have been developed to seamlessly access and process spatio-temporal image sequences acquired by any satellite fleet in a timely and automatic manner.
* [satpy](https://github.com/pytroll/satpy) ⭐ 1,204 | 🐛 562 | 🌐 Python | 📅 2026-08-27 - A python library for reading and manipulating meteorological remote sensing data and writing it to various image and data file formats.
* [deep\_object\_pose](https://github.com/NVlabs/Deep_Object_Pose) ⭐ 1,178 | 🐛 87 | 🌐 Python | 📅 2025-08-06 - Deep Object Pose Estimation.
...
* [image\_pipeline](https://github.com/ros-perception/image_pipeline) ⭐ 959 | 🐛 57 | 🌐 C++ | 📅 2026-08-27 - Fills the gap between getting raw images from a camera driver and higher-level vision processing.
...
* [vision\_opencv](https://github.com/ros-perception/vision_opencv) ⭐ 669 | 🐛 68 | 🌐 C++ | 📅 2025-12-29 - Packages for interfacing ROS with OpenCV, a library of programming functions for real time computer vision.
...
* [apriltag\_ros](https://github.com/AprilRobotics/apriltag_ros) ⭐ 462 | 🐛 35 | 🌐 C++ | 📅 2024-06-23 - A ROS wrapper of the AprilTag 3 visual fiducial detector.
...
* [vision\_visp](https://github.com/lagadic/vision_visp) ⭐ 226 | 🐛 45 | 🌐 C++ | 📅 2026-03-04 - Wraps the ViSP moving edge tracker provided by the ViSP visual servoing library into a ROS package.
...
* [open3d](https://github.com/intel-isl/Open3D) ⭐ 13,928 | 🐛 1,305 | 🌐 C++ | 📅 2026-08-31 - Open3D: A Modern Library for 3D Data Processing.
* [Draco](https://github.com/google/draco) ⭐ 7,460 | 🐛 175 | 🌐 C++ | 📅 2026-08-18 - A library for compressing and decompressing 3D geometric meshes and point clouds.
* [mmdetection3d](https://github.com/open-mmlab/mmdetection3d) ⭐ 6,523 | 🐛 656 | 🌐 Python | 📅 2024-07-10 - Next-generation platform for general 3D object detection.
* [PCDet](https://github.com/sshaoshuai/PCDet) ⭐ 5,698 | 🐛 30 | 🌐 Python | 📅 2025-10-08 - A general PyTorch-based codebase for 3D object detection from point cloud.
* [OpenPCDet](https://github.com/open-mmlab/OpenPCDet) ⭐ 5,698 | 🐛 30 | 🌐 Python | 📅 2025-10-08 - A Toolbox for LiDAR-based 3D Object Detection.
* [kaolin](https://github.com/NVIDIAGameWorks/kaolin) ⭐ 5,163 | 🐛 28 | 🌐 Python | 📅 2026-08-24 - A PyTorch Library for Accelerating 3D Deep Learning Research.
* [grid\_map](https://github.com/ANYbotics/grid_map) ⭐ 3,227 | 🐛 168 | 🌐 C++ | 📅 2026-01-13 - Universal grid map library for mobile robotic mapping.
* [octomap](https://github.com/OctoMap/octomap) ⭐ 2,364 | 🐛 44 | 🌐 C++ | 📅 2026-08-02 - An Efficient Probabilistic 3D Mapping Framework Based on Octrees.
* [KISS-ICP](https://github.com/PRBonn/kiss-icp) ⭐ 2,307 | 🐛 18 | 🌐 C++ | 📅 2026-06-09 - A LiDAR Odometry pipeline that just works on most of the cases without tunning any parameter.
* [python-pcl](https://github.com/strawlab/python-pcl) ⚠️ Archived - Python bindings to the pointcloud library.
* [elevation\_mapping](https://github.com/ANYbotics/elevation_mapping) ⭐ 1,859 | 🐛 101 | 🌐 C++ | 📅 2024-11-04 - Robot-centric elevation mapping for rough terrain navigation.
* [libpointmatcher](https://github.com/ethz-asl/libpointmatcher) ⭐ 1,829 | 🐛 100 | 🌐 C++ | 📅 2026-08-27 - An "Iterative Closest Point" library for 2-D/3-D mapping in Robotics.
* [Votenet](https://github.com/facebookresearch/votenet) ⚠️ Archived - Deep Hough Voting for 3D Object Detection in Point Clouds.
* [fast\_gicp](https://github.com/SMRT-AIST/fast_gicp) ⭐ 1,687 | 🐛 76 | 🌐 C++ | 📅 2025-04-24 - A collection of GICP-based fast point cloud registration algorithms.
...
* [PDAL](https://github.com/PDAL/PDAL) ⭐ 1,405 | 🐛 132 | 🌐 C++ | 📅 2026-08-31 - A C++ BSD library for translating and manipulating point cloud data.
...
* [LAStools](https://github.com/LAStools/LAStools) ⭐ 1,067 | 🐛 59 | 🌐 C++ | 📅 2026-08-21 - Award-winning software for efficient LiDAR processing.
* [Cupoch](https://github.com/neka-nat/cupoch) ⭐ 1,060 | 🐛 24 | 🌐 C++ | 📅 2026-06-25 -  A library that implements rapid 3D data processing and robotics computation using CUDA.
...
* [spatio\_temporal\_voxel\_layer](https://github.com/SteveMacenski/spatio_temporal_voxel_layer) ⭐ 857 | 🐛 16 | 🌐 C++ | 📅 2026-08-05 - A new voxel layer leveraging modern 3D graphics tools to modernize navigation environmental representations.
* [ndt\_omp](https://github.com/koide3/ndt_omp) ⭐ 855 | 🐛 32 | 🌐 C++ | 📅 2024-08-31 - Multi-threaded and SSE friendly NDT algorithm.
* [PolyFit](https://github.com/LiangliangNan/PolyFit) ⭐ 828 | 🐛 0 | 🌐 C++ | 📅 2025-04-16 - Polygonal Surface Reconstruction from Point Clouds.
* [PotreeConverter](https://github.com/potree/PotreeConverter) ⭐ 815 | 🐛 186 | 🌐 JavaScript | 📅 2026-06-22 - Builds a potree octree from las, laz, binary ply, xyz or ptx files.
* [linefit\_ground\_segmentation](https://github.com/lorenwel/linefit_ground_segmentation) ⭐ 809 | 🐛 5 | 🌐 C++ | 📅 2024-07-26 - Implementation of the ground segmentation algorithm.
...
* [Removert](https://github.com/irapkaist/removert) ⭐ 647 | 🐛 18 | 🌐 C++ | 📅 2026-04-25 - Remove then revert. Static map construction in the wild and dynamic points removing tool by constructing a static map.
* [CSF](https://github.com/jianboqi/CSF) ⭐ 644 | 🐛 16 | 🌐 C++ | 📅 2025-08-13 - LiDAR point cloud ground filtering / segmentation (bare earth extraction) method based on cloth simulation.
* [pptk](https://github.com/heremaps/pptk) ⭐ 634 | 🐛 59 | 🌐 C++ | 📅 2020-09-17 - Point Processing Toolkit from HEREMaps.
* [pointcloud\_to\_laserscan](https://github.com/ros-perception/pointcloud_to_laserscan) ⭐ 599 | 🐛 10 | 🌐 C++ | 📅 2025-08-28 - Converts a 3D Point Cloud into a 2D laser scan.
...
* [mp2p\_icp](https://github.com/MOLAorg/mp2p_icp) ⭐ 188 | 🐛 4 | 🌐 C++ | 📅 2026-08-30 - A repertory of multi primitive-to-primitive (MP2P) ICP algorithms in C++.
...
* [robot\_body\_filter](https://github.com/peci1/robot_body_filter) ⭐ 103 | 🐛 7 | 🌐 C++ | 📅 2026-04-06 - A highly configurable LaserScan/PointCloud2 filter that allows to dynamically remove the 3D body of the robot from the measurements.
...
* [Kalman-and-Bayesian-Filters-in-Python](https://github.com/rlabbe/Kalman-and-Bayesian-Filters-in-Python) ⭐ 19,227 | 🐛 143 | 🌐 Jupyter Notebook | 📅 2024-08-07 - Kalman Filter book using Jupyter Notebook.
* [evo](https://github.com/MichaelGrupp/evo) ⭐ 4,311 | 🐛 8 | 🌐 Python | 📅 2026-08-31 - Python package for the evaluation of odometry and SLAM.
* [PROJ](https://github.com/OSGeo/PROJ) ⭐ 2,008 | 🐛 100 | 🌐 C++ | 📅 2026-08-28 - Cartographic Projections and Coordinate Transformations Library.
* [robot\_localization](https://github.com/cra-ros-pkg/robot_localization) ⭐ 1,951 | 🐛 92 | 🌐 C++ | 📅 2026-07-16 - A package of nonlinear state estimation nodes.
...
* [ai-imu-dr](https://github.com/mbrossar/ai-imu-dr) ⭐ 998 | 🐛 39 | 🌐 Python | 📅 2025-01-08 - Contains the code of our novel accurate method for dead reckoning of wheeled vehicles based only on an IMU.
* [RTKLIB](https://github.com/rtklibexplorer/RTKLIB) ⭐ 968 | 🐛 76 | 🌐 C | 📅 2026-08-28 - A version of RTKLIB optimized for single and dual frequency low cost GPS receivers, especially u-blox receivers.
...
* [fuse](https://github.com/locusrobotics/fuse) ⭐ 877 | 🐛 48 | 🌐 C++ | 📅 2026-08-19 - General architecture for performing sensor fusion live on a robot.
...
* [python-sgp4](https://github.com/brandon-rhodes/python-sgp4) ⭐ 470 | 🐛 8 | 🌐 Python | 📅 2026-07-12 - Python version of the SGP4 satellite position library.
...
* [se2lam](https://github.com/izhengfan/se2lam) ⭐ 411 | 🐛 3 | 🌐 C++ | 📅 2024-06-04 - On-SE(2) Localization and Mapping for Ground Vehicles by Fusing Odometry and Vision.
...
* [LIO\_SAM](https://github.com/TixiaoShan/LIO-SAM) ⭐ 4,900 | 🐛 183 | 🌐 C++ | 📅 2025-02-14 - Tightly-coupled Lidar Inertial Odometry via Smoothing and Mapping.
* [pyslam](https://github.com/luigifreda/pyslam) ⭐ 3,403 | 🐛 1 | 🌐 Python | 📅 2026-08-23 - Contains a monocular Visual Odometry (VO) pipeline in Python.
* [maplab](https://github.com/ethz-asl/maplab) ⭐ 2,868 | 🐛 123 | 🌐 C++ | 📅 2024-05-31 - An open visual-inertial mapping framework.
...
* [slam\_toolbox](https://github.com/SteveMacenski/slam_toolbox) ⭐ 2,612 | 🐛 48 | 🌐 C++ | 📅 2026-08-19 - Slam Toolbox for lifelong mapping and localization in potentially massive maps with ROS .
* [A-LOAM](https://github.com/HKUST-Aerial-Robotics/A-LOAM) ⭐ 2,440 | 🐛 52 | 🌐 C++ | 📅 2023-10-19 - Advanced implementation of LOAM.
* [hdl\_graph\_slam](https://github.com/koide3/hdl_graph_slam) ⭐ 2,332 | 🐛 126 | 🌐 C++ | 📅 2024-07-16 - An open source ROS package for real-time 6DOF SLAM using a 3D LIDAR.
* [KISS-ICP](https://github.com/PRBonn/kiss-icp) ⭐ 2,307 | 🐛 18 | 🌐 C++ | 📅 2026-06-09 - A LiDAR Odometry pipeline that just works on most of the cases without tunning any parameter.
* [cartographer\_ros](https://github.com/googlecartographer/cartographer_ros) ⭐ 1,854 | 🐛 289 | 🌐 C++ | 📅 2024-03-10 - Provides ROS integration for Cartographer.
* [loam\_velodyne](https://github.com/laboshinl/loam_velodyne) ⭐ 1,759 | 🐛 108 | 🌐 C++ | 📅 2019-06-18 - Laser Odometry and Mapping (Loam) is a realtime method for state estimation and mapping using a 3D lidar.
* [loam\_livox](https://github.com/hku-mars/loam_livox) ⭐ 1,619 | 🐛 71 | 🌐 C++ | 📅 2020-02-24 - A robust LiDAR Odometry and Mapping (LOAM) package for Livox-LiDAR.
* [Fast LOAM](https://github.com/wh200720041/floam) ⭐ 1,142 | 🐛 43 | 🌐 C++ | 📅 2024-07-30 - Fast and Optimized Lidar Odometry And Mapping.
* [lio-mapping](https://github.com/hyye/lio-mapping) ⭐ 1,028 | 🐛 35 | 🌐 C++ | 📅 2020-02-13 - Implementation of Tightly Coupled 3D Lidar Inertial Odometry and Mapping (LIO-mapping).
* [semantic\_suma](https://github.com/PRBonn/semantic_suma/) ⭐ 1,015 | 🐛 5 | 🌐 C++ | 📅 2024-03-12 - Semantic Mapping using Surfel Mapping and Semantic Segmentation.
* [mola](https://github.com/MOLAorg/mola) ⭐ 1,002 | 🐛 32 | 🌐 C++ | 📅 2026-08-29 - A Modular System for Localization and Mapping.
...
* [ORB\_SLAM3](https://github.com/UZ-SLAMLab/ORB_SLAM3) ⭐ 8,999 | 🐛 571 | 🌐 C++ | 📅 2024-07-24 - ORB-SLAM3: An Accurate Open-Source Library for Visual, Visual-Inertial and Multi-Map SLAM.
* [VINS-Fusion](https://github.com/HKUST-Aerial-Robotics/VINS-Fusion) ⭐ 4,691 | 🐛 212 | 🌐 C++ | 📅 2024-05-23 - A Robust and Versatile Multi-Sensor Visual-Inertial State Estimator.
* [hloc](https://github.com/cvg/Hierarchical-Localization) ⭐ 4,199 | 🐛 162 | 🌐 Python | 📅 2025-12-10 - A modular toolbox for state-of-the-art 6-DoF visual localization. It implements Hierarchical Localization, leveraging image retrieval and feature matching, and is fast, accurate, and scalable.
* [open\_vins](https://github.com/rpng/open_vins) ⭐ 3,069 | 🐛 73 | 🌐 C++ | 📅 2025-11-30 - An open source platform for visual-inertial navigation research.
* [openvslam](https://github.com/xdspacelab/openvslam) ⚠️ Archived - OpenVSLAM: A Versatile Visual SLAM Framework.
* [LSD-SLAM](https://github.com/tum-vision/lsd_slam) ⭐ 2,724 | 🐛 240 | 🌐 C++ | 📅 2023-03-23 - Large-Scale Direct Monocular SLAM is a real-time monocular SLAM.
* [dso](https://github.com/JakobEngel/dso/) ⭐ 2,454 | 🐛 138 | 🌐 C++ | 📅 2024-02-23 - Direct Sparse Odometry.
* [Kimera](https://github.com/MIT-SPARK/Kimera) ⭐ 2,120 | 🐛 2 | 📅 2021-01-30 - A C++ library for real-time metric-semantic simultaneous localization and mapping, which uses camera images and inertial data to build a semantically annotated 3D mesh of the environment.
* [Atlas](https://github.com/magicleap/Atlas) ⭐ 1,857 | 🐛 53 | 🌐 Python | 📅 2022-04-06 - End-to-End 3D Scene Reconstruction from Posed Images.
* [gradslam](https://github.com/gradslam/gradslam) ⭐ 1,422 | 🐛 18 | 🌐 Python | 📅 2023-09-02 - An open source differentiable dense SLAM library for PyTorch.
* [rovio](https://github.com/ethz-asl/rovio) ⭐ 1,263 | 🐛 83 | 🌐 C++ | 📅 2026-01-19 - Robust Visual Inertial Odometry Framework.
...
* [LARVIO](https://github.com/PetWorm/LARVIO) ⭐ 805 | 🐛 12 | 🌐 C++ | 📅 2024-04-10 - A lightweight, accurate and robust monocular visual inertial odometry based on Multi-State Constraint Kalman Filter.
* [ESVO](https://github.com/HKUST-Aerial-Robotics/ESVO) ⭐ 505 | 🐛 10 | 🌐 C++ | 📅 2025-03-20 - A novel pipeline for real-time visual odometry using a stereo event-based camera.
* [vilib](https://github.com/uzh-rpg/vilib) ⭐ 458 | 🐛 4 | 🌐 C++ | 📅 2021-06-25 - This library focuses on the front-end of VIO pipelines with CUDA.
* [tagslam](https://github.com/berndpfrommer/tagslam) ⭐ 371 | 🐛 0 | 🌐 C++ | 📅 2026-01-08 - A ROS-based package for Simultaneous Localization and Mapping using AprilTag fiducial markers.
...
* [Mapbox](https://github.com/mapbox/mapbox-gl-js) ⭐ 12,391 | 🐛 1,457 | 🌐 TypeScript | 📅 2026-08-31 - A JavaScript library for interactive, customizable vector maps on the web.
* [osrm-backend](https://github.com/Project-OSRM/osrm-backend) ⭐ 8,027 | 🐛 357 | 🌐 C++ | 📅 2026-08-29 - Open Source Routing Machine - C++ backend.
* [gdal](https://github.com/OSGeo/gdal) ⭐ 6,040 | 🐛 560 | 🌐 C++ | 📅 2026-08-31 - GDAL is an open source X/MIT licensed translator library for raster and vector geospatial data formats.
* [osmnx](https://github.com/gboeing/osmnx) ⭐ 5,832 | 🐛 2 | 🌐 Python | 📅 2026-07-31 - Python for street networks. Retrieve, model, analyze, and visualize street networks and other spatial data from OpenStreetMap.
* [geopandas](https://github.com/geopandas/geopandas) ⭐ 5,236 | 🐛 420 | 🌐 Python | 📅 2026-08-31 - A project to add support for geographic data to pandas objects.
* [mapnik](https://github.com/mapnik/mapnik) ⭐ 3,956 | 🐛 728 | 🌐 C++ | 📅 2026-08-28 - Combines pixel-perfect image output with lightning-fast cartographic algorithms, and exposes interfaces in C++, Python, and Node.
* [iD](https://github.com/openstreetmap/iD) ⭐ 3,865 | 🐛 1,019 | 🌐 JavaScript | 📅 2026-08-31 - The easy-to-use OpenStreetMap editor in JavaScript.
* [MapsModelsImporter](https://github.com/eliemichel/MapsModelsImporter) ⭐ 2,810 | 🐛 132 | 🌐 Python | 📅 2024-04-21 - A Blender add-on to import models from google maps.
* [3d-tiles](https://github.com/CesiumGS/3d-tiles) ⭐ 2,599 | 🐛 95 | 🌐 Batchfile | 📅 2026-08-27 - Specification for streaming massive heterogeneous 3D geospatial datasets.
* [grass](https://github.com/OSGeo/grass) ⭐ 1,156 | 🐛 703 | 🌐 C | 📅 2026-08-29 - GRASS GIS - free and open source Geographic Information System (GIS).
* [segmap](https://github.com/ethz-asl/segmap) ⭐ 1,096 | 🐛 66 | 🌐 C++ | 📅 2021-03-17 - A map representation based on 3D segments.
* [Lanelet2](https://github.com/fzi-forschungszentrum-informatik/Lanelet2) ⭐ 959 | 🐛 19 | 🌐 C++ | 📅 2026-06-18 - Map handling framework for automated driving.
...
* [RapiD](https://github.com/facebookincubator/RapiD) ⭐ 636 | 🐛 335 | 🌐 JavaScript | 📅 2026-05-28 - An enhanced version of iD for mapping with AI created by Facebook.
* [mapillary\_tools](https://github.com/mapillary/mapillary_tools) ⭐ 314 | 🐛 31 | 🌐 Python | 📅 2026-08-04 - A library for processing and uploading images to Mapillary.
...
* [sgan](https://github.com/agrimgupta92/sgan) ⭐ 914 | 🐛 70 | 🌐 Python | 📅 2023-11-24 -  Socially Acceptable Trajectories with Generative Adversarial Networks.

## Behavior and Decision

* [BehaviorTree.CPP](https://github.com/BehaviorTree/BehaviorTree.CPP) ⭐ 4,175 | 🐛 51 | 🌐 C++ | 📅 2026-08-31 - Behavior Trees Library in C++.
...
* [pinocchio](https://github.com/stack-of-tasks/pinocchio) ⭐ 3,693 | 🐛 110 | 🌐 C++ | 📅 2026-08-31 - A fast and flexible implementation of Rigid Body Dynamics algorithms and their analytical derivatives.
* [EGO-Planner](https://github.com/ZJU-FAST-Lab/ego-planner) ⭐ 2,626 | 🐛 40 | 🌐 C++ | 📅 2025-03-08 - A lightweight gradient-based local planner without ESDF construction, which significantly reduces computation time compared to some state-of-the-art methods.
* [casADi](https://github.com/casadi/casadi) ⭐ 2,284 | 🐛 746 | 🌐 C++ | 📅 2026-08-25 - A symbolic framework for numeric optimization implementing automatic differentiation in forward and reverse modes on sparse matrix-valued computational graphs.
* [ompl](https://github.com/ompl/ompl) ⭐ 2,136 | 🐛 99 | 🌐 C++ | 📅 2026-08-26 - Consists of many state-of-the-art sampling-based motion planning algorithms.
* [path\_planner](https://github.com/karlkurzer/path_planner) ⭐ 1,912 | 🐛 18 | 🌐 C++ | 📅 2026-03-30 - Hybrid A\* Path Planner for the KTH Research Concept Vehicle.
* [mpcc](https://github.com/alexliniger/MPCC) ⭐ 1,862 | 🐛 9 | 🌐 C++ | 📅 2026-04-25 - Model Predictive Contouring Controller for Autonomous Racing.
* [flexible-collision-library](https://github.com/flexible-collision-library/fcl) ⭐ 1,753 | 🐛 245 | 🌐 C++ | 📅 2026-08-28 - A library for performing three types of proximity queries on a pair of geometric models composed of triangles.
...
* [teb\_local\_planner](https://github.com/rst-tu-dortmund/teb_local_planner) ⭐ 1,344 | 🐛 151 | 🌐 C++ | 📅 2026-01-09 - An optimal trajectory planner considering distinctive topologies for mobile robots based on Timed-Elastic-Bands.
...
* [toppra](https://github.com/hungpham2511/toppra) ⭐ 923 | 🐛 37 | 🌐 Python | 📅 2026-08-28 - A library for computing the time-optimal path parametrization for robots subject to kinematic and dynamic constraints.
...
* [CrowdNav](https://github.com/vita-epfl/CrowdNav) ⭐ 733 | 🐛 30 | 🌐 Python | 📅 2022-08-26 - Crowd-aware Robot Navigation with Attention-based Deep Reinforcement Learning.
...
* [se2\_navigation](https://github.com/leggedrobotics/se2_navigation) ⭐ 606 | 🐛 7 | 🌐 C++ | 📅 2023-03-07 - Pure pursuit controller and Reeds-Shepp sampling based planner for navigation in SE(2) space.
...
* [imgui](https://github.com/ocornut/imgui) ⭐ 75,970 | 🐛 1,236 | 🌐 C++ | 📅 2026-08-31 - Designed to enable fast iterations and to empower programmers to create content creation tools and visualization / debug tools.
* [pencil](https://github.com/evolus/pencil) ⭐ 9,861 | 🐛 534 | 🌐 JavaScript | 📅 2026-06-02 - A tool for making diagrams and GUI prototyping that everyone can use.
* [NanoGUI](https://github.com/wjakob/nanogui) ⭐ 4,873 | 🐛 115 | 🌐 C++ | 📅 2023-04-28 - A minimalistic cross-platform widget library for OpenGL 3.x or higher.
* [elements](https://github.com/cycfi/elements) ⭐ 3,718 | 🐛 41 | 🌐 C++ | 📅 2026-06-13 - A lightweight, fine-grained, resolution independent, modular GUI library.
* [cage](https://github.com/Hjdskes/cage) ⭐ 2,036 | 🐛 124 | 🌐 C | 📅 2026-08-18 - This is Cage, a Wayland kiosk. A kiosk runs a single, maximized application.
...
* [mir](https://github.com/MirServer/mir) ⭐ 779 | 🐛 417 | 🌐 C++ | 📅 2026-08-28 - Mir is set of libraries for building Wayland based shells.
...
* [TTS](https://github.com/coqui-ai/TTS) ⭐ 45,972 | 🐛 2 | 🌐 Python | 📅 2024-08-16 - A deep learning toolkit for Text-to-Speech, battle-tested in research and production.
...
* [DDSP](https://github.com/magenta/ddsp) ⭐ 3,346 | 🐛 54 | 🌐 Python | 📅 2026-07-09 - A library of differentiable versions of common DSP functions (such as synthesizers, waveshapers, and filters).
...
* [the-art-of-command-line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,192 | 🐛 257 | 📅 2024-06-25 - Master the command line, in one page.
* [fzf](https://github.com/junegunn/fzf) ⭐ 82,740 | 🐛 326 | 🌐 Go | 📅 2026-08-31 - A command-line fuzzy finder.
* [bat](https://github.com/sharkdp/bat) ⭐ 60,315 | 🐛 421 | 🌐 Rust | 📅 2026-08-11 - A cat(1) clone with wings.
* [ag](https://github.com/ggreer/the_silver_searcher) ⭐ 27,113 | 🐛 564 | 🌐 C | 📅 2024-06-16 - A code-searching tool similar to ack, but faster.
* [fx](https://github.com/antonmedv/fx) ⭐ 20,612 | 🐛 27 | 🌐 Go | 📅 2026-08-26 - Command-line tool and terminal JSON viewer.
* [gocui](https://github.com/jroimartin/gocui) ⭐ 10,594 | 🐛 60 | 🌐 Go | 📅 2025-05-01 - Minimalist Go package aimed at creating Console User Interfaces.
* [python-prompt-toolkit](https://github.com/prompt-toolkit/python-prompt-toolkit) ⭐ 10,565 | 🐛 709 | 🌐 Python | 📅 2026-07-26 - Library for building powerful interactive command line applications in Python.
* [mapscii](https://github.com/rastapasta/mapscii) ⭐ 9,232 | 🐛 52 | 🌐 JavaScript | 📅 2024-11-03 - World map renderer for your console.
* [dotbot](https://github.com/anishathalye/dotbot) ⭐ 7,995 | 🐛 17 | 🌐 Python | 📅 2026-07-12 - A tool that bootstraps your dotfiles.
* [tmate](https://github.com/tmate-io/tmate) ⭐ 6,120 | 🐛 130 | 🌐 C | 📅 2026-07-29 - Instant terminal sharing.
* [guake](https://github.com/Guake/guake) ⭐ 4,668 | 🐛 458 | 🌐 Python | 📅 2026-08-19 - Drop-down terminal for GNOME.
* [tmuxp](https://github.com/tmux-python/tmuxp) ⭐ 4,570 | 🐛 139 | 🌐 Python | 📅 2026-08-29 -  A session manager built on libtmux.
...
* [obs-studio](https://github.com/obsproject/obs-studio) ⭐ 75,659 | 🐛 1,171 | 🌐 C | 📅 2026-08-26 - Free and open source software for live streaming and screen recording.
* [bokeh](https://github.com/bokeh/bokeh) ⭐ 20,436 | 🐛 855 | 🌐 Python | 📅 2026-08-31 - Interactive Data Visualization in the browser, from Python.
* [plotly.py](https://github.com/plotly/plotly.py) ⭐ 18,763 | 🐛 750 | 🌐 Python | 📅 2026-08-27 - An open-source, interactive graphing library for Python.
* [openmct](https://github.com/nasa/openmct) ⭐ 13,102 | 🐛 1,077 | 🌐 JavaScript | 📅 2026-08-26 - A web based mission control framework.
* [kepler.gl](https://github.com/keplergl/kepler.gl) ⭐ 11,994 | 🐛 461 | 🌐 TypeScript | 📅 2026-08-31 - Kepler.gl is a powerful open source geospatial analysis tool for large-scale data sets.
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,135 | 🐛 162 | 🌐 C++ | 📅 2026-08-10 - The timeseries visualization tool that you deserve.
...
* [PyQtGraph](https://github.com/pyqtgraph/pyqtgraph) ⭐ 4,409 | 🐛 495 | 🌐 Python | 📅 2026-08-30 - Fast data visualization and GUI tools for scientific / engineering applications.
* [Pangolin](https://github.com/stevenlovegrove/Pangolin) ⭐ 2,740 | 🐛 48 | 🌐 C++ | 📅 2026-08-19 - Pangolin is a lightweight portable rapid development library for managing OpenGL display / interaction and abstracting video input.
* [webviz](https://github.com/cruise-automation/webviz) ⭐ 2,336 | 🐛 134 | 🌐 JavaScript | 📅 2022-12-17 - Web-based visualization libraries like rviz.
* [marvros](https://github.com/mavlink/mavros) ⭐ 1,218 | 🐛 411 | 🌐 C++ | 📅 2026-08-28 - MAVLink to ROS gateway with proxy for Ground Control Station.
...
* [urdf-loaders](https://github.com/gkjohnson/urdf-loaders) ⭐ 813 | 🐛 30 | 🌐 JavaScript | 📅 2026-08-10 - URDF Loaders for Unity and THREE.js with example ATHLETE URDF File.
...
* [ros3djs](https://github.com/RobotWebTools/ros3djs) ⭐ 446 | 🐛 81 | 🌐 JavaScript | 📅 2026-02-20 - 3D Visualization Library for use with the ROS JavaScript Libraries.
* [web\_video\_server](https://github.com/RobotWebTools/web_video_server) ⭐ 389 | 🐛 24 | 🌐 C++ | 📅 2026-07-02 - HTTP Streaming of ROS Image Topics in Multiple Formats.
...
* [label-studio](https://github.com/heartexlabs/label-studio) ⭐ 28,170 | 🐛 930 | 🌐 TypeScript | 📅 2026-08-31 - Label Studio is a multi-type data labeling and annotation tool with standardized output format.
...
* [cvat](https://github.com/opencv/cvat) ⭐ 16,625 | 🐛 599 | 🌐 Python | 📅 2026-08-31 - Powerful and efficient Computer Vision Annotation Tool (CVAT).
* [labelme](https://github.com/wkentaro/labelme) ⭐ 16,133 | 🐛 181 | 🌐 Python | 📅 2026-08-30 - Image Polygonal Annotation with Python (polygon, rectangle, circle, line, point and image-level flag annotation).
* [napari](https://github.com/napari/napari) ⭐ 2,751 | 🐛 1,237 | 🌐 Python | 📅 2026-08-25 -  A fast, interactive, multi-dimensional image viewer for python.
...
* [Potree](https://github.com/potree/potree) ⭐ 5,588 | 🐛 822 | 🌐 JavaScript | 📅 2026-01-08 - WebGL point cloud viewer for large datasets.
* [CloudCompare](https://github.com/CloudCompare/CloudCompare) ⭐ 4,705 | 🐛 287 | 🌐 C++ | 📅 2026-08-30 - CloudCompare is a 3D point cloud (and triangular mesh) processing software.
...
* [Pcx](https://github.com/keijiro/Pcx) ⭐ 1,514 | 🐛 25 | 🌐 C# | 📅 2022-08-23 - Point cloud importer & renderer for Unity.
...
* [rviz\_visual\_tools](https://github.com/PickNikRobotics/rviz_visual_tools) ⭐ 818 | 🐛 33 | 🌐 C++ | 📅 2026-08-03 - C++ API wrapper for displaying shapes and meshes in Rviz.
...
* [mapviz](https://github.com/swri-robotics/mapviz) ⭐ 486 | 🐛 12 | 🌐 C++ | 📅 2026-08-30 - Modular ROS visualization tool for 2D data.
* [rviz\_cinematographer](https://github.com/AIS-Bonn/rviz_cinematographer) ⭐ 294 | 🐛 2 | 🌐 C++ | 📅 2021-08-19 - Easy to use tools to create and edit trajectories for the rviz camera.

<!--lint ignore double-link-->

* [jsk\_visualization](https://github.com/jsk-ros-pkg/jsk_visualization) ⭐ 358 | 🐛 29 | 🌐 C++ | 📅 2026-07-29 - Jsk visualization ros packages for rviz and rqt.
...
* [spdlog](https://github.com/gabime/spdlog) ⭐ 29,553 | 🐛 49 | 🌐 C++ | 📅 2026-08-08 - Very fast, header-only/compiled, C++ logging library.
* [ctop](https://github.com/bcicen/ctop) ⭐ 17,831 | 🐛 120 | 🌐 Go | 📅 2024-07-08 -  Top-like interface for container metrics.
* [psutil](https://github.com/giampaolo/psutil) ⭐ 11,272 | 🐛 260 | 🌐 Python | 📅 2026-08-27 - Cross-platform lib for process and system monitoring in Python.
* [nvtop](https://github.com/Syllo/nvtop) ⭐ 10,952 | 🐛 146 | 🌐 C | 📅 2026-05-06 - NVIDIA GPUs htop like monitoring tool.
* [ntop](https://github.com/ntop/ntopng) ⭐ 8,123 | 🐛 321 | 🌐 Lua | 📅 2026-08-31 - Web-based Traffic and Security Network Traffic Monitoring.
...
* [collectd](https://github.com/collectd/collectd/) ⭐ 3,363 | 🐛 785 | 🌐 C | 📅 2026-05-29 - A small daemon which collects system information periodically and provides mechanisms to store and monitor the values in a variety of ways.
* [Sshwifty](https://github.com/nirui/sshwifty) ⭐ 3,116 | 🐛 40 | 🌐 JavaScript | 📅 2026-08-19 - Sshwifty is a SSH and Telnet connector made for the Web.
...
* [atop](https://github.com/Atoptool/atop) ⭐ 1,058 | 🐛 62 | 🌐 C | 📅 2026-08-15 - System and process monitor for Linux with logging and replay function.
...
* [syncthing](https://github.com/syncthing/syncthing) ⭐ 88,157 | 🐛 378 | 🌐 Go | 📅 2026-08-25 - A continuous file synchronization program.
* [DuckDB](https://github.com/cwida/duckdb) ⭐ 40,849 | 🐛 854 | 🌐 C++ | 📅 2026-08-31 - An embeddable SQL OLAP Database Management System.
* [nextcloud](https://github.com/nextcloud/server) ⭐ 36,649 | 🐛 3,600 | 🌐 PHP | 📅 2026-08-31 - Nextcloud is a suite of client-server software for creating and using file hosting services.
* [borg](https://github.com/borgbackup/borg) ⭐ 13,671 | 🐛 223 | 🌐 Python | 📅 2026-08-31 - Deduplicating archiver with compression and authenticated encryption.
...
* [kitti2bag](https://github.com/tomas789/kitti2bag) ⭐ 813 | 🐛 42 | 🌐 Python | 📅 2024-07-06 - Convert KITTI dataset to ROS bag file the easy way.
* [rosbag\_editor](https://github.com/facontidavide/rosbag_editor) ⭐ 448 | 🐛 12 | 🌐 C++ | 📅 2023-03-25 - Create a rosbag from a given one, using a simple GUI.
...
* [ceph](https://github.com/ceph/ceph) ⭐ 16,980 | 🐛 1,306 | 🌐 C++ | 📅 2026-08-31 - A distributed object, block, and file storage platform.
* [moosefs](https://github.com/moosefs/moosefs) ⭐ 2,002 | 🐛 191 | 🌐 C | 📅 2026-05-18 -  A scalable distributed storage system.
* [sshfs](https://github.com/osxfuse/sshfs) ⭐ 1,204 | 🐛 30 | 🌐 C | 📅 2022-09-06 - File system based on the SSH File Transfer Protocol.
* [nfs](https://github.com/sahlberg/libnfs) ⭐ 601 | 🐛 1 | 🌐 C | 📅 2026-08-30 - A distributed file system protocol originally developed by Sun Microsystems.
...
* [ansible](https://github.com/ansible/ansible) ⭐ 70,511 | 🐛 836 | 🌐 Python | 📅 2026-08-27 - Ansible is a radically simple IT automation platform that makes your applications and systems easier to deploy.
...
* [traefik](https://github.com/containous/traefik) ⭐ 64,675 | 🐛 913 | 🌐 Go | 📅 2026-08-31 - The Cloud Native Edge Router.
* [Portainer](https://github.com/portainer/portainer) ⭐ 38,392 | 🐛 745 | 🌐 TypeScript | 📅 2026-08-28 - Making Docker management easy.
...
* [noVNC](https://github.com/novnc/noVNC) ⭐ 13,971 | 🐛 109 | 🌐 JavaScript | 📅 2026-08-20 - VNC client using HTML5.
* [triton-inference-server](https://github.com/NVIDIA/triton-inference-server) ⭐ 10,952 | 🐛 887 | 🌐 Python | 📅 2026-08-31 - NVIDIA Triton Inference Server provides a cloud inferencing solution optimized for NVIDIA GPUs.
* [cudf](https://github.com/rapidsai/cudf) ⭐ 9,740 | 🐛 1,302 | 🌐 C++ | 📅 2026-08-31 - Provides a pandas-like API that will be familiar to data engineers & data scientists, so they can use it to easily accelerate their workflows without going into the details of CUDA programming.
* [jupyterhub](https://github.com/jupyterhub/jupyterhub) ⭐ 8,331 | 🐛 194 | 🌐 Python | 📅 2026-08-24 - Multi-user server for Jupyter notebooks.
* [graylog2-server](https://github.com/Graylog2/graylog2-server) ⭐ 8,122 | 🐛 2,056 | 🌐 Java | 📅 2026-08-31 - Free and open source log management.
* [docker-py](https://github.com/docker/docker-py) ⭐ 7,212 | 🐛 569 | 🌐 Python | 📅 2026-08-31 - A Python library for the Docker Engine API.
* [pyinfra](https://github.com/Fizzadar/pyinfra) ⭐ 5,970 | 🐛 176 | 🌐 Python | 📅 2026-08-27 - It can be used for ad-hoc command execution, service deployment, configuration management and more.
* [Slurm](https://github.com/SchedMD/slurm) ⭐ 4,289 | 🐛 14 | 🌐 C | 📅 2026-08-31 - Slurm: A Highly Scalable Workload Manager.
* [polyaxon](https://github.com/polyaxon/polyaxon) ⭐ 3,727 | 🐛 126 | 🌐 MDX | 📅 2026-08-31 - A platform for reproducing and managing the whole life cycle of machine learning and deep learning applications.
* [docker-firefox](https://github.com/jlesage/docker-firefox) ⭐ 2,544 | 🐛 95 | 🌐 Shell | 📅 2026-08-26 - Run a Docker Container with Firefox and noVNC for remote access to headless servers.
* [log-pilot](https://github.com/AliyunContainerService/log-pilot) ⚠️ Archived - Collect logs for docker containers.
* [enroot](https://github.com/NVIDIA/enroot) ⭐ 1,096 | 🐛 100 | 🌐 Shell | 📅 2026-06-09 - A simple, yet powerful tool to turn traditional container/OS images into unprivileged sandboxes.
* [mass](https://github.com/maas/maas) ⭐ 498 | 🐛 27 | 🌐 Python | 📅 2026-08-28 - Self-service, remote installation of Windows, CentOS, ESXi and Ubuntu on real servers turns your data centre into a bare metal cloud.

### Embedded Operation System

* [jetson-containers](https://github.com/dusty-nv/jetson-containers) ⭐ 4,840 | 🐛 197 | 🌐 Jupyter Notebook | 📅 2026-08-10 - Machine Learning Containers for Jetson and JetPack 4.4.
* [jetson\_stats](https://github.com/rbonghi/jetson_stats) ⭐ 2,616 | 🐛 54 | 🌐 Python | 📅 2026-08-28 - A package to monitoring and control your NVIDIA Jetson (Xavier NX, Nano, AGX Xavier, TX1, TX2) Works with all NVIDIA Jetson ecosystem.
* [Jailhouse](https://github.com/siemens/jailhouse) ⭐ 1,959 | 🐛 0 | 🌐 C | 📅 2024-05-18 - Jailhouse is a partitioning Hypervisor based on Linux.
...
* [meta-balena](https://github.com/balena-os/meta-balena) ⭐ 989 | 🐛 139 | 🌐 BitBake | 📅 2026-08-30 - Run Docker containers on embedded devices.
...
* [bitbake](https://github.com/openembedded/bitbake) ⭐ 529 | 🐛 17 | 🌐 Python | 📅 2026-08-29 - A generic task execution engine that allows shell and Python tasks to be run efficiently and in parallel while working within complex inter-task dependency constraints.
* [meta-ros](https://github.com/ros/meta-ros/tree/thud-draft) ⭐ 486 | 🐛 103 | 🌐 BitBake | 📅 2026-08-30 - OpenEmbedded Layer for ROS Applications.
* [OpenCR](https://github.com/ROBOTIS-GIT/OpenCR) ⭐ 429 | 🐛 16 | 🌐 C | 📅 2024-05-01 - Open-source Control Module for ROS.
* [qemu-xilinx](https://github.com/Xilinx/qemu) ⭐ 301 | 🐛 52 | 🌐 C | 📅 2026-08-17 - A fork of Quick EMUlator (QEMU) with improved support and modelling for the Xilinx platforms.
...
* [protobuf](https://github.com/protocolbuffers/protobuf) ⭐ 71,863 | 🐛 315 | 🌐 C++ | 📅 2026-08-31 - Google's data interchange format.
* [Fast-RTPS](https://github.com/eProsima/Fast-RTPS) ⭐ 2,889 | 🐛 134 | 🌐 C++ | 📅 2026-08-28 - A Protocol, which provides publisher-subscriber communications over unreliable transports such as UDP, as defined and maintained by the Object Management Group (OMG) consortium.
* [iceoryx](https://github.com/eclipse/iceoryx) ⭐ 2,163 | 🐛 259 | 🌐 C++ | 📅 2026-08-18 - An IPC middleware for POSIX-based systems.
* [cyclonedds](https://github.com/eclipse-cyclonedds/cyclonedds) ⭐ 1,331 | 🐛 314 | 🌐 C | 📅 2026-08-26 - Eclipse Cyclone DDS is a very performant and robust open-source DDS implementation.
...
* [micro-ROS for Arduino](https://github.com/micro-ROS/micro_ros_arduino) ⭐ 574 | 🐛 76 | 🌐 C | 📅 2026-01-28 - A experimental micro-ROS library for baremetal projects based on Arduino IDE or Arduino CLI.
...
* [realtime\_support](https://github.com/ros2/realtime_support) ⭐ 79 | 🐛 7 | 🌐 C++ | 📅 2026-07-15 - Minimal real-time testing utility for measuring jitter and latency.
...
* [termshark](https://github.com/gcla/termshark) ⭐ 9,980 | 🐛 51 | 🌐 Go | 📅 2024-04-30 - A terminal UI for tshark, inspired by Wireshark.
* [iperf](https://github.com/esnet/iperf) ⭐ 8,726 | 🐛 233 | 🌐 C | 📅 2026-07-10 - A TCP, UDP, and SCTP network bandwidth measurement tool.
* [openwifi](https://github.com/open-sdr/openwifi) ⭐ 4,777 | 🐛 93 | 🌐 C | 📅 2026-08-25 - Linux mac80211 compatible full-stack IEEE802.11/Wi-Fi design based on Software Defined Radio.
* [nethogs](https://github.com/raboof/nethogs) ⭐ 3,688 | 🐛 104 | 🌐 C++ | 📅 2026-07-23 - It groups bandwidth by process.
* [pyshark](https://github.com/KimiNewt/pyshark) ⭐ 2,495 | 🐛 144 | 🌐 Python | 📅 2026-03-22 - Python wrapper for tshark, allowing python packet parsing using wireshark dissectors.
* [tcpreplay](https://github.com/appneta/tcpreplay) ⭐ 1,345 | 🐛 0 | 🌐 C | 📅 2026-08-15 - Pcap editing and replay tools.
* [wavemon](https://github.com/uoaerg/wavemon) ⭐ 1,230 | 🐛 6 | 🌐 C | 📅 2026-06-29 - An ncurses-based monitoring application for wireless network devices.
* [SOES](https://github.com/OpenEtherCATsociety/SOES) ⭐ 833 | 🐛 32 | 🌐 C | 📅 2025-04-08 - SOES is an EtherCAT slave stack written in C.
* [ptpd](https://github.com/ptpd/ptpd) ⭐ 576 | 🐛 77 | 🌐 C | 📅 2022-09-05 - PTP daemon (PTPd) is an implementation the Precision Time Protocol (PTP) version 2 as defined by 'IEEE Std 1588-2008'. PTP provides precise time coordination of Ethernet LAN connected computers.
...
* [awesome CAN](https://github.com/iDoka/awesome-canbus) ⭐ 3,437 | 🐛 6 | 📅 2026-08-07 -  A curated list of awesome CAN bus tools, hardware and resources.
* [opendbc](https://github.com/commaai/opendbc) ⭐ 3,379 | 🐛 345 | 🌐 Python | 📅 2026-08-30 - The project to democratize access to the decoder ring of your car.
* [can-utils](https://github.com/linux-can/can-utils) ⭐ 2,910 | 🐛 63 | 🌐 C | 📅 2026-05-12 - Linux-CAN / SocketCAN user space applications.
* [cantools](https://github.com/eerimoq/cantools) ⭐ 2,280 | 🐛 129 | 🌐 Python | 📅 2026-08-28 - CAN BUS tools in Python 3.
* [AndrOBD](https://github.com/fr3ts0n/AndrOBD) ⭐ 2,079 | 🐛 71 | 🌐 Java | 📅 2026-08-27 - Android OBD diagnostics with any ELM327 adapter.
* [CANopenNode](https://github.com/CANopenNode/CANopenNode) ⭐ 1,989 | 🐛 114 | 🌐 C | 📅 2026-07-10 - The internationally standardized (EN 50325-4) (CiA301) CAN-based higher-layer protocol for embedded control system.
* [ddt4all](https://github.com/cedricp/ddt4all) ⭐ 1,825 | 🐛 0 | 🌐 Python | 📅 2026-08-23 - DDT4All is a tool to create your own ECU parameters screens and connect to a CAN network with a cheap ELM327 interface.
* [SavvyCAN](https://github.com/collin80/SavvyCAN) ⭐ 1,803 | 🐛 283 | 🌐 C++ | 📅 2026-05-15 - A Qt5 based cross platform tool which can be used to load, save, and capture canbus frames.
* [python-can](https://github.com/hardbyte/python-can) ⭐ 1,587 | 🐛 273 | 🌐 Python | 📅 2026-07-01 - The can package provides controller area network support for Python developers.
* [CANdevStudio](https://github.com/GENIVI/CANdevStudio) ⭐ 1,140 | 🐛 37 | 🌐 C++ | 📅 2025-07-21 -  CANdevStudio aims to be cost-effective replacement for CAN simulation software. It can work with variety of CAN hardware interfaces.
...
* [Open-Vehicle-Monitoring-System-3](https://github.com/openvehicles/Open-Vehicle-Monitoring-System-3) ⭐ 848 | 🐛 204 | 🌐 C | 📅 2026-08-30 - The system provides live monitoring of vehicle metrics like state of charge, temperatures, tyre pressures and diagnostic fault conditions.
* [uds-c](https://github.com/openxc/uds-c) ⭐ 823 | 🐛 6 | 🌐 C | 📅 2021-08-16 - Unified Diagnostics Service (UDS) and OBD-II (On Board Diagnostics for Vehicles) C Library.
...
* [canopen](https://github.com/christiansandberg/canopen) ⭐ 565 | 🐛 74 | 🌐 Python | 📅 2026-06-28 - A Python implementation of the CANopen standard. The aim of the project is to support the most common parts of the CiA 301 standard in a Pythonic interface.
* [autosar](https://github.com/cogu/autosar) ⭐ 501 | 🐛 3 | 🌐 Python | 📅 2026-08-24 - A set of python modules for working with AUTOSAR XML files.
...
* [Tesla-API](https://github.com/timdorr/tesla-api) ⭐ 2,063 | 🐛 23 | 🌐 Ruby | 📅 2026-03-04 - Provides functionality to monitor and control the Model S (and future Tesla vehicles) remotely.
...
* [ublox](https://github.com/KumarRobotics/ublox) ⭐ 534 | 🐛 121 | 🌐 C++ | 📅 2026-08-21 - Provides support for u-blox GPS receivers.
* [ouster\_example](https://github.com/ouster-lidar/ouster_example) ⭐ 523 | 🐛 77 | 🌐 C++ | 📅 2026-08-13 - Sample code for connecting to and configuring the OS1, reading and visualizing data, and interfacing with ROS.
...
* [novatel\_gps\_driver](https://github.com/swri-robotics/novatel_gps_driver) ⭐ 175 | 🐛 29 | 🌐 C++ | 📅 2026-08-30 - ROS driver for NovAtel GPS / GNSS receivers.
...
* [Vault](https://github.com/hashicorp/vault) ⭐ 36,193 | 🐛 1,433 | 🌐 Go | 📅 2026-08-28 - A tool for securely accessing secrets. A secret is anything that you want to tightly control access to, such as API keys, passwords, certificates, and more.
* [How-to-Secure-A-Linux-Server](https://github.com/imthenachoman/How-To-Secure-A-Linux-Server) ⭐ 30,919 | 🐛 36 | 📅 2026-07-13 - An evolving how-to guide for securing a Linux server.
* [fail2ban](https://github.com/fail2ban/fail2ban) ⭐ 18,512 | 🐛 271 | 🌐 Python | 📅 2026-08-26 - Daemon to ban hosts that cause multiple authentication errors.
* [lynis](https://github.com/CISOfy/lynis) ⭐ 16,261 | 🐛 219 | 🌐 Shell | 📅 2026-08-05 - Security auditing tool for Linux, macOS, and UNIX-based systems. Assists with compliance testing (HIPAA/ISO27001/PCI DSS) and system hardening.
* [OpenVPN](https://github.com/OpenVPN/openvpn) ⭐ 14,462 | 🐛 222 | 🌐 C | 📅 2026-08-31 - An open source VPN daemon.
...
* [Firejail](https://github.com/netblue30/firejail) ⭐ 7,620 | 🐛 523 | 🌐 C | 📅 2026-08-30 - A SUID sandbox program that reduces the risk of security breaches by restricting the running environment of untrusted applications using Linux namespaces, seccomp-bpf and Linux capabilities.
* [gopass](https://github.com/gopasspw/gopass) ⭐ 7,113 | 🐛 86 | 🌐 Go | 📅 2026-08-30 - A password manager for the command line written in Go.
* [vulscan](https://github.com/scipag/vulscan) ⭐ 3,781 | 🐛 7 | 🌐 Lua | 📅 2026-02-06 - Advanced vulnerability scanning with Nmap NSE.
* [OpenTitan](https://github.com/lowRISC/opentitan) ⭐ 3,616 | 🐛 2,018 | 🌐 SystemVerilog | 📅 2026-08-31 - Will make the silicon Root of Trust design and implementation more transparent, trustworthy, and secure for enterprises, platform providers, and chip manufacturers. OpenTitan is administered by lowRISC CIC as a collaborative project to produce high quality, open IP for instantiation as a full-featured product.
* [nmap-vulners](https://github.com/vulnersCom/nmap-vulners) ⭐ 3,418 | 🐛 0 | 🌐 Lua | 📅 2026-08-31 - NSE script based on Vulners.com API.
* [openfortivpn](https://github.com/adrienverge/openfortivpn) ⭐ 3,401 | 🐛 141 | 🌐 Perl | 📅 2026-08-24 - A client for PPP+SSL VPN tunnel services and compatible with Fortinet VPNs.
* [wolfssl](https://github.com/wolfSSL/wolfssl) ⭐ 2,925 | 🐛 232 | 🌐 C | 📅 2026-08-29 - A small, fast, portable implementation of TLS/SSL for embedded devices to the cloud.
* [brutespray](https://github.com/x90skysn3k/brutespray) ⭐ 2,529 | 🐛 11 | 🌐 Go | 📅 2026-08-31 - Automatically attempts default creds on found services.
...
* [hardening](https://github.com/konstruktoid/hardening) ⭐ 1,855 | 🐛 7 | 🌐 Shell | 📅 2026-08-31 - A quick way to make a Ubuntu server a bit more secure.
* [openscap](https://github.com/OpenSCAP/openscap) ⭐ 1,808 | 🐛 63 | 🌐 XSLT | 📅 2026-08-13 - The oscap program is a command line tool that allows users to load, scan, validate, edit, and export SCAP documents.
* [Security-Enhanced Linux](https://github.com/SELinuxProject/selinux) ⭐ 1,620 | 🐛 16 | 🌐 C | 📅 2026-08-28 - A Linux kernel security module that provides a mechanism for supporting access control security policies, including mandatory access controls (MAC).
* [Passbolt](https://github.com/passbolt/passbolt_docker) ⭐ 1,109 | 🐛 9 | 🌐 Ruby | 📅 2026-08-12 - Passbolt is a free and open source password manager that allows team members to store and share credentials securely.
...
* [waymo-open-dataset](https://github.com/waymo-research/waymo-open-dataset) ⭐ 3,403 | 🐛 463 | 🌐 Python | 📅 2026-01-08 - The Waymo Open Dataset is comprised of high-resolution sensor data collected by Waymo self-driving cars in a wide variety of conditions.
* [nuscenes-devkit](https://github.com/nutonomy/nuscenes-devkit) ⭐ 2,796 | 🐛 32 | 🌐 Python | 📅 2026-08-06 - The devkit of the nuScenes dataset.
* [Objectron](https://github.com/google-research-datasets/Objectron/) ⭐ 2,349 | 🐛 31 | 🌐 Jupyter Notebook | 📅 2026-03-06 - A collection of short, object-centric video clips, which are accompanied by AR session metadata that includes camera poses, sparse point-clouds and characterization of the planar surfaces in the surrounding environment.
...
* [racetrack-database](https://github.com/TUMFTM/racetrack-database) ⭐ 298 | 🐛 0 | 📅 2021-09-18 - Contains center lines (x- and y-coordinates), track widths and race lines for over 20 race tracks (mainly F1 and DTM) all over the world.
