...
* [discourse](https://github.com/discourse/discourse) ⭐ 47,816 | 🐛 243 | 🌐 Ruby | 📅 2026-09-10 - A platform for community discussion. Free, open, simple.
* [Gogs](https://github.com/gogs/gogs) ⭐ 47,801 | 🐛 1,010 | 🌐 Go | 📅 2026-09-06 - Build a simple, stable and extensible self-hosted Git service that can be setup in the most painless way.
* [mattermost](https://github.com/mattermost/mattermost-server) ⭐ 39,032 | 🐛 1,000 | 🌐 TypeScript | 📅 2026-09-10 - An open source, private cloud, Slack-alternative.
* [jitsi-meet](https://github.com/jitsi/jitsi-meet) ⭐ 29,898 | 🐛 145 | 🌐 TypeScript | 📅 2026-09-10 - Secure, Simple and Scalable Video Conferences that you use as a standalone app or embed in your web application.
...
* [Wekan](https://github.com/wekan/wekan) ⭐ 21,073 | 🐛 281 | 🌐 JavaScript | 📅 2026-09-10 - Meteor based Kanban Board.
* [openproject](https://github.com/opf/openproject) ⭐ 16,069 | 🐛 243 | 🌐 Ruby | 📅 2026-09-10 - The leading open source project management software.
...
* [Kanboard](https://github.com/kanboard/kanboard) ⭐ 9,858 | 🐛 164 | 🌐 PHP | 📅 2026-09-09 - Minimalistic Kanban Board.
* [Gitlab](https://github.com/sameersbn/docker-gitlab) ⭐ 8,109 | 🐛 572 | 🌐 Shell | 📅 2026-09-09 - Simple Selfhosted Gitlab Server with Docker.
...
* [Excalidraw](https://github.com/excalidraw/excalidraw) ⭐ 131,537 | 🐛 3,446 | 🌐 TypeScript | 📅 2026-09-10 - Virtual whiteboard for sketching hand-drawn like diagrams.
* [tesseract](https://github.com/tesseract-ocr/tesseract) ⭐ 76,420 | 🐛 484 | 🌐 C++ | 📅 2026-09-09 - Open Source OCR Engine.
* [Pandoc](https://github.com/jgm/pandoc) ⭐ 46,214 | 🐛 1,035 | 🌐 Haskell | 📅 2026-09-10 - Universal markup converter.
* [carbon](https://github.com/carbon-app/carbon) ⭐ 36,099 | 🐛 85 | 🌐 JavaScript | 📅 2026-02-10 - Share beautiful images of your source code.
* [OCRmyPDF](https://github.com/jbarlow83/OCRmyPDF) ⭐ 34,706 | 🐛 98 | 🌐 Python | 📅 2026-09-08 - Adds an OCR text layer to scanned PDF files, allowing them to be searched.
* [PlotNeuralNet](https://github.com/HarisIqbal88/PlotNeuralNet) ⭐ 24,966 | 🐛 89 | 🌐 TeX | 📅 2023-08-21 - Latex code for drawing neural networks for reports and presentation.
* [mkdocs](https://github.com/mkdocs/mkdocs/) ⭐ 22,428 | 🐛 189 | 🌐 Python | 📅 2025-10-20 - A fast, simple and downright gorgeous static site generator that's geared towards building project documentation.
* [overleaf](https://github.com/overleaf/overleaf) ⭐ 18,110 | 🐛 176 | 🌐 JavaScript | 📅 2026-07-10 - An open-source online real-time collaborative LaTeX editor.
* [asciinema](https://github.com/asciinema/asciinema) ⭐ 17,790 | 🐛 10 | 🌐 Rust | 📅 2026-08-14 - Lets you easily record terminal sessions and replay them in a terminal as well as in a web browser.
* [foam](https://github.com/foambubble/foam) ⭐ 17,390 | 🐛 31 | 🌐 TypeScript | 📅 2026-09-05 - Foam is a personal knowledge management and sharing system inspired by Roam Research, built on Visual Studio Code and GitHub.
* [Zotero](https://github.com/zotero/zotero) ⭐ 15,211 | 🐛 1,600 | 🌐 JavaScript | 📅 2026-09-09 - A free, easy-to-use tool to help you collect, organize, cite, and share your research sources.
...
* [Sphinx](https://github.com/sphinx-doc/sphinx/) ⭐ 8,005 | 🐛 1,430 | 🌐 Python | 📅 2026-09-07 - A tool that makes it easy to create intelligent and beautiful documentation for Python projects.
...
* [CodiMD](https://github.com/codimd/server) ⭐ 7,407 | 🐛 269 | 🌐 TypeScript | 📅 2026-09-09 - Open Source Online Real-time collaborate on team documentation in markdown.
* [buku](https://github.com/jarun/buku) ⭐ 7,196 | 🐛 4 | 🌐 Python | 📅 2026-09-09 - Browser-independent bookmark manager.
* [Doxygen](https://github.com/doxygen/doxygen) ⭐ 6,578 | 🐛 1,869 | 🌐 C++ | 📅 2026-09-09 - Doxygen is the de facto standard tool for generating documentation from annotated C++ sources.
...
* [Markor](https://github.com/gsantner/markor) ⭐ 6,106 | 🐛 192 | 🌐 Java | 📅 2026-08-25 - A Simple Markdown Editor for your Android Device.
...
* [fossology](https://github.com/fossology/fossology) ⭐ 1,025 | 🐛 293 | 🌐 HTML | 📅 2026-09-04 - A toolkit you can run license, copyright and export control scans from the command line.
...
* [Architecture\_Decision\_Record](https://github.com/joelparkerhenderson/architecture_decision_record) ⭐ 16,875 | 🐛 11 | 🌐 JavaScript | 📅 2026-09-05 - A document that captures an important architectural decision made along with its context and consequences.
* [vscode-drawio](https://github.com/hediet/vscode-drawio) ⭐ 9,485 | 🐛 179 | 🌐 TypeScript | 📅 2026-09-09 - This extension integrates Draw\.io into VS Code.
...
* [OpenPilot](https://github.com/commaai/openpilot) ⭐ 63,625 | 🐛 146 | 🌐 Python | 📅 2026-09-10 - Open Source Adaptive Cruise Control (ACC) and Lane Keeping Assist System (LKAS).
* [PythonRobotics](https://github.com/AtsushiSakai/PythonRobotics/) ⭐ 30,480 | 🐛 54 | 🌐 Python | 📅 2026-09-07 - This is a Python code collection of robotics algorithms, especially for autonomous navigation.
* [Apollo](https://github.com/ApolloAuto/apollo) ⭐ 26,825 | 🐛 1,047 | 🌐 C++ | 📅 2026-04-16 - High performance, flexible architecture which accelerates the development, testing, and deployment of Autonomous Vehicles.
* [ArduPilot](https://github.com/ArduPilot/ardupilot) ⭐ 15,836 | 🐛 3,177 | 🌐 C++ | 📅 2026-09-10 - Open source control software for autonomous vehicles - copters/planes/rovers/boats/submersibles.
* [PX4](https://github.com/PX4/Firmware) ⭐ 12,586 | 🐛 363 | 🌐 C++ | 📅 2026-09-10 - An open source flight control software for drones and other unmanned vehicles.
* [F Prime](https://github.com/nasa/fprime) ⭐ 11,731 | 🐛 461 | 🌐 C++ | 📅 2026-09-09 - A component-driven framework that enables rapid development and deployment of spaceflight and other embedded software applications.
* [open-source-rover](https://github.com/nasa-jpl/open-source-rover) ⭐ 9,632 | 🐛 14 | 🌐 HTML | 📅 2026-09-03 - A build-it-yourself, 6-wheel rover based on the rovers on Mars from JPL.
...
* [JdeRobot Academy](https://github.com/JdeRobot/RoboticsAcademy) ⭐ 491 | 🐛 50 | 🌐 Python | 📅 2026-09-10 - JdeRobot Academy is an open source collection of exercises to learn robotics in a practical way.
...
* [Visual Studio Code](https://github.com/Microsoft/vscode) ⭐ 191,540 | 🐛 20,772 | 🌐 TypeScript | 📅 2026-09-10 - Code editor for edit-build-debug cycle.
...
* [Gitpod](https://github.com/gitpod-io/gitpod) ⭐ 13,767 | 🐛 451 | 🌐 TypeScript | 📅 2026-09-07 - An open source developer platform that automates the provisioning of ready-to-code development environments.
* [TabNine](https://github.com/zxqfl/TabNine) ⚠️ Archived - The all-language autocompleter.
* [jedi](https://github.com/davidhalter/jedi) ⭐ 6,174 | 🐛 70 | 🌐 Python | 📅 2026-07-09 - Autocompletion and static analysis library for python.
...
* [pyenv](https://github.com/pyenv/pyenv) ⭐ 45,092 | 🐛 55 | 🌐 Shell | 📅 2026-09-08 - Simple Python version management.
...
* [aptly](https://github.com/aptly-dev/aptly) ⭐ 2,882 | 🐛 221 | 🌐 Go | 📅 2026-09-02 - Debian repository management tool.
* [qemu-user-static](https://github.com/multiarch/qemu-user-static) ⭐ 2,710 | 🐛 67 | 🌐 Shell | 📅 2024-06-25 - Enable an execution of different multi-architecture containers by QEMU and binfmt\_misc.
* [docker\_images](https://github.com/osrf/docker_images) ⭐ 750 | 🐛 39 | 🌐 Dockerfile | 📅 2026-09-09 - Official Docker images maintained by OSRF on ROS(2) and Gazebo.
...
* [superflore](https://github.com/ros-infrastructure/superflore) ⭐ 62 | 🐛 21 | 🌐 Python | 📅 2026-09-01 - An extended platform release manager for Robot Operating System.
...
* [googletest](https://github.com/google/googletest) ⭐ 39,509 | 🐛 505 | 🌐 C++ | 📅 2026-09-09 - Google's C++ test framework.
* [pytest](https://github.com/pytest-dev/pytest/) ⭐ 14,493 | 🐛 815 | 🌐 Python | 📅 2026-09-08 - The pytest framework makes it easy to write small tests, yet scales to support complex functional testing.
...
* [black](https://github.com/psf/black) ⭐ 41,841 | 🐛 310 | 🌐 Python | 📅 2026-09-04 - The uncompromising Python code formatter.
* [shellcheck](https://github.com/koalaman/shellcheck) ⭐ 40,015 | 🐛 1,139 | 🌐 Haskell | 📅 2026-08-04 - A static analysis tool for shell scripts.
* [pydantic](https://github.com/samuelcolvin/pydantic) ⭐ 28,754 | 🐛 574 | 🌐 Python | 📅 2026-09-10 - Data parsing and validation using Python type hints.
* [hadolint](https://github.com/hadolint/hadolint) ⭐ 12,396 | 🐛 206 | 🌐 Haskell | 📅 2026-08-24 - Dockerfile linter, validate inline bash, written in Haskell.
* [cppcheck](https://github.com/danmar/cppcheck) ⭐ 6,742 | 🐛 198 | 🌐 C++ | 📅 2026-09-09 - Static analysis of C/C++ code.
* [pylint](https://github.com/PyCQA/pylint/) ⭐ 5,722 | 🐛 1,084 | 🌐 Python | 📅 2026-09-08 - Pylint is a Python static code analysis tool which looks for programming errors, helps enforcing a coding standard, sniffs for code smells and offers simple refactoring suggestions.
...
* [bcc](https://github.com/iovisor/bcc) ⭐ 22,656 | 🐛 1,077 | 🌐 C | 📅 2026-08-27 - Tools for BPF-based Linux IO analysis, networking, monitoring, and more.
* [FlameGraph](https://github.com/brendangregg/FlameGraph) ⭐ 19,739 | 🐛 173 | 🌐 Perl | 📅 2024-10-20 - Visualize profiled code.
* [tracy](https://github.com/wolfpld/tracy) ⭐ 16,745 | 🐛 166 | 🌐 C++ | 📅 2026-09-10 - A real time, nanosecond resolution, remote telemetry frame profiler for games and other applications.
...
* [bpftrace](https://github.com/iovisor/bpftrace) ⭐ 10,317 | 🐛 255 | 🌐 C++ | 📅 2026-09-10 - High-level tracing language for Linux eBPF.
...
* [cppinsights](https://github.com/andreasfertig/cppinsights) ⭐ 4,523 | 🐛 25 | 🌐 C++ | 📅 2026-08-26 - C++ Insights - See your source code with the eyes of a compiler.
* [backward-cpp](https://github.com/bombela/backward-cpp) ⭐ 4,301 | 🐛 126 | 🌐 C++ | 📅 2025-04-14 - A beautiful stack trace pretty printer for C++.
* [heaptrack](https://github.com/KDE/heaptrack) ⭐ 4,161 | 🐛 5 | 🌐 C++ | 📅 2026-09-07 - Traces all memory allocations and annotates these events with stack traces.
...
* [gdb-frontend](https://github.com/rohanrhu/gdb-frontend) ⭐ 3,026 | 🐛 16 | 🌐 JavaScript | 📅 2025-11-12 - GDBFrontend is an easy, flexible and extensionable gui debugger.
...
* [lazygit](https://github.com/jesseduffield/lazygit) ⭐ 82,191 | 🐛 1,032 | 🌐 Go | 📅 2026-09-09 - A simple terminal UI for git commands, written in Go with the gocui library.
* [dive](https://github.com/wagoodman/dive) ⭐ 54,550 | 🐛 213 | 🌐 Go | 📅 2025-12-15 - A tool for exploring each layer in a docker image.
* [learnGitBranching](https://github.com/pcottle/learnGitBranching) ⭐ 34,017 | 🐛 60 | 🌐 JavaScript | 📅 2026-09-10 - A git repository visualizer, sandbox, and a series of educational tutorials and challenges.
...
* [meld](https://github.com/GNOME/meld) ⭐ 1,311 | 🐛 0 | 🌐 Python | 📅 2026-09-09 - Meld is a visual diff and merge tool that helps you compare files, directories, and version controlled projects.
...
* [AirSim](https://github.com/microsoft/AirSim) ⭐ 18,466 | 🐛 780 | 🌐 C++ | 📅 2026-06-30 - Open source simulator for autonomous vehicles built on Unreal Engine.
* [carla](https://github.com/carla-simulator/carla) ⭐ 14,381 | 🐛 1,197 | 🌐 C++ | 📅 2026-09-10 - Open-source simulator for autonomous driving research.
* [Webots](https://github.com/cyberbotics/webots) ⭐ 4,609 | 🐛 229 | 🌐 C++ | 📅 2026-09-10 - Webots is an open source robot simulator compatible (among others) with [ROS](http://wiki.ros.org/webots_ros) and [ROS2](http://wiki.ros.org/webots_ros2).
* [Drake](https://github.com/RobotLocomotion/drake) ⭐ 4,185 | 🐛 661 | 🌐 C++ | 📅 2026-09-10 - Drake aims to simulate even very complex dynamics of robots.
* [sumo](https://github.com/eclipse/sumo) ⭐ 4,173 | 🐛 2,973 | 🌐 Python | 📅 2026-09-09 - Eclipse SUMO is an open source, highly portable, microscopic and continuous road traffic simulation package designed to handle large road networks.
...
* [gym-pybullet-drones](https://github.com/utiasDSL/gym-pybullet-drones) ⭐ 2,126 | 🐛 110 | 🌐 Python | 📅 2026-09-06 - PyBullet-based Gym environments for single and multi-agent reinforcement learning of quadcopter control.
...
* [flightmare](https://github.com/uzh-rpg/flightmare) ⭐ 1,415 | 🐛 128 | 🌐 C++ | 📅 2024-06-14 - Flightmare is composed of two main components: a configurable rendering engine built on Unity and a flexible physics engine for dynamics simulation.
...
* [esmini](https://github.com/esmini/esmini) ⭐ 942 | 🐛 219 | 🌐 C++ | 📅 2026-09-10 -  A basic OpenSCENARIO player.
...
* [ESIM](https://github.com/uzh-rpg/rpg_esim/) ⭐ 730 | 🐛 83 | 🌐 C | 📅 2023-12-25 - An Open Event Camera Simulator.
* [scenario\_runner](https://github.com/carla-simulator/scenario_runner) ⭐ 681 | 🐛 179 | 🌐 Python | 📅 2026-09-02 - Traffic scenario definition and execution engine.
...
* [42](https://github.com/ericstoneking/42) ⭐ 452 | 🐛 27 | 🌐 C | 📅 2026-08-13 - Simulation for spacecraft attitude control system analysis and design.
* [open-simulation-interface](https://github.com/OpenSimulationInterface/open-simulation-interface) ⭐ 302 | 🐛 185 | 🌐 Python | 📅 2026-09-10 - A generic interface for the environmental perception of automated driving functions in virtual scenarios.
...
* [Trick](https://github.com/nasa/Trick) ⭐ 166 | 🐛 118 | 🌐 C++ | 📅 2026-09-10 - Developed at the NASA Johnson Space Center, is a powerful simulation development framework that enables users to build applications for all phases of space vehicle development.
...
* [FreeCAD](https://github.com/FreeCAD/FreeCAD) ⭐ 33,404 | 🐛 4,111 | 🌐 C++ | 📅 2026-09-10 - Your own 3D parametric modeler.
* [openscad](https://github.com/openscad/openscad) ⭐ 10,179 | 🐛 829 | 🌐 C++ | 📅 2026-09-09 -  A software for creating solid 3D CAD models.
...
* [NASA-3D-Resources](https://github.com/nasa/NASA-3D-Resources) ⭐ 3,778 | 🐛 4 | 📅 2025-06-03 - Here you'll find a growing collection of 3D models, textures, and images from inside NASA.
* [ODrive](https://github.com/madcowswe/ODrive) ⭐ 3,762 | 🐛 19 | 🌐 C++ | 📅 2026-01-20 - The aim is to make it possible to use inexpensive brushless motors in high performance robotics projects.
* [LibrePCB](https://github.com/LibrePCB/LibrePCB) ⭐ 2,981 | 🐛 220 | 🌐 C++ | 📅 2026-09-07 - A powerful, innovative and intuitive EDA tool for everyone.
* [GNSS-SDR](https://github.com/gnss-sdr/gnss-sdr) ⭐ 2,230 | 🐛 238 | 🌐 C++ | 📅 2026-09-09 - GNSS-SDR provides interfaces for a wide range of radio frequency front-ends and raw sample file formats, generates processing outputs in standard formats.
* [pvlib-python](https://github.com/pvlib/pvlib-python) ⭐ 1,660 | 🐛 246 | 🌐 Python | 📅 2026-09-08 - A community supported tool that provides a set of functions and classes for simulating the performance of photovoltaic energy systems.
...
* [Horizon](https://github.com/horizon-eda/horizon) ⭐ 1,315 | 🐛 166 | 🌐 C | 📅 2026-09-09 - EDA is an Electronic Design Automation package supporting an integrated end-to-end workflow for printed circuit board design including parts management and schematic entry.
* [phobos](https://github.com/dfki-ric/phobos) ⭐ 902 | 🐛 14 | 🌐 Python | 📅 2026-07-14 - An add-on for Blender allowing to create URDF, SDF and SMURF robot models in a WYSIWYG environment.
...
* [OpenMDAO](https://github.com/OpenMDAO/OpenMDAO) ⭐ 779 | 🐛 72 | 🌐 Python | 📅 2026-09-09 - An open-source framework for efficient multidisciplinary optimization.
...
* [oemof-solph](https://github.com/oemof/oemof-solph) ⭐ 418 | 🐛 117 | 🌐 Python | 📅 2026-09-10 - A modular open source framework to model energy supply systems.
...
* [tigl](https://github.com/DLR-SC/tigl) ⭐ 301 | 🐛 131 | 🌐 C++ | 📅 2026-09-10 - The TiGL Geometry Library can be used for the computation and processing of aircraft geometries stored inside CPACS files.
...
* [kalibr](https://github.com/ethz-asl/kalibr) ⭐ 5,710 | 🐛 135 | 🌐 C++ | 📅 2024-03-30 - The Kalibr visual-inertial calibration toolbox.
...
* [robot\_calibration](https://github.com/mikeferguson/robot_calibration/) ⭐ 491 | 🐛 7 | 🌐 C++ | 📅 2026-08-10 - This package offers calibration of a number of parameters of a robot, such as: 3D Camera intrinsics, extrinsics Joint angle offsets and robot frame offsets.
...
* [ray](https://github.com/ray-project/ray) ⭐ 43,764 | 🐛 3,573 | 🌐 Python | 📅 2026-09-10 - A fast and simple framework for building and running distributed applications.
* [gym](https://github.com/openai/gym) ⚠️ Archived - A toolkit for developing and comparing reinforcement learning algorithms.
* [Netron](https://github.com/lutzroeder/Netron) ⭐ 33,458 | 🐛 18 | 🌐 JavaScript | 📅 2026-09-09 - Visualizer for neural network, deep learning and machine learning models.
...
* [mlflow](https://github.com/mlflow/mlflow) ⭐ 27,898 | 🐛 2,081 | 🌐 Python | 📅 2026-09-10 - A platform to streamline machine learning development, including tracking experiments, packaging code into reproducible runs, and sharing and deploying models.
* [MNN](https://github.com/alibaba/MNN) ⭐ 16,054 | 🐛 62 | 🌐 C++ | 📅 2026-09-09 - A blazing fast, lightweight deep learning framework, battle-tested by business-critical use cases in Alibaba.
...
* [Tensorflow Federated](https://github.com/tensorflow/federated) ⭐ 2,451 | 🐛 291 | 🌐 Python | 📅 2026-09-09 - TensorFlow Federated (TFF) is an open-source framework for machine learning and other computations on decentralized data.
* [finn](https://github.com/Xilinx/finn) ⭐ 1,059 | 🐛 115 | 🌐 Python | 📅 2026-09-06 - Fast, Scalable Quantized Neural Network Inference on FPGAs.
...
* [dask](https://github.com/dask/dask) ⭐ 13,913 | 🐛 1,329 | 🌐 Python | 📅 2026-08-24 - Parallel computing with task scheduling for Python.
* [TensorRT](https://github.com/NVIDIA/TensorRT) ⭐ 13,332 | 🐛 634 | 🌐 C++ | 📅 2026-08-25 - A C++ library for high performance inference on NVIDIA GPUs and deep learning accelerators.
* [cupy](https://github.com/cupy/cupy) ⭐ 12,312 | 🐛 697 | 🌐 Python | 📅 2026-09-10 - NumPy-like API accelerated with CUDA.
* [numba](https://github.com/numba/numba) ⭐ 11,150 | 🐛 1,789 | 🌐 Python | 📅 2026-09-09 - NumPy aware dynamic Python compiler using LLVM.
* [Thrust](https://github.com/thrust/thrust) ⚠️ Archived - A C++ parallel programming library which resembles the C++ Standard Library.
* [ArrayFire](https://github.com/arrayfire/arrayfire) ⭐ 4,902 | 🐛 318 | 🌐 C++ | 📅 2026-03-07 - A general purpose GPU library.
* [PYNQ](https://github.com/Xilinx/PYNQ) ⭐ 2,348 | 🐛 43 | 🌐 Jupyter Notebook | 📅 2026-09-07 - An open-source project from Xilinx that makes it easy to design embedded systems with Zynq All Programmable Systems on Chips.
...
* [detectron2](https://github.com/facebookresearch/detectron2) ⭐ 34,706 | 🐛 590 | 🌐 Python | 📅 2026-08-19 - A next-generation research platform for object detection and segmentation.
...
* [meshroom](https://github.com/alicevision/meshroom) ⭐ 12,951 | 🐛 518 | 🌐 Python | 📅 2026-09-09 - Meshroom is a free, open-source 3D Reconstruction Software based on the AliceVision Photogrammetric Computer Vision framework.
* [libvips](https://github.com/libvips/libvips) ⭐ 11,632 | 🐛 81 | 🌐 C | 📅 2026-09-06 - A fast image processing library with low memory needs.
* [satellite-image-deep-learning](https://github.com/robmarkcole/satellite-image-deep-learning) ⭐ 10,247 | 🐛 0 | 📅 2026-09-04 - Resources for deep learning with satellite & aerial imagery.
* [fawkes](https://github.com/Shawn-Shan/fawkes) ⭐ 5,601 | 🐛 43 | 🌐 Python | 📅 2023-08-02 - Privacy preserving tool against facial recognition systems.
...
* [AliceVision](https://github.com/alicevision/AliceVision) ⭐ 3,491 | 🐛 37 | 🌐 C++ | 📅 2026-09-08 - A Photogrammetric Computer Vision Framework which provides a 3D Reconstruction and Camera Tracking algorithms.
...
* [Simd](https://github.com/ermig1979/Simd) ⭐ 2,268 | 🐛 26 | 🌐 C++ | 📅 2026-09-10 - C++ image processing and machine learning library with using of SIMD: SSE, SSE2, SSE3, SSSE3, SSE4.1, SSE4.2, AVX, AVX2, AVX-512, VMX(Altivec) and VSX(Power7), NEON for ARM.
...
* [satpy](https://github.com/pytroll/satpy) ⭐ 1,205 | 🐛 563 | 🌐 Python | 📅 2026-09-09 - A python library for reading and manipulating meteorological remote sensing data and writing it to various image and data file formats.
* [deep\_object\_pose](https://github.com/NVlabs/Deep_Object_Pose) ⭐ 1,180 | 🐛 87 | 🌐 Python | 📅 2025-08-06 - Deep Object Pose Estimation.
...
* [image\_pipeline](https://github.com/ros-perception/image_pipeline) ⭐ 963 | 🐛 57 | 🌐 C++ | 📅 2026-08-27 - Fills the gap between getting raw images from a camera driver and higher-level vision processing.
...
* [3d-vehicle-tracking](https://github.com/ucbdrive/3d-vehicle-tracking) ⭐ 685 | 🐛 10 | 🌐 Python | 📅 2022-12-03 - Official implementation of Joint Monocular 3D Vehicle Detection and Tracking.
...
* [open3d](https://github.com/intel-isl/Open3D) ⭐ 13,949 | 🐛 1,313 | 🌐 C++ | 📅 2026-09-09 - Open3D: A Modern Library for 3D Data Processing.
* [Draco](https://github.com/google/draco) ⭐ 7,473 | 🐛 180 | 🌐 C++ | 📅 2026-08-18 - A library for compressing and decompressing 3D geometric meshes and point clouds.
...
* [PCDet](https://github.com/sshaoshuai/PCDet) ⭐ 5,701 | 🐛 31 | 🌐 Python | 📅 2025-10-08 - A general PyTorch-based codebase for 3D object detection from point cloud.
* [OpenPCDet](https://github.com/open-mmlab/OpenPCDet) ⭐ 5,701 | 🐛 31 | 🌐 Python | 📅 2025-10-08 - A Toolbox for LiDAR-based 3D Object Detection.
...
* [grid\_map](https://github.com/ANYbotics/grid_map) ⭐ 3,236 | 🐛 168 | 🌐 C++ | 📅 2026-01-13 - Universal grid map library for mobile robotic mapping.
* [octomap](https://github.com/OctoMap/octomap) ⭐ 2,370 | 🐛 44 | 🌐 C++ | 📅 2026-08-02 - An Efficient Probabilistic 3D Mapping Framework Based on Octrees.
* [KISS-ICP](https://github.com/PRBonn/kiss-icp) ⭐ 2,313 | 🐛 18 | 🌐 C++ | 📅 2026-06-09 - A LiDAR Odometry pipeline that just works on most of the cases without tunning any parameter.
* [python-pcl](https://github.com/strawlab/python-pcl) ⚠️ Archived - Python bindings to the pointcloud library.
* [elevation\_mapping](https://github.com/ANYbotics/elevation_mapping) ⭐ 1,863 | 🐛 101 | 🌐 C++ | 📅 2024-11-04 - Robot-centric elevation mapping for rough terrain navigation.
...
* [PDAL](https://github.com/PDAL/PDAL) ⭐ 1,409 | 🐛 135 | 🌐 C++ | 📅 2026-09-10 - A C++ BSD library for translating and manipulating point cloud data.
...
* [Cupoch](https://github.com/neka-nat/cupoch) ⭐ 1,064 | 🐛 25 | 🌐 C++ | 📅 2026-06-25 -  A library that implements rapid 3D data processing and robotics computation using CUDA.
...
* [Kalman-and-Bayesian-Filters-in-Python](https://github.com/rlabbe/Kalman-and-Bayesian-Filters-in-Python) ⭐ 19,289 | 🐛 144 | 🌐 Jupyter Notebook | 📅 2024-08-07 - Kalman Filter book using Jupyter Notebook.
...
* [robot\_localization](https://github.com/cra-ros-pkg/robot_localization) ⭐ 1,955 | 🐛 92 | 🌐 C++ | 📅 2026-07-16 - A package of nonlinear state estimation nodes.
...
* [ai-imu-dr](https://github.com/mbrossar/ai-imu-dr) ⭐ 1,002 | 🐛 39 | 🌐 Python | 📅 2025-01-08 - Contains the code of our novel accurate method for dead reckoning of wheeled vehicles based only on an IMU.
...
* [LIO\_SAM](https://github.com/TixiaoShan/LIO-SAM) ⭐ 4,910 | 🐛 183 | 🌐 C++ | 📅 2025-02-14 - Tightly-coupled Lidar Inertial Odometry via Smoothing and Mapping.
* [pyslam](https://github.com/luigifreda/pyslam) ⭐ 3,406 | 🐛 1 | 🌐 Python | 📅 2026-08-23 - Contains a monocular Visual Odometry (VO) pipeline in Python.
...
* [ORB\_SLAM3](https://github.com/UZ-SLAMLab/ORB_SLAM3) ⭐ 9,054 | 🐛 571 | 🌐 C++ | 📅 2024-07-24 - ORB-SLAM3: An Accurate Open-Source Library for Visual, Visual-Inertial and Multi-Map SLAM.
* [VINS-Fusion](https://github.com/HKUST-Aerial-Robotics/VINS-Fusion) ⭐ 4,703 | 🐛 212 | 🌐 C++ | 📅 2024-05-23 - A Robust and Versatile Multi-Sensor Visual-Inertial State Estimator.
...
* [open\_vins](https://github.com/rpng/open_vins) ⭐ 3,091 | 🐛 75 | 🌐 C++ | 📅 2025-11-30 - An open source platform for visual-inertial navigation research.
...
* [Mapbox](https://github.com/mapbox/mapbox-gl-js) ⭐ 12,405 | 🐛 1,457 | 🌐 TypeScript | 📅 2026-09-10 - A JavaScript library for interactive, customizable vector maps on the web.
* [osrm-backend](https://github.com/Project-OSRM/osrm-backend) ⭐ 8,056 | 🐛 357 | 🌐 C++ | 📅 2026-09-10 - Open Source Routing Machine - C++ backend.
* [gdal](https://github.com/OSGeo/gdal) ⭐ 6,052 | 🐛 570 | 🌐 C++ | 📅 2026-09-09 - GDAL is an open source X/MIT licensed translator library for raster and vector geospatial data formats.
...
* [iD](https://github.com/openstreetmap/iD) ⭐ 3,871 | 🐛 989 | 🌐 JavaScript | 📅 2026-09-10 - The easy-to-use OpenStreetMap editor in JavaScript.
* [MapsModelsImporter](https://github.com/eliemichel/MapsModelsImporter) ⭐ 2,814 | 🐛 132 | 🌐 Python | 📅 2024-04-21 - A Blender add-on to import models from google maps.
* [3d-tiles](https://github.com/CesiumGS/3d-tiles) ⭐ 2,600 | 🐛 96 | 🌐 Batchfile | 📅 2026-09-08 - Specification for streaming massive heterogeneous 3D geospatial datasets.
* [grass](https://github.com/OSGeo/grass) ⭐ 1,162 | 🐛 702 | 🌐 C | 📅 2026-09-10 - GRASS GIS - free and open source Geographic Information System (GIS).
...
* [mapillary\_tools](https://github.com/mapillary/mapillary_tools) ⭐ 314 | 🐛 34 | 🌐 Python | 📅 2026-08-04 - A library for processing and uploading images to Mapillary.
...
* [BehaviorTree.CPP](https://github.com/BehaviorTree/BehaviorTree.CPP) ⭐ 4,193 | 🐛 53 | 🌐 C++ | 📅 2026-08-31 - Behavior Trees Library in C++.
...
* [py\_trees\_ros](https://github.com/splintered-reality/py_trees_ros) ⭐ 228 | 🐛 19 | 🌐 Python | 📅 2026-07-16 - Behaviours, trees and utilities that extend py\_trees for use with ROS.
* [RAFCON](https://github.com/DLR-RM/RAFCON) ⭐ 212 | 🐛 9 | 🌐 Python | 📅 2026-08-11 - Uses hierarchical state machines, featuring concurrent state execution, to represent robot programs.
...
* [pinocchio](https://github.com/stack-of-tasks/pinocchio) ⭐ 3,725 | 🐛 102 | 🌐 C++ | 📅 2026-09-07 - A fast and flexible implementation of Rigid Body Dynamics algorithms and their analytical derivatives.
* [EGO-Planner](https://github.com/ZJU-FAST-Lab/ego-planner) ⭐ 2,649 | 🐛 40 | 🌐 C++ | 📅 2025-03-08 - A lightweight gradient-based local planner without ESDF construction, which significantly reduces computation time compared to some state-of-the-art methods.
* [casADi](https://github.com/casadi/casadi) ⭐ 2,288 | 🐛 730 | 🌐 C++ | 📅 2026-09-10 - A symbolic framework for numeric optimization implementing automatic differentiation in forward and reverse modes on sparse matrix-valued computational graphs.
* [ompl](https://github.com/ompl/ompl) ⭐ 2,142 | 🐛 103 | 🌐 C++ | 📅 2026-08-26 - Consists of many state-of-the-art sampling-based motion planning algorithms.
...
* [pykep](https://github.com/esa/pykep) ⭐ 422 | 🐛 2 | 🌐 C++ | 📅 2026-09-09 - A scientific library providing basic tools for research in interplanetary trajectory design.
...
* [autogenu-jupyter](https://github.com/mayataka/autogenu-jupyter) ⭐ 178 | 🐛 1 | 🌐 Python | 📅 2026-09-09 - This project provides the continuation/GMRES method (C/GMRES method) based solvers for nonlinear model predictive control (NMPC) and an automatic code generator for NMPC.
* [traffic-editor](https://github.com/osrf/traffic-editor) ⭐ 165 | 🐛 43 | 🌐 C++ | 📅 2026-09-09 - A graphical editor for robot traffic flows.
...
* [imgui](https://github.com/ocornut/imgui) ⭐ 76,139 | 🐛 1,227 | 🌐 C++ | 📅 2026-09-09 - Designed to enable fast iterations and to empower programmers to create content creation tools and visualization / debug tools.
...
* [elements](https://github.com/cycfi/elements) ⭐ 3,717 | 🐛 41 | 🌐 C++ | 📅 2026-09-10 - A lightweight, fine-grained, resolution independent, modular GUI library.
* [cage](https://github.com/Hjdskes/cage) ⭐ 2,051 | 🐛 124 | 🌐 C | 📅 2026-09-08 - This is Cage, a Wayland kiosk. A kiosk runs a single, maximized application.
...
* [mir](https://github.com/MirServer/mir) ⭐ 785 | 🐛 408 | 🌐 C++ | 📅 2026-09-10 - Mir is set of libraries for building Wayland based shells.
...
* [TTS](https://github.com/coqui-ai/TTS) ⭐ 45,997 | 🐛 2 | 🌐 Python | 📅 2024-08-16 - A deep learning toolkit for Text-to-Speech, battle-tested in research and production.
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 82,887 | 🐛 329 | 🌐 Go | 📅 2026-09-10 - A command-line fuzzy finder.
* [bat](https://github.com/sharkdp/bat) ⭐ 60,394 | 🐛 514 | 🌐 Rust | 📅 2026-09-04 - A cat(1) clone with wings.
* [ag](https://github.com/ggreer/the_silver_searcher) ⭐ 27,118 | 🐛 563 | 🌐 C | 📅 2024-06-16 - A code-searching tool similar to ack, but faster.
* [fx](https://github.com/antonmedv/fx) ⭐ 20,622 | 🐛 29 | 🌐 Go | 📅 2026-08-26 - Command-line tool and terminal JSON viewer.
* [gocui](https://github.com/jroimartin/gocui) ⭐ 10,603 | 🐛 60 | 🌐 Go | 📅 2025-05-01 - Minimalist Go package aimed at creating Console User Interfaces.
...
* [obs-studio](https://github.com/obsproject/obs-studio) ⭐ 76,019 | 🐛 1,152 | 🌐 C | 📅 2026-09-09 - Free and open source software for live streaming and screen recording.
* [bokeh](https://github.com/bokeh/bokeh) ⭐ 20,448 | 🐛 851 | 🌐 Python | 📅 2026-09-09 - Interactive Data Visualization in the browser, from Python.
* [plotly.py](https://github.com/plotly/plotly.py) ⭐ 18,773 | 🐛 702 | 🌐 Python | 📅 2026-09-09 - An open-source, interactive graphing library for Python.
* [openmct](https://github.com/nasa/openmct) ⭐ 13,112 | 🐛 1,089 | 🌐 JavaScript | 📅 2026-09-10 - A web based mission control framework.
* [kepler.gl](https://github.com/keplergl/kepler.gl) ⭐ 12,005 | 🐛 457 | 🌐 TypeScript | 📅 2026-09-10 - Kepler.gl is a powerful open source geospatial analysis tool for large-scale data sets.
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,173 | 🐛 163 | 🌐 C++ | 📅 2026-08-10 - The timeseries visualization tool that you deserve.
...
* [PyQtGraph](https://github.com/pyqtgraph/pyqtgraph) ⭐ 4,412 | 🐛 501 | 🌐 Python | 📅 2026-08-31 - Fast data visualization and GUI tools for scientific / engineering applications.
...
* [marvros](https://github.com/mavlink/mavros) ⭐ 1,221 | 🐛 400 | 🌐 C++ | 📅 2026-09-09 - MAVLink to ROS gateway with proxy for Ground Control Station.
...
* [label-studio](https://github.com/heartexlabs/label-studio) ⭐ 28,239 | 🐛 941 | 🌐 TypeScript | 📅 2026-09-10 - Label Studio is a multi-type data labeling and annotation tool with standardized output format.
...
* [cvat](https://github.com/opencv/cvat) ⭐ 16,673 | 🐛 591 | 🌐 Python | 📅 2026-09-10 - Powerful and efficient Computer Vision Annotation Tool (CVAT).
* [labelme](https://github.com/wkentaro/labelme) ⭐ 16,160 | 🐛 169 | 🌐 Python | 📅 2026-09-10 - Image Polygonal Annotation with Python (polygon, rectangle, circle, line, point and image-level flag annotation).
* [napari](https://github.com/napari/napari) ⭐ 2,758 | 🐛 1,246 | 🌐 Python | 📅 2026-09-07 -  A fast, interactive, multi-dimensional image viewer for python.
...
* [3d-bat](https://github.com/walzimmer/3d-bat) ⭐ 820 | 🐛 47 | 🌐 TypeScript | 📅 2024-03-07 - 3D Bounding Box Annotation Tool for Point cloud and Image Labeling.
...
* [Potree](https://github.com/potree/potree) ⭐ 5,602 | 🐛 822 | 🌐 JavaScript | 📅 2026-01-08 - WebGL point cloud viewer for large datasets.
* [CloudCompare](https://github.com/CloudCompare/CloudCompare) ⭐ 4,736 | 🐛 287 | 🌐 C++ | 📅 2026-09-10 - CloudCompare is a 3D point cloud (and triangular mesh) processing software.
...
* [rviz\_visual\_tools](https://github.com/PickNikRobotics/rviz_visual_tools) ⭐ 818 | 🐛 33 | 🌐 C++ | 📅 2026-09-08 - C++ API wrapper for displaying shapes and meshes in Rviz.
...
* [nvtop](https://github.com/Syllo/nvtop) ⭐ 10,982 | 🐛 142 | 🌐 C | 📅 2026-09-07 - NVIDIA GPUs htop like monitoring tool.
* [ntop](https://github.com/ntop/ntopng) ⭐ 8,149 | 🐛 301 | 🌐 Lua | 📅 2026-09-10 - Web-based Traffic and Security Network Traffic Monitoring.
...
* [Sshwifty](https://github.com/nirui/sshwifty) ⭐ 3,119 | 🐛 40 | 🌐 JavaScript | 📅 2026-09-03 - Sshwifty is a SSH and Telnet connector made for the Web.
* [gputil](https://github.com/anderskm/gputil) ⭐ 1,213 | 🐛 31 | 🌐 Python | 📅 2026-07-18 - A Python module for getting the GPU status from NVIDA GPUs using nvidia-smi programmically in Python.
* [atop](https://github.com/Atoptool/atop) ⭐ 1,061 | 🐛 63 | 🌐 C | 📅 2026-08-15 - System and process monitor for Linux with logging and replay function.
...
* [syncthing](https://github.com/syncthing/syncthing) ⭐ 88,443 | 🐛 382 | 🌐 Go | 📅 2026-09-08 - A continuous file synchronization program.
* [DuckDB](https://github.com/cwida/duckdb) ⭐ 41,117 | 🐛 859 | 🌐 C++ | 📅 2026-09-10 - An embeddable SQL OLAP Database Management System.
* [nextcloud](https://github.com/nextcloud/server) ⭐ 36,765 | 🐛 3,652 | 🌐 PHP | 📅 2026-09-10 - Nextcloud is a suite of client-server software for creating and using file hosting services.
* [borg](https://github.com/borgbackup/borg) ⭐ 13,702 | 🐛 211 | 🌐 Python | 📅 2026-09-10 - Deduplicating archiver with compression and authenticated encryption.
...
* [ceph](https://github.com/ceph/ceph) ⭐ 17,021 | 🐛 1,354 | 🌐 C++ | 📅 2026-09-10 - A distributed object, block, and file storage platform.
* [moosefs](https://github.com/moosefs/moosefs) ⭐ 2,000 | 🐛 191 | 🌐 C | 📅 2026-05-18 -  A scalable distributed storage system.
...
* [ansible](https://github.com/ansible/ansible) ⭐ 70,626 | 🐛 832 | 🌐 Python | 📅 2026-09-09 - Ansible is a radically simple IT automation platform that makes your applications and systems easier to deploy.
...
* [traefik](https://github.com/containous/traefik) ⭐ 64,801 | 🐛 922 | 🌐 Go | 📅 2026-09-10 - The Cloud Native Edge Router.
* [Portainer](https://github.com/portainer/portainer) ⭐ 38,477 | 🐛 751 | 🌐 TypeScript | 📅 2026-09-07 - Making Docker management easy.
...
* [kubeflow](https://github.com/kubeflow/kubeflow) ⭐ 15,857 | 🐛 0 | 📅 2026-08-21 - Machine Learning Toolkit for Kubernetes.
* [noVNC](https://github.com/novnc/noVNC) ⭐ 14,004 | 🐛 107 | 🌐 JavaScript | 📅 2026-09-07 - VNC client using HTML5.
* [triton-inference-server](https://github.com/NVIDIA/triton-inference-server) ⭐ 10,978 | 🐛 894 | 🌐 Python | 📅 2026-09-10 - NVIDIA Triton Inference Server provides a cloud inferencing solution optimized for NVIDIA GPUs.
* [cudf](https://github.com/rapidsai/cudf) ⭐ 9,749 | 🐛 1,342 | 🌐 C++ | 📅 2026-09-10 - Provides a pandas-like API that will be familiar to data engineers & data scientists, so they can use it to easily accelerate their workflows without going into the details of CUDA programming.
* [jupyterhub](https://github.com/jupyterhub/jupyterhub) ⭐ 8,332 | 🐛 198 | 🌐 Python | 📅 2026-09-09 - Multi-user server for Jupyter notebooks.
* [graylog2-server](https://github.com/Graylog2/graylog2-server) ⭐ 8,126 | 🐛 2,073 | 🌐 Java | 📅 2026-09-10 - Free and open source log management.
* [docker-py](https://github.com/docker/docker-py) ⭐ 7,211 | 🐛 569 | 🌐 Python | 📅 2026-09-07 - A Python library for the Docker Engine API.
* [pyinfra](https://github.com/Fizzadar/pyinfra) ⭐ 5,983 | 🐛 188 | 🌐 Python | 📅 2026-09-10 - It can be used for ad-hoc command execution, service deployment, configuration management and more.
* [Slurm](https://github.com/SchedMD/slurm) ⭐ 4,340 | 🐛 17 | 🌐 C | 📅 2026-09-10 - Slurm: A Highly Scalable Workload Manager.
...
* [mass](https://github.com/maas/maas) ⭐ 498 | 🐛 31 | 🌐 Python | 📅 2026-09-10 - Self-service, remote installation of Windows, CentOS, ESXi and Ubuntu on real servers turns your data centre into a bare metal cloud.
...
* [jetson\_stats](https://github.com/rbonghi/jetson_stats) ⭐ 2,620 | 🐛 54 | 🌐 Python | 📅 2026-09-08 - A package to monitoring and control your NVIDIA Jetson (Xavier NX, Nano, AGX Xavier, TX1, TX2) Works with all NVIDIA Jetson ecosystem.
* [Jailhouse](https://github.com/siemens/jailhouse) ⭐ 1,962 | 🐛 0 | 🌐 C | 📅 2024-05-18 - Jailhouse is a partitioning Hypervisor based on Linux.
* [fusesoc](https://github.com/olofk/fusesoc) ⭐ 1,456 | 🐛 150 | 🌐 Python | 📅 2026-09-08 - Package manager and build abstraction tool for FPGA/ASIC development.
...
* [meta-balena](https://github.com/balena-os/meta-balena) ⭐ 989 | 🐛 137 | 🌐 BitBake | 📅 2026-09-09 - Run Docker containers on embedded devices.
...
* [meta-ros](https://github.com/ros/meta-ros/tree/thud-draft) ⭐ 486 | 🐛 91 | 🌐 BitBake | 📅 2026-09-09 - OpenEmbedded Layer for ROS Applications.
...
* [protobuf](https://github.com/protocolbuffers/protobuf) ⭐ 72,013 | 🐛 326 | 🌐 C++ | 📅 2026-09-10 - Google's data interchange format.
* [Fast-RTPS](https://github.com/eProsima/Fast-RTPS) ⭐ 2,896 | 🐛 139 | 🌐 C++ | 📅 2026-09-10 - A Protocol, which provides publisher-subscriber communications over unreliable transports such as UDP, as defined and maintained by the Object Management Group (OMG) consortium.
* [iceoryx](https://github.com/eclipse/iceoryx) ⭐ 2,182 | 🐛 259 | 🌐 C++ | 📅 2026-08-18 - An IPC middleware for POSIX-based systems.
* [cyclonedds](https://github.com/eclipse-cyclonedds/cyclonedds) ⭐ 1,337 | 🐛 309 | 🌐 C | 📅 2026-09-08 - Eclipse Cyclone DDS is a very performant and robust open-source DDS implementation.
* [rosbridge\_suite](https://github.com/RobotWebTools/rosbridge_suite) ⭐ 1,240 | 🐛 32 | 🌐 Python | 📅 2026-08-17 - Provides a JSON interface to ROS, allowing any client to send JSON to publish or subscribe to ROS topics, call ROS services, and more.
...
* [termshark](https://github.com/gcla/termshark) ⭐ 10,007 | 🐛 51 | 🌐 Go | 📅 2024-04-30 - A terminal UI for tshark, inspired by Wireshark.
* [iperf](https://github.com/esnet/iperf) ⭐ 8,744 | 🐛 236 | 🌐 C | 📅 2026-07-10 - A TCP, UDP, and SCTP network bandwidth measurement tool.
* [openwifi](https://github.com/open-sdr/openwifi) ⭐ 4,792 | 🐛 94 | 🌐 C | 📅 2026-08-25 - Linux mac80211 compatible full-stack IEEE802.11/Wi-Fi design based on Software Defined Radio.
* [nethogs](https://github.com/raboof/nethogs) ⭐ 3,694 | 🐛 104 | 🌐 C++ | 📅 2026-07-23 - It groups bandwidth by process.
...
* [tcpreplay](https://github.com/appneta/tcpreplay) ⭐ 1,348 | 🐛 0 | 🌐 C | 📅 2026-08-15 - Pcap editing and replay tools.
* [wavemon](https://github.com/uoaerg/wavemon) ⭐ 1,236 | 🐛 6 | 🌐 C | 📅 2026-06-29 - An ncurses-based monitoring application for wireless network devices.
* [SOES](https://github.com/OpenEtherCATsociety/SOES) ⭐ 839 | 🐛 32 | 🌐 C | 📅 2025-04-08 - SOES is an EtherCAT slave stack written in C.
...
* [awesome CAN](https://github.com/iDoka/awesome-canbus) ⭐ 3,460 | 🐛 6 | 📅 2026-08-07 -  A curated list of awesome CAN bus tools, hardware and resources.
* [opendbc](https://github.com/commaai/opendbc) ⭐ 3,403 | 🐛 359 | 🌐 Python | 📅 2026-09-09 - The project to democratize access to the decoder ring of your car.
* [can-utils](https://github.com/linux-can/can-utils) ⭐ 2,910 | 🐛 61 | 🌐 C | 📅 2026-05-12 - Linux-CAN / SocketCAN user space applications.
* [cantools](https://github.com/eerimoq/cantools) ⭐ 2,283 | 🐛 129 | 🌐 Python | 📅 2026-09-04 - CAN BUS tools in Python 3.
* [AndrOBD](https://github.com/fr3ts0n/AndrOBD) ⭐ 2,088 | 🐛 73 | 🌐 Java | 📅 2026-09-08 - Android OBD diagnostics with any ELM327 adapter.
...
* [SavvyCAN](https://github.com/collin80/SavvyCAN) ⭐ 1,826 | 🐛 286 | 🌐 C++ | 📅 2026-05-15 - A Qt5 based cross platform tool which can be used to load, save, and capture canbus frames.
...
* [Open-Vehicle-Monitoring-System-3](https://github.com/openvehicles/Open-Vehicle-Monitoring-System-3) ⭐ 854 | 🐛 206 | 🌐 C | 📅 2026-09-04 - The system provides live monitoring of vehicle metrics like state of charge, temperatures, tyre pressures and diagnostic fault conditions.
...
* [ublox](https://github.com/KumarRobotics/ublox) ⭐ 535 | 🐛 121 | 🌐 C++ | 📅 2026-08-21 - Provides support for u-blox GPS receivers.
...
* [pylon-ros-camera](https://github.com/basler/pylon-ros-camera) ⭐ 194 | 🐛 19 | 🌐 C++ | 📅 2026-09-09 - The official pylon ROS driver for Basler GigE Vision and USB3 Vision cameras.
...
* [Vault](https://github.com/hashicorp/vault) ⭐ 36,221 | 🐛 1,433 | 🌐 Go | 📅 2026-09-10 - A tool for securely accessing secrets. A secret is anything that you want to tightly control access to, such as API keys, passwords, certificates, and more.
* [How-to-Secure-A-Linux-Server](https://github.com/imthenachoman/How-To-Secure-A-Linux-Server) ⭐ 31,383 | 🐛 32 | 📅 2026-09-07 - An evolving how-to guide for securing a Linux server.
* [fail2ban](https://github.com/fail2ban/fail2ban) ⭐ 18,578 | 🐛 271 | 🌐 Python | 📅 2026-08-26 - Daemon to ban hosts that cause multiple authentication errors.
* [lynis](https://github.com/CISOfy/lynis) ⭐ 16,309 | 🐛 219 | 🌐 Shell | 📅 2026-09-09 - Security auditing tool for Linux, macOS, and UNIX-based systems. Assists with compliance testing (HIPAA/ISO27001/PCI DSS) and system hardening.
* [OpenVPN](https://github.com/OpenVPN/openvpn) ⭐ 14,527 | 🐛 224 | 🌐 C | 📅 2026-09-10 - An open source VPN daemon.
...
* [Firejail](https://github.com/netblue30/firejail) ⭐ 7,638 | 🐛 523 | 🌐 C | 📅 2026-09-07 - A SUID sandbox program that reduces the risk of security breaches by restricting the running environment of untrusted applications using Linux namespaces, seccomp-bpf and Linux capabilities.
* [gopass](https://github.com/gopasspw/gopass) ⭐ 7,133 | 🐛 90 | 🌐 Go | 📅 2026-09-10 - A password manager for the command line written in Go.
* [vulscan](https://github.com/scipag/vulscan) ⭐ 3,783 | 🐛 7 | 🌐 Lua | 📅 2026-02-06 - Advanced vulnerability scanning with Nmap NSE.
* [OpenTitan](https://github.com/lowRISC/opentitan) ⭐ 3,638 | 🐛 2,035 | 🌐 SystemVerilog | 📅 2026-09-10 - Will make the silicon Root of Trust design and implementation more transparent, trustworthy, and secure for enterprises, platform providers, and chip manufacturers. OpenTitan is administered by lowRISC CIC as a collaborative project to produce high quality, open IP for instantiation as a full-featured product.
* [nmap-vulners](https://github.com/vulnersCom/nmap-vulners) ⭐ 3,478 | 🐛 2 | 🌐 Lua | 📅 2026-09-07 - NSE script based on Vulners.com API.
...
* [wolfssl](https://github.com/wolfSSL/wolfssl) ⭐ 2,932 | 🐛 237 | 🌐 C | 📅 2026-09-10 - A small, fast, portable implementation of TLS/SSL for embedded devices to the cloud.
* [brutespray](https://github.com/x90skysn3k/brutespray) ⭐ 2,528 | 🐛 14 | 🌐 Go | 📅 2026-09-10 - Automatically attempts default creds on found services.
...
* [openscap](https://github.com/OpenSCAP/openscap) ⭐ 1,814 | 🐛 61 | 🌐 XSLT | 📅 2026-09-07 - The oscap program is a command line tool that allows users to load, scan, validate, edit, and export SCAP documents.
* [Security-Enhanced Linux](https://github.com/SELinuxProject/selinux) ⭐ 1,628 | 🐛 12 | 🌐 C | 📅 2026-09-09 - A Linux kernel security module that provides a mechanism for supporting access control security policies, including mandatory access controls (MAC).
...
* [nuscenes-devkit](https://github.com/nutonomy/nuscenes-devkit) ⭐ 2,803 | 🐛 32 | 🌐 Python | 📅 2026-08-06 - The devkit of the nuScenes dataset.
