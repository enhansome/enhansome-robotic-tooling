...
* [Gogs](https://github.com/gogs/gogs) ⭐ 47,751 | 🐛 1,010 | 🌐 Go | 📅 2026-08-21 - Build a simple, stable and extensible self-hosted Git service that can be setup in the most painless way.
...
* [mattermost](https://github.com/mattermost/mattermost-server) ⭐ 38,871 | 🐛 966 | 🌐 TypeScript | 📅 2026-08-22 - An open source, private cloud, Slack-alternative.
* [jitsi-meet](https://github.com/jitsi/jitsi-meet) ⭐ 29,785 | 🐛 147 | 🌐 TypeScript | 📅 2026-08-21 - Secure, Simple and Scalable Video Conferences that you use as a standalone app or embed in your web application.
...
* [Wekan](https://github.com/wekan/wekan) ⭐ 21,058 | 🐛 335 | 🌐 JavaScript | 📅 2026-08-21 - Meteor based Kanban Board.
* [openproject](https://github.com/opf/openproject) ⭐ 15,908 | 🐛 203 | 🌐 Ruby | 📅 2026-08-22 - The leading open source project management software.
* [leantime](https://github.com/Leantime/leantime) ⭐ 11,410 | 🐛 316 | 🌐 PHP | 📅 2026-08-15 - Leantime is a lean project management system for innovators.
* [Kanboard](https://github.com/kanboard/kanboard) ⭐ 9,808 | 🐛 168 | 🌐 PHP | 📅 2026-08-11 - Minimalistic Kanban Board.
* [Gitlab](https://github.com/sameersbn/docker-gitlab) ⭐ 8,101 | 🐛 576 | 🌐 Shell | 📅 2026-08-18 - Simple Selfhosted Gitlab Server with Docker.
* [ONLYOFFICE](https://github.com/ONLYOFFICE/CommunityServer) ⭐ 3,157 | 🐛 206 | 🌐 C# | 📅 2026-05-05 -  A free open source collaborative system developed to manage documents, projects, customer relationship and email correspondence, all in one place.
...
* [Excalidraw](https://github.com/excalidraw/excalidraw) ⭐ 130,175 | 🐛 3,354 | 🌐 TypeScript | 📅 2026-08-16 - Virtual whiteboard for sketching hand-drawn like diagrams.
* [tesseract](https://github.com/tesseract-ocr/tesseract) ⭐ 76,097 | 🐛 489 | 🌐 C++ | 📅 2026-08-21 - Open Source OCR Engine.
* [Pandoc](https://github.com/jgm/pandoc) ⭐ 45,966 | 🐛 1,050 | 🌐 Haskell | 📅 2026-08-22 - Universal markup converter.
* [carbon](https://github.com/carbon-app/carbon) ⭐ 36,090 | 🐛 84 | 🌐 JavaScript | 📅 2026-02-10 - Share beautiful images of your source code.
* [OCRmyPDF](https://github.com/jbarlow83/OCRmyPDF) ⭐ 34,524 | 🐛 95 | 🌐 Python | 📅 2026-08-22 - Adds an OCR text layer to scanned PDF files, allowing them to be searched.
...
* [mkdocs](https://github.com/mkdocs/mkdocs/) ⭐ 22,364 | 🐛 186 | 🌐 Python | 📅 2025-10-20 - A fast, simple and downright gorgeous static site generator that's geared towards building project documentation.
* [overleaf](https://github.com/overleaf/overleaf) ⭐ 18,053 | 🐛 168 | 🌐 JavaScript | 📅 2026-07-10 - An open-source online real-time collaborative LaTeX editor.
* [asciinema](https://github.com/asciinema/asciinema) ⭐ 17,706 | 🐛 8 | 🌐 Rust | 📅 2026-08-14 - Lets you easily record terminal sessions and replay them in a terminal as well as in a web browser.
* [foam](https://github.com/foambubble/foam) ⭐ 17,367 | 🐛 29 | 🌐 TypeScript | 📅 2026-08-13 - Foam is a personal knowledge management and sharing system inspired by Roam Research, built on Visual Studio Code and GitHub.
* [Zotero](https://github.com/zotero/zotero) ⭐ 15,027 | 🐛 1,594 | 🌐 JavaScript | 📅 2026-08-21 - A free, easy-to-use tool to help you collect, organize, cite, and share your research sources.
...
* [Sphinx](https://github.com/sphinx-doc/sphinx/) ⭐ 7,984 | 🐛 1,457 | 🌐 Python | 📅 2026-08-16 - A tool that makes it easy to create intelligent and beautiful documentation for Python projects.
...
* [CodiMD](https://github.com/codimd/server) ⭐ 7,376 | 🐛 268 | 🌐 TypeScript | 📅 2026-08-21 - Open Source Online Real-time collaborate on team documentation in markdown.
* [buku](https://github.com/jarun/buku) ⭐ 7,179 | 🐛 6 | 🌐 Python | 📅 2026-08-16 - Browser-independent bookmark manager.
* [Doxygen](https://github.com/doxygen/doxygen) ⭐ 6,556 | 🐛 1,857 | 🌐 C++ | 📅 2026-08-21 - Doxygen is the de facto standard tool for generating documentation from annotated C++ sources.
...
* [Markor](https://github.com/gsantner/markor) ⭐ 6,005 | 🐛 187 | 🌐 Java | 📅 2026-08-05 - A Simple Markdown Editor for your Android Device.
...
* [fossology](https://github.com/fossology/fossology) ⭐ 1,019 | 🐛 294 | 🌐 HTML | 📅 2026-08-20 - A toolkit you can run license, copyright and export control scans from the command line.
* [doorstop](https://github.com/doorstop-dev/doorstop) ⭐ 659 | 🐛 56 | 🌐 Python | 📅 2026-08-15 - Requirements management using version control.
...
* [Architecture\_Decision\_Record](https://github.com/joelparkerhenderson/architecture_decision_record) ⭐ 16,710 | 🐛 10 | 📅 2026-08-20 - A document that captures an important architectural decision made along with its context and consequences.
...
* [Plantuml](https://github.com/plantuml/plantuml-server) ⭐ 2,214 | 🐛 77 | 🌐 Java | 📅 2026-08-07 - Web application to generate UML diagrams on-the-fly in your live documentation.
...
* [OpenPilot](https://github.com/commaai/openpilot) ⭐ 63,468 | 🐛 127 | 🌐 Python | 📅 2026-08-22 - Open Source Adaptive Cruise Control (ACC) and Lane Keeping Assist System (LKAS).
* [PythonRobotics](https://github.com/AtsushiSakai/PythonRobotics/) ⭐ 30,344 | 🐛 50 | 🌐 Python | 📅 2026-08-17 - This is a Python code collection of robotics algorithms, especially for autonomous navigation.
* [Apollo](https://github.com/ApolloAuto/apollo) ⭐ 26,800 | 🐛 1,045 | 🌐 C++ | 📅 2026-04-16 - High performance, flexible architecture which accelerates the development, testing, and deployment of Autonomous Vehicles.
* [ArduPilot](https://github.com/ArduPilot/ardupilot) ⭐ 15,723 | 🐛 3,154 | 🌐 C++ | 📅 2026-08-22 - Open source control software for autonomous vehicles - copters/planes/rovers/boats/submersibles.
* [PX4](https://github.com/PX4/Firmware) ⭐ 12,460 | 🐛 339 | 🌐 C++ | 📅 2026-08-22 - An open source flight control software for drones and other unmanned vehicles.
* [F Prime](https://github.com/nasa/fprime) ⭐ 11,682 | 🐛 448 | 🌐 C++ | 📅 2026-08-21 - A component-driven framework that enables rapid development and deployment of spaceflight and other embedded software applications.
* [open-source-rover](https://github.com/nasa-jpl/open-source-rover) ⭐ 9,596 | 🐛 16 | 🌐 Prolog | 📅 2026-08-13 - A build-it-yourself, 6-wheel rover based on the rovers on Mars from JPL.
...
* [Visual Studio Code](https://github.com/Microsoft/vscode) ⭐ 189,119 | 🐛 20,103 | 🌐 TypeScript | 📅 2026-08-22 - Code editor for edit-build-debug cycle.
* [atom](https://github.com/atom/atom) ⚠️ Archived - Hackable text editor for the 21st century.
* [pybind11](https://github.com/pybind/pybind11) ⭐ 17,999 | 🐛 713 | 🌐 C++ | 📅 2026-08-19 - Seamless operability between C++11 and Python.
* [Sourcetrail](https://github.com/CoatiSoftware/Sourcetrail) ⚠️ Archived - Free and open-source cross-platform source explorer.
* [Gitpod](https://github.com/gitpod-io/gitpod) ⭐ 13,754 | 🐛 456 | 🌐 TypeScript | 📅 2026-08-17 - An open source developer platform that automates the provisioning of ready-to-code development environments.
...
* [xeus-cling](https://github.com/QuantStack/xeus-cling) ⭐ 3,292 | 🐛 179 | 🌐 C++ | 📅 2025-10-27 - Jupyter kernel for the C++ programming language.
...
* [live-share](https://github.com/MicrosoftDocs/live-share) ⭐ 2,383 | 🐛 280 | 📅 2026-08-03 - Real-time collaborative development from the comfort of your favorite tools.
...
* [aptly](https://github.com/aptly-dev/aptly) ⭐ 2,871 | 🐛 214 | 🌐 Go | 📅 2026-08-09 - Debian repository management tool.
...
* [googletest](https://github.com/google/googletest) ⭐ 38,951 | 🐛 493 | 🌐 C++ | 📅 2026-08-21 - Google's C++ test framework.
* [pytest](https://github.com/pytest-dev/pytest/) ⭐ 14,436 | 🐛 812 | 🌐 Python | 📅 2026-08-20 - The pytest framework makes it easy to write small tests, yet scales to support complex functional testing.
* [doctest](https://github.com/onqtam/doctest) ⭐ 6,847 | 🐛 140 | 🌐 C++ | 📅 2026-08-18 - The fastest feature-rich C++11/14/17/20 single-header testing framework for unit tests and TDD.
...
* [black](https://github.com/psf/black) ⭐ 41,812 | 🐛 301 | 🌐 Python | 📅 2026-08-20 - The uncompromising Python code formatter.
* [shellcheck](https://github.com/koalaman/shellcheck) ⭐ 39,905 | 🐛 1,140 | 🌐 Haskell | 📅 2026-08-04 - A static analysis tool for shell scripts.
* [pydantic](https://github.com/samuelcolvin/pydantic) ⭐ 28,588 | 🐛 581 | 🌐 Python | 📅 2026-08-21 - Data parsing and validation using Python type hints.
...
* [cppcheck](https://github.com/danmar/cppcheck) ⭐ 6,725 | 🐛 207 | 🌐 C++ | 📅 2026-08-21 - Static analysis of C/C++ code.
* [pylint](https://github.com/PyCQA/pylint/) ⭐ 5,714 | 🐛 1,089 | 🌐 Python | 📅 2026-08-21 - Pylint is a Python static code analysis tool which looks for programming errors, helps enforcing a coding standard, sniffs for code smells and offers simple refactoring suggestions.
...
* [bcc](https://github.com/iovisor/bcc) ⭐ 22,629 | 🐛 1,070 | 🌐 C | 📅 2026-08-20 - Tools for BPF-based Linux IO analysis, networking, monitoring, and more.
* [FlameGraph](https://github.com/brendangregg/FlameGraph) ⭐ 19,686 | 🐛 174 | 🌐 Perl | 📅 2024-10-20 - Visualize profiled code.
* [tracy](https://github.com/wolfpld/tracy) ⭐ 16,640 | 🐛 170 | 🌐 C++ | 📅 2026-08-22 - A real time, nanosecond resolution, remote telemetry frame profiler for games and other applications.
...
* [hotspot](https://github.com/KDAB/hotspot) ⭐ 5,133 | 🐛 82 | 🌐 C++ | 📅 2026-05-12 - The Linux perf GUI for performance analysis.
...
* [lazygit](https://github.com/jesseduffield/lazygit) ⭐ 81,541 | 🐛 1,024 | 🌐 Go | 📅 2026-08-21 - A simple terminal UI for git commands, written in Go with the gocui library.
* [dive](https://github.com/wagoodman/dive) ⭐ 54,481 | 🐛 212 | 🌐 Go | 📅 2025-12-15 - A tool for exploring each layer in a docker image.
* [learnGitBranching](https://github.com/pcottle/learnGitBranching) ⭐ 33,918 | 🐛 60 | 🌐 JavaScript | 📅 2026-08-21 - A git repository visualizer, sandbox, and a series of educational tutorials and challenges.
* [semantic-release](https://github.com/semantic-release/semantic-release) ⭐ 23,995 | 🐛 405 | 🌐 JavaScript | 📅 2026-08-18 - Fully automated version management and package publishing.
* [dvc](https://github.com/iterative/dvc) ⭐ 15,832 | 🐛 201 | 🌐 Python | 📅 2026-08-19 - Management and versioning of datasets and machine learning models.
...
* [git-secret](https://github.com/sobolevn/git-secret) ⭐ 4,037 | 🐛 254 | 🌐 Shell | 📅 2026-08-11 - Encrypts files with permitted users' public keys, allowing users you trust to access encrypted data using pgp and their secret keys.
* [nbdime](https://github.com/jupyter/nbdime) ⭐ 2,840 | 🐛 95 | 🌐 TypeScript | 📅 2026-06-10 - Tools for diffing and merging of Jupyter notebooks.
* [git-sweep](https://github.com/arc90/git-sweep) ⭐ 2,705 | 🐛 45 | 🌐 Python | 📅 2023-10-01 - A command-line tool that helps you clean up Git branches that have been merged into master.
...
* [git-cola](https://github.com/git-cola/git-cola) ⭐ 2,563 | 🐛 5 | 🌐 Python | 📅 2026-08-21 - The highly caffeinated Git GUI.
* [python-gitlab](https://github.com/python-gitlab/python-gitlab) ⭐ 2,470 | 🐛 31 | 🌐 Python | 📅 2026-08-17 - A Python package providing access to the GitLab server API.
...
* [meld](https://github.com/GNOME/meld) ⭐ 1,306 | 🐛 0 | 🌐 Python | 📅 2026-08-21 - Meld is a visual diff and merge tool that helps you compare files, directories, and version controlled projects.
...
* [AirSim](https://github.com/microsoft/AirSim) ⭐ 18,414 | 🐛 780 | 🌐 C++ | 📅 2026-06-30 - Open source simulator for autonomous vehicles built on Unreal Engine.
* [carla](https://github.com/carla-simulator/carla) ⭐ 14,312 | 🐛 1,193 | 🌐 C++ | 📅 2026-08-21 - Open-source simulator for autonomous driving research.
* [Webots](https://github.com/cyberbotics/webots) ⭐ 4,568 | 🐛 229 | 🌐 C++ | 📅 2026-08-21 - Webots is an open source robot simulator compatible (among others) with [ROS](http://wiki.ros.org/webots_ros) and [ROS2](http://wiki.ros.org/webots_ros2).
...
* [sumo](https://github.com/eclipse/sumo) ⭐ 4,141 | 🐛 2,981 | 🌐 Python | 📅 2026-08-21 - Eclipse SUMO is an open source, highly portable, microscopic and continuous road traffic simulation package designed to handle large road networks.
...
* [OpenSceneGraph](https://github.com/openscenegraph/OpenSceneGraph) ⭐ 3,606 | 🐛 176 | 🌐 C++ | 📅 2024-08-09 - An open source high performance 3D graphics toolkit, used by application developers in fields such as visual simulation, games, virtual reality, scientific visualization and modelling.
* [highway-env](https://github.com/eleurent/highway-env) ⭐ 3,299 | 🐛 41 | 🌐 Python | 📅 2026-08-07 - A collection of environments for autonomous driving and tactical decision-making tasks.
...
* [gym-pybullet-drones](https://github.com/utiasDSL/gym-pybullet-drones) ⭐ 2,112 | 🐛 110 | 🌐 Python | 📅 2026-08-16 - PyBullet-based Gym environments for single and multi-agent reinforcement learning of quadcopter control.
...
* [safe-control-gym](https://github.com/utiasDSL/safe-control-gym) ⭐ 911 | 🐛 6 | 🌐 Python | 📅 2026-04-29 - PyBullet-based CartPole and Quadrotor environments—with CasADi symbolic dynamics and constraints—for safe and robust learning-based control.
...
* [ESIM](https://github.com/uzh-rpg/rpg_esim/) ⭐ 726 | 🐛 83 | 🌐 C | 📅 2023-12-25 - An Open Event Camera Simulator.
...
* [FreeCAD](https://github.com/FreeCAD/FreeCAD) ⭐ 32,996 | 🐛 4,101 | 🌐 C++ | 📅 2026-08-21 - Your own 3D parametric modeler.
* [openscad](https://github.com/openscad/openscad) ⭐ 9,997 | 🐛 826 | 🌐 C++ | 📅 2026-08-19 -  A software for creating solid 3D CAD models.
* [WireViz](https://github.com/formatc1702/WireViz) ⭐ 5,226 | 🐛 194 | 🌐 Python | 📅 2026-06-06 - A tool for easily documenting cables, wiring harnesses and connector pinouts.
* [NASA-3D-Resources](https://github.com/nasa/NASA-3D-Resources) ⭐ 3,752 | 🐛 5 | 📅 2025-06-03 - Here you'll find a growing collection of 3D models, textures, and images from inside NASA.
* [ODrive](https://github.com/madcowswe/ODrive) ⭐ 3,737 | 🐛 18 | 🌐 C++ | 📅 2026-01-20 - The aim is to make it possible to use inexpensive brushless motors in high performance robotics projects.
* [LibrePCB](https://github.com/LibrePCB/LibrePCB) ⭐ 2,970 | 🐛 217 | 🌐 C++ | 📅 2026-08-12 - A powerful, innovative and intuitive EDA tool for everyone.
...
* [pvlib-python](https://github.com/pvlib/pvlib-python) ⭐ 1,641 | 🐛 243 | 🌐 Python | 📅 2026-08-19 - A community supported tool that provides a set of functions and classes for simulating the performance of photovoltaic energy systems.
* [PcbDraw](https://github.com/yaqwsx/PcbDraw) ⭐ 1,411 | 🐛 10 | 🌐 Python | 📅 2026-08-07 - Convert your KiCAD board into a nice looking 2D drawing suitable for pinout diagrams.
...
* [phobos](https://github.com/dfki-ric/phobos) ⭐ 898 | 🐛 14 | 🌐 Python | 📅 2026-07-14 - An add-on for Blender allowing to create URDF, SDF and SMURF robot models in a WYSIWYG environment.
...
* [kalibr](https://github.com/ethz-asl/kalibr) ⭐ 5,657 | 🐛 135 | 🌐 C++ | 📅 2024-03-30 - The Kalibr visual-inertial calibration toolbox.
...
* [e2calib](https://github.com/uzh-rpg/e2calib) ⭐ 199 | 🐛 3 | 🌐 Python | 📅 2025-02-28 - Contains code that implements video reconstruction from event data for calibration.
...
* [ray](https://github.com/ray-project/ray) ⭐ 43,577 | 🐛 3,509 | 🌐 Python | 📅 2026-08-22 - A fast and simple framework for building and running distributed applications.
* [gym](https://github.com/openai/gym) ⚠️ Archived - A toolkit for developing and comparing reinforcement learning algorithms.
* [Netron](https://github.com/lutzroeder/Netron) ⭐ 33,383 | 🐛 18 | 🌐 JavaScript | 📅 2026-08-22 - Visualizer for neural network, deep learning and machine learning models.
* [fastai](https://github.com/fastai/fastai) ⭐ 28,118 | 🐛 267 | 🌐 Jupyter Notebook | 📅 2026-08-15 - The fastai library simplifies training fast and accurate neural nets using modern best practices.
* [mlflow](https://github.com/mlflow/mlflow) ⭐ 27,614 | 🐛 2,067 | 🌐 Python | 📅 2026-08-22 - A platform to streamline machine learning development, including tracking experiments, packaging code into reproducible runs, and sharing and deploying models.
* [MNN](https://github.com/alibaba/MNN) ⭐ 15,943 | 🐛 27 | 🌐 C++ | 📅 2026-08-20 - A blazing fast, lightweight deep learning framework, battle-tested by business-critical use cases in Alibaba.
...
* [cnn-explainer](https://github.com/poloclub/cnn-explainer) ⭐ 9,022 | 🐛 7 | 🌐 JavaScript | 📅 2023-10-14 - Learning Convolutional Neural Networks with Interactive Visualization.
...
* [leela-zero](https://github.com/leela-zero/leela-zero) ⭐ 5,582 | 🐛 374 | 🌐 C++ | 📅 2024-05-02 - This is a fairly faithful reimplementation of the system described in the Alpha Go Zero paper "Mastering the Game of Go without Human Knowledge".
...
* [Tensorflow Federated](https://github.com/tensorflow/federated) ⭐ 2,447 | 🐛 290 | 🌐 Python | 📅 2026-08-21 - TensorFlow Federated (TFF) is an open-source framework for machine learning and other computations on decentralized data.
...
* [dask](https://github.com/dask/dask) ⭐ 13,894 | 🐛 1,312 | 🌐 Python | 📅 2026-08-17 - Parallel computing with task scheduling for Python.
* [TensorRT](https://github.com/NVIDIA/TensorRT) ⭐ 13,273 | 🐛 622 | 🌐 C++ | 📅 2026-08-17 - A C++ library for high performance inference on NVIDIA GPUs and deep learning accelerators.
* [cupy](https://github.com/cupy/cupy) ⭐ 12,265 | 🐛 706 | 🌐 Python | 📅 2026-08-20 - NumPy-like API accelerated with CUDA.
...
* [PYNQ](https://github.com/Xilinx/PYNQ) ⭐ 2,337 | 🐛 56 | 🌐 Jupyter Notebook | 📅 2026-08-21 - An open-source project from Xilinx that makes it easy to design embedded systems with Zynq All Programmable Systems on Chips.
...
* [meshroom](https://github.com/alicevision/meshroom) ⭐ 12,914 | 🐛 516 | 🌐 Python | 📅 2026-08-20 - Meshroom is a free, open-source 3D Reconstruction Software based on the AliceVision Photogrammetric Computer Vision framework.
* [libvips](https://github.com/libvips/libvips) ⭐ 11,586 | 🐛 82 | 🌐 C | 📅 2026-08-21 - A fast image processing library with low memory needs.
* [satellite-image-deep-learning](https://github.com/robmarkcole/satellite-image-deep-learning) ⭐ 10,234 | 🐛 0 | 📅 2026-08-02 - Resources for deep learning with satellite & aerial imagery.
...
* [open3d](https://github.com/intel-isl/Open3D) ⭐ 13,904 | 🐛 1,321 | 🌐 C++ | 📅 2026-08-22 - Open3D: A Modern Library for 3D Data Processing.
* [Draco](https://github.com/google/draco) ⭐ 7,451 | 🐛 172 | 🌐 C++ | 📅 2026-08-18 - A library for compressing and decompressing 3D geometric meshes and point clouds.
...
* [PCDet](https://github.com/sshaoshuai/PCDet) ⭐ 5,686 | 🐛 30 | 🌐 Python | 📅 2025-10-08 - A general PyTorch-based codebase for 3D object detection from point cloud.
* [OpenPCDet](https://github.com/open-mmlab/OpenPCDet) ⭐ 5,686 | 🐛 30 | 🌐 Python | 📅 2025-10-08 - A Toolbox for LiDAR-based 3D Object Detection.
...
* [mp2p\_icp](https://github.com/MOLAorg/mp2p_icp) ⭐ 188 | 🐛 3 | 🌐 C++ | 📅 2026-08-21 - A repertory of multi primitive-to-primitive (MP2P) ICP algorithms in C++.
...
* [PROJ](https://github.com/OSGeo/PROJ) ⭐ 2,006 | 🐛 98 | 🌐 C++ | 📅 2026-08-19 - Cartographic Projections and Coordinate Transformations Library.
...
* [RTKLIB](https://github.com/rtklibexplorer/RTKLIB) ⭐ 963 | 🐛 93 | 🌐 C | 📅 2026-08-06 - A version of RTKLIB optimized for single and dual frequency low cost GPS receivers, especially u-blox receivers.
...
* [LIO\_SAM](https://github.com/TixiaoShan/LIO-SAM) ⭐ 4,891 | 🐛 183 | 🌐 C++ | 📅 2025-02-14 - Tightly-coupled Lidar Inertial Odometry via Smoothing and Mapping.
...
* [mola](https://github.com/MOLAorg/mola) ⭐ 995 | 🐛 34 | 🌐 C++ | 📅 2026-08-21 - A Modular System for Localization and Mapping.
...
* [ORB\_SLAM3](https://github.com/UZ-SLAMLab/ORB_SLAM3) ⭐ 8,975 | 🐛 572 | 🌐 C++ | 📅 2024-07-24 - ORB-SLAM3: An Accurate Open-Source Library for Visual, Visual-Inertial and Multi-Map SLAM.
* [VINS-Fusion](https://github.com/HKUST-Aerial-Robotics/VINS-Fusion) ⭐ 4,678 | 🐛 212 | 🌐 C++ | 📅 2024-05-23 - A Robust and Versatile Multi-Sensor Visual-Inertial State Estimator.
...
* [open\_vins](https://github.com/rpng/open_vins) ⭐ 3,050 | 🐛 74 | 🌐 C++ | 📅 2025-11-30 - An open source platform for visual-inertial navigation research.
...
* [Mapbox](https://github.com/mapbox/mapbox-gl-js) ⭐ 12,386 | 🐛 1,457 | 🌐 TypeScript | 📅 2026-08-21 - A JavaScript library for interactive, customizable vector maps on the web.
* [osrm-backend](https://github.com/Project-OSRM/osrm-backend) ⭐ 7,999 | 🐛 358 | 🌐 C++ | 📅 2026-08-21 - Open Source Routing Machine - C++ backend.
* [gdal](https://github.com/OSGeo/gdal) ⭐ 6,027 | 🐛 569 | 🌐 C++ | 📅 2026-08-21 - GDAL is an open source X/MIT licensed translator library for raster and vector geospatial data formats.
* [osmnx](https://github.com/gboeing/osmnx) ⭐ 5,823 | 🐛 1 | 🌐 Python | 📅 2026-07-31 - Python for street networks. Retrieve, model, analyze, and visualize street networks and other spatial data from OpenStreetMap.
...
* [iD](https://github.com/openstreetmap/iD) ⭐ 3,860 | 🐛 984 | 🌐 JavaScript | 📅 2026-08-20 - The easy-to-use OpenStreetMap editor in JavaScript.
...
* [grass](https://github.com/OSGeo/grass) ⭐ 1,154 | 🐛 694 | 🌐 C | 📅 2026-08-21 - GRASS GIS - free and open source Geographic Information System (GIS).
...
* [BehaviorTree.CPP](https://github.com/BehaviorTree/BehaviorTree.CPP) ⭐ 4,168 | 🐛 56 | 🌐 C++ | 📅 2026-08-14 - Behavior Trees Library in C++.
* [Groot](https://github.com/BehaviorTree/Groot) ⭐ 887 | 🐛 66 | 🌐 C++ | 📅 2025-02-28 - Graphical Editor to create BehaviorTrees. Compliant with BehaviorTree.CPP.
...
* [pinocchio](https://github.com/stack-of-tasks/pinocchio) ⭐ 3,673 | 🐛 110 | 🌐 C++ | 📅 2026-08-11 - A fast and flexible implementation of Rigid Body Dynamics algorithms and their analytical derivatives.
* [EGO-Planner](https://github.com/ZJU-FAST-Lab/ego-planner) ⭐ 2,609 | 🐛 40 | 🌐 C++ | 📅 2025-03-08 - A lightweight gradient-based local planner without ESDF construction, which significantly reduces computation time compared to some state-of-the-art methods.
* [casADi](https://github.com/casadi/casadi) ⭐ 2,274 | 🐛 740 | 🌐 C++ | 📅 2026-08-20 - A symbolic framework for numeric optimization implementing automatic differentiation in forward and reverse modes on sparse matrix-valued computational graphs.
...
* [OpEn](https://github.com/alphaville/optimization-engine) ⭐ 644 | 🐛 12 | 🌐 Rust | 📅 2026-03-31 - A solver for Fast & Accurate Embedded Optimization for next-generation Robotics and Autonomous Systems.
...
* [imgui](https://github.com/ocornut/imgui) ⭐ 75,796 | 🐛 1,235 | 🌐 C++ | 📅 2026-08-19 - Designed to enable fast iterations and to empower programmers to create content creation tools and visualization / debug tools.
...
* [cage](https://github.com/Hjdskes/cage) ⭐ 2,015 | 🐛 124 | 🌐 C | 📅 2026-08-18 - This is Cage, a Wayland kiosk. A kiosk runs a single, maximized application.
...
* [TTS](https://github.com/coqui-ai/TTS) ⭐ 45,931 | 🐛 2 | 🌐 Python | 📅 2024-08-16 - A deep learning toolkit for Text-to-Speech, battle-tested in research and production.
...
* [the-art-of-command-line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,146 | 🐛 257 | 📅 2024-06-25 - Master the command line, in one page.
* [fzf](https://github.com/junegunn/fzf) ⭐ 82,603 | 🐛 330 | 🌐 Go | 📅 2026-08-21 - A command-line fuzzy finder.
...
* [fx](https://github.com/antonmedv/fx) ⭐ 20,586 | 🐛 25 | 🌐 Go | 📅 2026-07-28 - Command-line tool and terminal JSON viewer.
...
* [dotbot](https://github.com/anishathalye/dotbot) ⭐ 7,989 | 🐛 17 | 🌐 Python | 📅 2026-07-12 - A tool that bootstraps your dotfiles.
...
* [tmuxp](https://github.com/tmux-python/tmuxp) ⭐ 4,564 | 🐛 138 | 🌐 Python | 📅 2026-08-16 -  A session manager built on libtmux.
...
* [bokeh](https://github.com/bokeh/bokeh) ⭐ 20,432 | 🐛 849 | 🌐 Python | 📅 2026-08-21 - Interactive Data Visualization in the browser, from Python.
* [plotly.py](https://github.com/plotly/plotly.py) ⭐ 18,749 | 🐛 779 | 🌐 Python | 📅 2026-08-21 - An open-source, interactive graphing library for Python.
* [openmct](https://github.com/nasa/openmct) ⭐ 13,087 | 🐛 1,072 | 🌐 JavaScript | 📅 2026-08-20 - A web based mission control framework.
* [kepler.gl](https://github.com/keplergl/kepler.gl) ⭐ 11,981 | 🐛 463 | 🌐 TypeScript | 📅 2026-08-21 - Kepler.gl is a powerful open source geospatial analysis tool for large-scale data sets.
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,124 | 🐛 159 | 🌐 C++ | 📅 2026-08-10 - The timeseries visualization tool that you deserve.
...
* [PyQtGraph](https://github.com/pyqtgraph/pyqtgraph) ⭐ 4,403 | 🐛 520 | 🌐 Python | 📅 2026-08-17 - Fast data visualization and GUI tools for scientific / engineering applications.
...
* [marvros](https://github.com/mavlink/mavros) ⭐ 1,212 | 🐛 413 | 🌐 C++ | 📅 2026-08-21 - MAVLink to ROS gateway with proxy for Ground Control Station.
...
* [label-studio](https://github.com/heartexlabs/label-studio) ⭐ 28,106 | 🐛 924 | 🌐 TypeScript | 📅 2026-08-21 - Label Studio is a multi-type data labeling and annotation tool with standardized output format.
...
* [cvat](https://github.com/opencv/cvat) ⭐ 16,567 | 🐛 588 | 🌐 Python | 📅 2026-08-21 - Powerful and efficient Computer Vision Annotation Tool (CVAT).
* [labelme](https://github.com/wkentaro/labelme) ⭐ 16,121 | 🐛 183 | 🌐 Python | 📅 2026-08-21 - Image Polygonal Annotation with Python (polygon, rectangle, circle, line, point and image-level flag annotation).
* [napari](https://github.com/napari/napari) ⭐ 2,738 | 🐛 1,239 | 🌐 Python | 📅 2026-08-21 -  A fast, interactive, multi-dimensional image viewer for python.
...
* [Potree](https://github.com/potree/potree) ⭐ 5,583 | 🐛 822 | 🌐 JavaScript | 📅 2026-01-08 - WebGL point cloud viewer for large datasets.
* [CloudCompare](https://github.com/CloudCompare/CloudCompare) ⭐ 4,685 | 🐛 287 | 🌐 C++ | 📅 2026-08-21 - CloudCompare is a 3D point cloud (and triangular mesh) processing software.
...
* [psutil](https://github.com/giampaolo/psutil) ⭐ 11,265 | 🐛 255 | 🌐 Python | 📅 2026-08-19 - Cross-platform lib for process and system monitoring in Python.
* [nvtop](https://github.com/Syllo/nvtop) ⭐ 10,932 | 🐛 144 | 🌐 C | 📅 2026-05-06 - NVIDIA GPUs htop like monitoring tool.
* [ntop](https://github.com/ntop/ntopng) ⭐ 8,099 | 🐛 336 | 🌐 Lua | 📅 2026-08-21 - Web-based Traffic and Security Network Traffic Monitoring.
...
* [syncthing](https://github.com/syncthing/syncthing) ⭐ 87,858 | 🐛 375 | 🌐 Go | 📅 2026-08-21 - A continuous file synchronization program.
* [DuckDB](https://github.com/cwida/duckdb) ⭐ 40,522 | 🐛 812 | 🌐 C++ | 📅 2026-08-20 - An embeddable SQL OLAP Database Management System.
* [nextcloud](https://github.com/nextcloud/server) ⭐ 36,520 | 🐛 3,583 | 🌐 PHP | 📅 2026-08-22 - Nextcloud is a suite of client-server software for creating and using file hosting services.
* [borg](https://github.com/borgbackup/borg) ⭐ 13,640 | 🐛 249 | 🌐 Python | 📅 2026-08-21 - Deduplicating archiver with compression and authenticated encryption.
...
* [ceph](https://github.com/ceph/ceph) ⭐ 16,954 | 🐛 1,261 | 🌐 C++ | 📅 2026-08-22 - A distributed object, block, and file storage platform.
...
* [ansible](https://github.com/ansible/ansible) ⭐ 70,433 | 🐛 836 | 🌐 Python | 📅 2026-08-19 - Ansible is a radically simple IT automation platform that makes your applications and systems easier to deploy.
...
* [traefik](https://github.com/containous/traefik) ⭐ 64,535 | 🐛 914 | 🌐 Go | 📅 2026-08-21 - The Cloud Native Edge Router.
* [Portainer](https://github.com/portainer/portainer) ⭐ 38,306 | 🐛 747 | 🌐 TypeScript | 📅 2026-08-21 - Making Docker management easy.
...
* [triton-inference-server](https://github.com/NVIDIA/triton-inference-server) ⭐ 10,931 | 🐛 906 | 🌐 Python | 📅 2026-08-20 - NVIDIA Triton Inference Server provides a cloud inferencing solution optimized for NVIDIA GPUs.
* [cudf](https://github.com/rapidsai/cudf) ⭐ 9,733 | 🐛 1,311 | 🌐 C++ | 📅 2026-08-22 - Provides a pandas-like API that will be familiar to data engineers & data scientists, so they can use it to easily accelerate their workflows without going into the details of CUDA programming.
* [jupyterhub](https://github.com/jupyterhub/jupyterhub) ⭐ 8,328 | 🐛 199 | 🌐 Python | 📅 2026-08-20 - Multi-user server for Jupyter notebooks.
* [graylog2-server](https://github.com/Graylog2/graylog2-server) ⭐ 8,112 | 🐛 2,053 | 🌐 Java | 📅 2026-08-21 - Free and open source log management.
...
* [Slurm](https://github.com/SchedMD/slurm) ⭐ 4,271 | 🐛 13 | 🌐 C | 📅 2026-08-20 - Slurm: A Highly Scalable Workload Manager.
* [polyaxon](https://github.com/polyaxon/polyaxon) ⭐ 3,722 | 🐛 126 | 🌐 MDX | 📅 2026-08-20 - A platform for reproducing and managing the whole life cycle of machine learning and deep learning applications.
...
* [mass](https://github.com/maas/maas) ⭐ 495 | 🐛 25 | 🌐 Python | 📅 2026-08-21 - Self-service, remote installation of Windows, CentOS, ESXi and Ubuntu on real servers turns your data centre into a bare metal cloud.
...
* [protobuf](https://github.com/protocolbuffers/protobuf) ⭐ 71,787 | 🐛 314 | 🌐 C++ | 📅 2026-08-22 - Google's data interchange format.
...
* [openwifi](https://github.com/open-sdr/openwifi) ⭐ 4,763 | 🐛 93 | 🌐 C | 📅 2026-08-14 - Linux mac80211 compatible full-stack IEEE802.11/Wi-Fi design based on Software Defined Radio.
...
* [awesome CAN](https://github.com/iDoka/awesome-canbus) ⭐ 3,426 | 🐛 6 | 📅 2026-08-07 -  A curated list of awesome CAN bus tools, hardware and resources.
* [opendbc](https://github.com/commaai/opendbc) ⭐ 3,351 | 🐛 337 | 🌐 Python | 📅 2026-08-22 - The project to democratize access to the decoder ring of your car.
* [can-utils](https://github.com/linux-can/can-utils) ⭐ 2,906 | 🐛 62 | 🌐 C | 📅 2026-05-12 - Linux-CAN / SocketCAN user space applications.
* [cantools](https://github.com/eerimoq/cantools) ⭐ 2,271 | 🐛 128 | 🌐 Python | 📅 2026-08-21 - CAN BUS tools in Python 3.
* [AndrOBD](https://github.com/fr3ts0n/AndrOBD) ⭐ 2,067 | 🐛 71 | 🌐 Java | 📅 2026-08-21 - Android OBD diagnostics with any ELM327 adapter.
...
* [ddt4all](https://github.com/cedricp/ddt4all) ⭐ 1,818 | 🐛 1 | 🌐 Python | 📅 2026-07-14 - DDT4All is a tool to create your own ECU parameters screens and connect to a CAN network with a cheap ELM327 interface.
* [SavvyCAN](https://github.com/collin80/SavvyCAN) ⭐ 1,776 | 🐛 283 | 🌐 C++ | 📅 2026-05-15 - A Qt5 based cross platform tool which can be used to load, save, and capture canbus frames.
* [python-can](https://github.com/hardbyte/python-can) ⭐ 1,584 | 🐛 271 | 🌐 Python | 📅 2026-07-01 - The can package provides controller area network support for Python developers.
...
* [Open-Vehicle-Monitoring-System-3](https://github.com/openvehicles/Open-Vehicle-Monitoring-System-3) ⭐ 839 | 🐛 206 | 🌐 C | 📅 2026-08-21 - The system provides live monitoring of vehicle metrics like state of charge, temperatures, tyre pressures and diagnostic fault conditions.
* [uds-c](https://github.com/openxc/uds-c) ⭐ 822 | 🐛 6 | 🌐 C | 📅 2021-08-16 - Unified Diagnostics Service (UDS) and OBD-II (On Board Diagnostics for Vehicles) C Library.
...
* [autosar](https://github.com/cogu/autosar) ⭐ 501 | 🐛 3 | 🌐 Python | 📅 2026-08-21 - A set of python modules for working with AUTOSAR XML files.
...
* [pylon-ros-camera](https://github.com/basler/pylon-ros-camera) ⭐ 195 | 🐛 19 | 🌐 C++ | 📅 2026-08-21 - The official pylon ROS driver for Basler GigE Vision and USB3 Vision cameras.
...
* [Vault](https://github.com/hashicorp/vault) ⭐ 36,153 | 🐛 1,429 | 🌐 Go | 📅 2026-08-21 - A tool for securely accessing secrets. A secret is anything that you want to tightly control access to, such as API keys, passwords, certificates, and more.
* [How-to-Secure-A-Linux-Server](https://github.com/imthenachoman/How-To-Secure-A-Linux-Server) ⭐ 30,304 | 🐛 34 | 📅 2026-07-13 - An evolving how-to guide for securing a Linux server.
* [fail2ban](https://github.com/fail2ban/fail2ban) ⭐ 18,440 | 🐛 273 | 🌐 Python | 📅 2026-08-20 - Daemon to ban hosts that cause multiple authentication errors.
* [lynis](https://github.com/CISOfy/lynis) ⭐ 16,191 | 🐛 218 | 🌐 Shell | 📅 2026-08-05 - Security auditing tool for Linux, macOS, and UNIX-based systems. Assists with compliance testing (HIPAA/ISO27001/PCI DSS) and system hardening.
* [OpenVPN](https://github.com/OpenVPN/openvpn) ⭐ 14,409 | 🐛 224 | 🌐 C | 📅 2026-08-22 - An open source VPN daemon.
* [bandit](https://github.com/PyCQA/bandit) ⭐ 8,231 | 🐛 259 | 🌐 Python | 📅 2026-08-04 - A tool designed to find common security issues in Python code.
* [Firejail](https://github.com/netblue30/firejail) ⭐ 7,602 | 🐛 524 | 🌐 C | 📅 2026-08-21 - A SUID sandbox program that reduces the risk of security breaches by restricting the running environment of untrusted applications using Linux namespaces, seccomp-bpf and Linux capabilities.
* [gopass](https://github.com/gopasspw/gopass) ⭐ 7,097 | 🐛 89 | 🌐 Go | 📅 2026-08-21 - A password manager for the command line written in Go.
* [vulscan](https://github.com/scipag/vulscan) ⭐ 3,778 | 🐛 7 | 🌐 Lua | 📅 2026-02-06 - Advanced vulnerability scanning with Nmap NSE.
* [OpenTitan](https://github.com/lowRISC/opentitan) ⭐ 3,602 | 🐛 2,043 | 🌐 SystemVerilog | 📅 2026-08-21 - Will make the silicon Root of Trust design and implementation more transparent, trustworthy, and secure for enterprises, platform providers, and chip manufacturers. OpenTitan is administered by lowRISC CIC as a collaborative project to produce high quality, open IP for instantiation as a full-featured product.
* [nmap-vulners](https://github.com/vulnersCom/nmap-vulners) ⭐ 3,407 | 🐛 0 | 🌐 Lua | 📅 2026-08-21 - NSE script based on Vulners.com API.
...
* [wolfssl](https://github.com/wolfSSL/wolfssl) ⭐ 2,913 | 🐛 196 | 🌐 C | 📅 2026-08-21 - A small, fast, portable implementation of TLS/SSL for embedded devices to the cloud.
* [brutespray](https://github.com/x90skysn3k/brutespray) ⭐ 2,521 | 🐛 17 | 🌐 Go | 📅 2026-08-20 - Automatically attempts default creds on found services.
